...
// click on submit
clickOnElement( new String[] {XPATH, "//button[@class=\'btn btn-magenta btn-primary btn-block submit_mpagoCashForm checkout-next\']"});
// click on terms1
...
Assert.assertTrue(getText(new String[] { XPATH, "//div[@class=\'down-bar-actions col-md-6 col-xs-12\']//button[@id=\'checkout-display-continueCheckout\']" }).contains("Ir a pagar"));
// Click on go pay
...
goForward();
// start of if loop
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'down-bar-actions col-md-6 col-xs-12\']//button[@id=\'checkout-display-continueCheckout\']"})){
// Click on go pay
clickOnElement( new String[] {XPATH, "//div[@class=\'down-bar-actions col-md-6 col-xs-12\']//button[@id=\'checkout-display-continueCheckout\']"});
// End of if loop
}
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\"alert alert-danger payment-error-message\"])[2]"}));
// End of if loop
}
...
waitForTime(6);
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//div[@class='actions']/button[contains(.,'Ir a pagar')]"}, "20","ten");
// start if statement
...
// Write text in address line1
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(4) > input" }, "bengaluru");
// Write text in address line2
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(4) > div > div > div:nth-of-type(1) > div > div:nth-of-type(1) > div > div > div:nth-of-type(2) > p:nth-of-type(2) > b"}));
// Add Assertion for ec.esc2.mto.fb@...
Assert.assertTrue(getText(new String[] { XPATH, "//b[text()=\'ec.esc2.mto.fb@gmail.com\']" }).contains("ec.esc2.mto.fb@gmail.com"));
// open new tab
...
// take screenshot
takeScreenshot("logs/Screenshoots/ywyLSy.png");
...
// Click on Continue
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-magenta btn-block submit_mpagoForm checkout-next\"])[1]"});
// Click on Terms1
...
clickOnElement( new String[] {XPATH, "//button[@class=\"btn btn-magenta btn-block checkout-next\"]"});
// Wait
waitUntil("CheckElement", new String[]{XPATH, "//button[@class='btn btn-magenta btn-block checkout-next']"}, "15","disabled");
// Click on confirm continue
clickOnElement( new String[] {XPATH, "//button[@class=\"btn btn-magenta btn-block checkout-next\"]"});
// wait
...
typeText(new String[] { XPATH, "(//input[@class=\"form-control input--card-number not-empty\"])[1]" }, "4168818844447115");
...
clickOnElement( new String[] {XPATH, "//div[@class=\'category_menu_item_principal nav__link\']/../..//a[@title=\'Cuidado personal\']"});
// click on product
...
getURL("https://s1-esika.tiendabelcorp.com/co/?consultantUrl=tiendaCO98");
// Click on user icon
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(4) > a > img"});
...
getURL("https://s1-lbel.tiendabelcorp.com/pe/?consultantUrl=mitiendaonlineelizabeth");
// Click on Makeup category
clickOnElement( new String[] {XPATH, "(//h3[@class=\"belcorp-cms-carousel-item__title js-belcorp-cms-carousel-item-link-trigger\"])[2]"});
// Click on product
