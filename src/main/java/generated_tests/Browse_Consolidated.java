...
clickOnElement( new String[] {CSS, "img[class=\"lazyOwl\"][src=\"/cdn-cgi/image/width=250,fit=contain,f=auto//medias/200097894-fotocrosselling.jpg?context=bWFzdGVyfHJvb3R8MjA4NTN8aW1hZ2UvanBlZ3xoZmUvaGRlLzEwODAzMTIyMjA4Nzk4LzIwMDA5Nzg5NF9mb3RvY3Jvc3NlbGxpbmcuanBnfGQyZjI4NTQxZmNkNTcyZmRkNzFkMDVhODQ5MDVlZDdlOTg5NTEzODQ4ZWQ2MTE3MzM0MDgxMWU3NmU5YWIzMTY\"]"});
...
clickOnElement( new String[] {CSS, "img[class=\"lazyOwl\"][src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200101074_fotocrosselling.jpg\"]"});
...
clickOnElement( new String[] {CSS, "img[class=\"lazyOwl\"][src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200097894_fotocrosselling.jpg\"]"});
...
javascriptExecution("window.sessionStorage.clear();");
// if lbel clickable
if (isElementClickable(new String[] { XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"})){
// Click on LBel
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]"}));
// click on video1
...
takeScreenshot("logs/Screenshoots/PcewIf.png");
// video 2 is clickable
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[2]"}));
// click on video 2
...
takeScreenshot("logs/Screenshoots/YOMEpL.png");
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//div[@class=\"product-details\"]//div[@class=\"priceContainer\"]"}));
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"product-main-info\"]" },"logs/Screenshots/FVBiAb.png");
...
Assert.assertEquals(getChildElements(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-4\']" }).size(), "4");
// End If Statement
}
// Start Else Statement
else{
...
// Click on empty cart
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3) > div > div > div > a > div:nth-of-type(2) > span"});
// Click on popup
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3) > div > div > div > div:nth-of-type(2)"});
// Click on consultant
...
pageRefresh();
// if visible
if (isDisplayed(new String[] { XPATH, "(//main//div[@class=\'product-variant-detail-button mt-lg-0 ml-lg-auto principalButtonViewDetail\']//p[text()=\' Ver detalle\'])[1]"}, 0)) {
// Click on see  detail
clickOnElement( new String[] {XPATH, "(//main//div[@class=\'product-variant-detail-button mt-lg-0 ml-lg-auto principalButtonViewDetail\']//p[text()=\' Ver detalle\'])[1]"});
// end if visible
}
...
scroll("ScrollDown", 1900);
// if video is present
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'bic-cyzone-video-tutorials__item--description\']/parent::div[@id=\'bic-cyzone-video-tutorials-item-0\']"})){
// Add assertion video present
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'bic-cyzone-video-tutorials__item--description\']/parent::div[@id=\'bic-cyzone-video-tutorials-item-0\']"}));
...
if (isElementClickable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]"})){
// Add assertion on play button
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]"}));
// end if play button clickable
}
// Take screenshot video is in same browser
takeScreenshot("logs/Screenshoots/QaHegD.png");
...
mouseHoverOnElement(new String[] {CSS, "main > div:nth-of-type(7) > div > div:nth-of-type(2) > div:nth-of-type(1) > div > div:nth-of-type(1) > a:nth-of-type(2) > h3"});
...
clickOnElement( new String[] {XPATH, "(//h3[@class=\"belcorp-cms-carousel-item__title js-belcorp-cms-carousel-item-link-trigger\"])[3]"});
// start of if loop
if (isElementAvailable(new String[] { XPATH, "//button[@id=\'cboxClose\']"})){
// close popup
clickOnElement( new String[] {XPATH, "//button[@id=\'cboxClose\']"});
...
goBack();
// Assertion on name of category
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//h3[@class=\"belcorp-cms-carousel-item__title js-belcorp-cms-carousel-item-link-trigger\"])[4]"}));
// click on personal care category
clickOnElement( new String[] {XPATH, "(//h3[@class=\"belcorp-cms-carousel-item__title js-belcorp-cms-carousel-item-link-trigger\"])[4]"});
// start of if loop
if (isElementAvailable(new String[] { XPATH, "//button[@id=\'cboxClose\']"})){
// close popup
clickOnElement( new String[] {XPATH, "//button[@id=\'cboxClose\']"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'commercialCarousel-pdp-wrapper\'])[1]"}));
// End If Statement
}
// Click on lbel
...
// Click on  fourth product
clickOnElement( new String[] {XPATH, "(//div[@class=\'product__listing product__grid\']/child::div/child::div/child::a)[4]"});
// Start If Statement
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h3[text()=\' PERFECT MATCH! Complementa tu look con\']"}));
// End  If Statement
}
// Start If Statement
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h3[text()=\' Esto también te podría encantar\']"}));
// End  If Statement
}
// clear cookies and cache
// Clear cookies
...
// add assertion for recommended for you
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//h2[@class=\'js-multi-text-product-carousel-title\'])[1]"}));
// End If Statement
}
// Click on cyzone
...
javascriptExecution("document.querySelector(\"ul#productGalleryThumbnails div:nth-child(4) > div > li > a > img\").click();");
// Click on play button
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(4) > div > div > div:nth-of-type(1) > div"});
// wait condtion
waitForTime(6);
// Click on img 2
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[1]"}));
// Add Assertion for Esika
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[1]"}));
// Go to Lbel Url
getURL("https://s1-lbel.tiendabelcorp.com/cl/");
// Assertion For Lbel
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[2]"}));
// Assertion For Lbel
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[2]"}));
// Go to Cyzone
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[3]"}));
// Assertion For Cyzone
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[3]"}));
...
// start if statement
if (isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(3) > div > ul > li:nth-of-type(1) > div > div > div"})){
// Click on change variant (first color)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(3) > div > ul > li:nth-of-type(1) > div > div > div"});
...
takeScreenshot("logs/Screenshoots/yhygzM.png");
// select tone
...
// start if statement
if (isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(3) > div > ul > li:nth-of-type(4) > div > div > div"})){
// Click on fourth color to change variant
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(3) > div > ul > li:nth-of-type(4) > div > div > div"});
// Add Assertion for description(-) button
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'panel-title__minus\'])[1]"}));
...
clickOnElement( new String[] {XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]"});
// Take screenshot for first video is playing
takeScreenshot("logs/Screenshoots/JygNTO.png");
// video 2 is clickable
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[2]"}));
// click on video 2
clickOnElement( new String[] {XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[2]"});
// Take screenshot clicked video is playing
takeScreenshot("logs/Screenshoots/qiRtcC.png");
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//div[@class=\'div-tono shadeSelectedOpenBox\']/child::span[3]"}));
// End If Statement
}
// Subscribe popup
moveAndDoubleClickWithOffset(new String[]{XPATH, "//span[@class=\'share-btn-icon shareBtnShare\']"}, 24,24);
...
// Click on product
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200097895_fotocrosselling.jpg\"]"});
// scroll
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//span[@id=\'product_labels_P0132053000\']" },"logs/Screenshots/XkxEse.png");
// end if statement
}
// start else
else{
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//span[@id=\'product_labels_P0132053000\']"}));
// Take Snip Of Curcada
takeScreenshotOfParticularElement(new String[] { XPATH, "//span[@id=\'product_labels_P0132053000\']" },"logs/Screenshots/uhcbkM.png");
// End if statement
}
// start else
else{
...
String $x= "0";
// Start if condition
if (isElementAvailable(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[1]"})){
...
// Start if condition
if (isElementAvailable(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[2]"})){
...
// Start if condition
if (isElementAvailable(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[3]"})){
...
// Start if condition
if (isDisplayed(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[4]"}, 0)) {
...
// Start if condition
if (isDisplayed(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[5]"}, 0)) {
...
// Start if condition
if (isDisplayed(new String[] { XPATH, "(//div[@class=\'plyr__video-wrapper\']/following-sibling::button)[6]"}, 0)) {
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"/pe/maquillaje/ojos/studio-look/c/cyzone-020204\"]"}));
// Click on Studio Look
clickOnElement( new String[] {CSS, "a[href=\"/pe/maquillaje/ojos/studio-look/c/cyzone-020204\"]"});
// if clickable
if (isElementAvailable(new String[] { CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200093927_fotocrosselling.jpg\"]"})){
// Click on sombras de ojos...
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200093927_fotocrosselling.jpg\"]"});
// mouse hover on image
mouseHoverOnElement(new String[] {CSS, "div#StickyProductGallery > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(1) > div > div:nth-of-type(2) > div"});
...
// Click on shade
clickOnElement( new String[] {CSS, "div#StickyProductGallery > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(2) > div > div > div"});
// Click on cboxClose
...
// Click on shade
clickOnElement( new String[] {CSS, "div#StickyProductGallery > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(3) > div > div > div"});
// Click on cboxClose
clickOnElement( new String[] {ID, "cboxClose"});
...
// Click on shade
clickOnElement( new String[] {CSS, "div#StickyProductGallery > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(4) > div > div > div"});
// Click on cboxClose
clickOnElement( new String[] {ID, "cboxClose"});
// end if clickable
}
...
// Take screenshot video is in same browser
takeScreenshot("logs/Screenshoots/wZkgqE.png");
// end if video is present
}
// else for video is  not present
else{
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-2\']"}));
// Count total number of stamp
Assert.assertEquals(getChildElements(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-2\']" }).size(), "2");
// end of if statement
}
// add assertion for product name
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'name\']"}));
...
pageRefresh();
// Take Screenshot
takeScreenshot("logs/Screenshoots/dzhFUq.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'bic-cyzone-video-tutorials__item--description\']/parent::div[@id=\'bic-cyzone-video-tutorials-item-0\']"}));
// Take screenshot video is in same browser
takeScreenshot("logs/Screenshoots/YzDAEb.png");
// end if video visible
}
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "span[class=\"bic-cyzone-video-tutorials__subtitle\"]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"bic-cyzone-video-tutorials__info-text--container\"]"}));
// end if video visible
}
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h2[@bucket-positon=\'Bloque 1\']/following-sibling::div[@class=\'panel-title__minus\']"}));
// Validate \"reasons to love him\" minus symbol
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h2[@bucket-positon=\'Bloque 2\']/following-sibling::div[@class=\'panel-title__minus\']"}));
// validate \"cy steps\" minus symbol
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h2[@bucket-positon=\'Bloque 3\']/following-sibling::div[@class=\'panel-title__minus\']"}));
// Go to lbel product
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'swiper-wrapper swe_posts swe_show\']"}));
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(8) > div > div:nth-of-type(1) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > div > div:nth-of-type(1) > div > div:nth-of-type(2) > div"}));
...
// Add Assertion for video title
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[contains(@class,\"container-ratio-txt brand\")]"}));
// end if statement
}
// start else statement
else{
...
// if video visible
if (isDisplayed(new String[] { CSS, "main > div:nth-of-type(8) > div > div:nth-of-type(1) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > div > div:nth-of-type(1) > div > button"}, 0)) {
// Click on Play button
clickOnElement( new String[] {CSS, "main > div:nth-of-type(8) > div > div:nth-of-type(1) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > div > div:nth-of-type(1) > div > button"});
// take snip of video carousel
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"bic-cyzone-video-tutorials__main\"]" },"logs/Screenshots/tdSamz.png");
// Scroll Up
scroll("ScrollUp", 930);
// Scroll Down to video carousel
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"bic-cyzone-video-tutorials__main\"]" },"logs/Screenshots/jHUJlH.png");
// Assertion for video carousel
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"bic-cyzone-video-tutorials__main\"]"}));
// end if video visible
}
...
// Click on play
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > ul > div > div > div:nth-of-type(8) > div > li > a > div"});
// Click on pause
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(3) > div > div:nth-of-type(1) > div > div:nth-of-type(4) > div > div > div:nth-of-type(1) > div"});
// Switch to iframe 
switchToIFrame(new String[] {CSS, "iframe"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//img[contains(@class,\"js-responsive-image\") and contains(@alt,\"Bic Cyzone Virtual Makeup Image Simple Responsive Banner\")]"}));
// Assertion for bic-virtual-makeup-component__carousel
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"bic-virtual-makeup-component__carousel\"]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//a[contains(text(),\'Máscara de pestañas studio look\')]"}));
// Assertion for crema hidratante facial en gel skin first
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//a[contains(text(),\'crema hidratante facial en gel skin first\')]"}));
...
// Take Snip
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'item\'])[1]" },"logs/Screenshots/ZLcuDJ.png");
// Click On image
...
takeScreenshotOfParticularElement(new String[] { CSS, "span[class=\"yCmsComponent btn btn-primary\"]" },"logs/Screenshots/LFmroY.png");
// add assertion for  try it live
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"https://cyzone.cyzone.com/pe/maquillador-virtual/\"]"}));
...
takeScreenshotOfParticularElement(new String[] { CSS, "a[href=\"/labial-studio-look-mate-smokey-nude/p/200102116\"]" },"logs/Screenshots/kauZEe.png");
// add assertion for  lipstick studio look matte to buy button
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"/labial-studio-look-mate-smokey-nude/p/200102116\"]"}));
...
takeScreenshotOfParticularElement(new String[] { CSS, "a[href=\"/mascara-de-pestanas-studio-look/p/200101074\"]" },"logs/Screenshots/nBFYfy.png");
// add assertion for  Studio look mascara button
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"/mascara-de-pestanas-studio-look/p/200101074\"]"}));
...
takeScreenshotOfParticularElement(new String[] { CSS, "a[href=\"/crema-hidratante-facial-en-gel-skin-first/p/200097894\"]" },"logs/Screenshots/NrJaks.png");
// add assertion for skin first gel facial moisturizer to buy
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"/crema-hidratante-facial-en-gel-skin-first/p/200097894\"]"}));
// Hover on see all products
mouseHoverOnElement(new String[] {CSS, "a[href=\"https://cyzone.tiendabelcorp.com/pe/studio-look/c/cyzone-07\"]"});
// take snip of see all products
takeScreenshotOfParticularElement(new String[] { CSS, "a[href=\"https://cyzone.tiendabelcorp.com/pe/studio-look/c/cyzone-07\"]" },"logs/Screenshots/smFqum.png");
// Assert for see all products
Assert.assertTrue(isElementAvailable(new String[] { CSS, "a[href=\"https://cyzone.tiendabelcorp.com/pe/studio-look/c/cyzone-07\"]"}));
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'product-item-info\'])[2]" },"logs/Screenshots/uLiUKa.png");
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { CSS, "div#CyzoneBicPromotionsLandingPageSection3" },"logs/Screenshots/ajTLFe.png");
// end if statement
}
// start else statement
else{
...
// Click on product
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200095855-FotoFondoBlancoSB.jpg\"]"});
...
if (isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(5) > div > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > span"})){
// Click on Next promotion arrow
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(5) > div > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > span"});
// Click on Next promotion arrow
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(5) > div > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > span"});
// refresh
pageRefresh();
...
clickOnElement( new String[] {XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"});
// Click on fragrance category
clickOnElement( new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 4 Simple Responsive Banner Component\"]"});
// start of if loop
...
Assert.assertTrue(isElementClickable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(5) > div > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > span"}));
// End of if loop
}
// End of if loop
}
...
// start of if loop
if (isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(1) > div:nth-of-type(1) > div > div > div:nth-of-type(2)"})){
// Assertion on minus navigation
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(1) > div:nth-of-type(1) > div > div > div:nth-of-type(2)"}));
// Click on get to know him(-)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(1) > div:nth-of-type(1) > div > div > div:nth-of-type(2)"});
// Click on reasons to love him(+)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(2) > div:nth-of-type(1) > div > div > div:nth-of-type(1)"});
// Click on reasons to love him(-)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(2) > div:nth-of-type(1) > div > div > div:nth-of-type(2)"});
// Assertion on plus navigation
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(3) > div:nth-of-type(1) > div > div > div:nth-of-type(1)"}));
// Click on cy steps(+)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(3) > div:nth-of-type(1) > div > div > div:nth-of-type(1)"});
// Click on cy steps(-)
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(7) > div:nth-of-type(3) > div:nth-of-type(1) > div > div > div:nth-of-type(2)"});
...
goForward();
// take screenshot
takeScreenshot("logs/Screenshoots/mabpoj.png");
...
pageRefresh();
// take screenshot
takeScreenshot("logs/Screenshoots/RDvSrF.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[contains(@class,\"horizontal-scroll-list__large-title\")]"}));
// take a snip to verify Products visible in the carousel before  click arrows on desktop
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"horizontal-scroll-list__product-cards\"]" },"logs/Screenshots/AZAEbX.png");
// end if present
}
// Scroll Down
scroll("ScrollDown", 2786);
// take a snip to verify Products not visible in the carousel before the user drags the carousel
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"EsikaBicSection6\"]" },"logs/Screenshots/wTZnrI.png");
// Add Assertion for The top recommendations
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h2[contains(@class,\"horizontal-slider__title js-multi-text-product-carousel-title\")]"}));
...
// count of videos
if (checkContainsValue(new String[] { XPATH, "//div//div//div//div//div//div//div[@data-slick-index=\"0\"]"}, "5")){
// click on arrow
clickOnElement( new String[] {XPATH, "//button[@class=\'slick-next slick-arrow\']"});
// end if
}
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"div-tono shadeSelectedOpenBox\"]"}));
// Add Assertion for img
Assert.assertTrue(isElementAvailable(new String[] { CSS, "img[class=\"lazy loaded\"][alt=\"Contour Parfait Polvo Compacto\"][src=\"/cdn-cgi/image/width=96,fit=contain,f=auto/https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200095428_galeria1_PolvosContour_Rose.jpg\"]"}));
// end if statement
}
// start else statement
else{
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'div-tono shadeSelectedOpenBox\']"}));
// Add Assertion for img
Assert.assertTrue(isElementAvailable(new String[] { CSS, "img[class=\"lazy loaded\"][alt=\"Labial Hidracolor Mate\"][src=\"/cdn-cgi/image/width=96,fit=contain,f=auto/https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200102305-FotoProducto.jpg\"]"}));
// end if statement
}
// start else statement
else{
...
takeScreenshot("logs/Screenshoots/yrYzSy.png");
// Click on LBEL
...
takeScreenshot("logs/Screenshoots/MyNvxw.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-5\']"}));
// Count total number of stamp
Assert.assertEquals(getChildElements(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-5\']" }).size(), "5");
// end if
}
// Add assertion for product name
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'name\']"}));
...
// Click on 4th image
javascriptExecution("document.querySelector(\"ul#productGalleryThumbnails div:nth-child(8) > div > li > a > img\").click();");
// Assertion on \"GIF is available\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\"gallery-video-thumbnail__play\"])[1]"}));
...
Assert.assertFalse(isElementAvailable(new String[] { XPATH, "(//div[@class=\"gallery-video-thumbnail__play\"])[1]"}));
// end if
}
