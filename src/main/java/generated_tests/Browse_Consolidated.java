...
public class Browse_Consolidated extends WebDriverHelper {
  ...
  @Test
  public void VIDEO_TUTORIALS_Check_the_amount_of_contents_of_the_carouselCOneThreeTwoEight_COneThreeThreeSix() {
    javascriptExecution(
      "lambda-name=VIDEO TUTORIALS Check the amount of contents of the carouselCOneThreeTwoEight COneThreeThreeSix");
    ...
    // Start If Statement
    if (checkVariableAssertion("variableLessThanOrEqualsValue", String.valueOf($x), "8")) {
      // Assertion
      Assert.assertTrue(checkVariableAssertion("variableLessThanValue", String.valueOf($x), "8"));
      // Print in Console
  ...
  @Test
  public void HYBRISVOneNineFourTwoNine__PRODUCT_NAME_IN_FIXED_BAR_FROM_THE_BEGINNINGCOneFourOneSeven_COneFourSixTwo() {
    javascriptExecution(
      "lambda-name=HYBRISVOneNineFourTwoNine  PRODUCT NAME IN FIXED BAR FROM THE BEGINNINGCOneFourOneSeven COneFourSixTwo");
  ...
  @Test
  public void PromotionsCThreeTwoTwoFive() {
    javascriptExecution("lambda-name=PromotionsCThreeTwoTwoFive");
  ...
  @Test
  public void UGC_INSERTION_THROUGH_GALLERY__CThreeTwoFourSix() {
    javascriptExecution("lambda-name=UGC INSERTION THROUGH GALLERY  CThreeTwoFourSix");
  ...
  @Test
  public void HYBRISVOneOneSevenNineThreeFour() {
    javascriptExecution("lambda-name=HYBRISVOneOneSevenNineThreeFour");
    ...
    takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'product-item-info\'])[2]" },
      "logs/Screenshots/uonrZS.png");

    status = "passed";
  }

  @Test
  public void TONE_DROPOFF_BARcyzoneProduct_with_VariantsCOneFourThreeFive__CThreeTwoThreeSix() {
    javascriptExecution("lambda-name=TONE DROPOFF BARcyzoneProduct with VariantsCOneFourThreeFive  CThreeTwoThreeSix");
    ...
    if (isElementAvailable(new String[] { XPATH, "//span[@class=\"variantName\"]" })) {
      ...
      takeScreenshot("logs/Screenshoots/yJNxQM.png");
      // if tone present
      if (isElementAvailable(new String[] { XPATH, "(//span[@class=\"js-tm-variant-category-pdp \"])[2]" })) {
        // select tone
  ...
  @Test
  public void TONE_DROPOFF_BAR_Without_VariationsCOneFourThreeSix() {
    javascriptExecution("lambda-name=TONE DROPOFF BAR Without VariationsCOneFourThreeSix");
  ...
  @Test
  public void Carrousel_de_contenidos__esikaCOneThreeSixThree() {
    javascriptExecution("lambda-name=Carrousel de contenidos  esikaCOneThreeSixThree");
    ...
    goForward();
    // take screenshot
    takeScreenshot("logs/Screenshoots/jgGLga.png");
    ...
    pageRefresh();
    // take screenshot
    takeScreenshot("logs/Screenshoots/VBWnzV.png");
  ...
  @Test
  public void VIDEO_TUTORIALES__Verificar_que_solo_se_reproduce_un_contenido_a_la_vez__COneThreeTwoFive_COneThreeThreeThree() {
    javascriptExecution(
      "lambda-name=VIDEO TUTORIALES  Verificar que solo se reproduce un contenido a la vez  COneThreeTwoFive COneThreeThreeThree");
    ...
    if (isDisplayed(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]" }, 0)) {
      ...
      takeScreenshot("logs/Screenshoots/NXhbDk.png");
      ...
      takeScreenshot("logs/Screenshoots/UQVPOC.png");
  ...
  @Test
  public void Featured_Images_and_VideoCThreeTwoTwoFour() {
    javascriptExecution("lambda-name=Featured Images and VideoCThreeTwoTwoFour");
  ...
  @Test
  public void Name_of_product__CThreeTwoTwoSeven() {
    javascriptExecution("lambda-name=Name of product  CThreeTwoTwoSeven");
  ...
  @Test
  public void TUTORIAL_VIDEOS__Verify_behavior_of_the_video_carouselCOneSevenSixThreeFiveFiveCOneThreeTwoSix() {
    javascriptExecution(
      "lambda-name=TUTORIAL VIDEOS  Verify behavior of the video carouselCOneSevenSixThreeFiveFiveCOneThreeTwoSix");
  ...
  @Test
  public void shop_by_category_FRONT__COneThreeSevenEight__CThreeOneSevenFive() {
    javascriptExecution("lambda-name=shop by category FRONT  COneThreeSevenEight  CThreeOneSevenFive");
  ...
  @Test
  public void HYBRISOneEightzeroFourOne() {
    javascriptExecution("lambda-name=HYBRISOneEightzeroFourOne");
  ...
  @Test
  public void DYNAMIC_RICH_RELEVANCE_CARROUSSELS_IN_POSITIONCOneFourFiveSix__CThreeTwoThreeFour() {
    javascriptExecution(
      "lambda-name=DYNAMIC RICH RELEVANCE CARROUSSELS IN POSITIONCOneFourFiveSix  CThreeTwoThreeFour");
  ...
  @Test
  public void Verify_that_the_content_is_played_in_the_same_browser__COneThreeTwoFour_COneThreeThreeTwo() {
    javascriptExecution(
      "lambda-name=Verify that the content is played in the same browser  COneThreeTwoFour COneThreeThreeTwo");
    ...
    if (isDisplayed(new String[] { XPATH, "//div[@class=\'content\']/child::p" }, 0)) {
      ...
      takeScreenshot("logs/Screenshoots/xGCBOQ.png");
      // end if video visible
    }
  ...
  @Test
  public void PopupsCThreeTwoThreeFive() {
    javascriptExecution("lambda-name=PopupsCThreeTwoThreeFive");
  ...
  @Test
  public void PRODUCT_CAROUSEL_Static_behavior_and_its_elementsCOneThreezeroFour() {
    javascriptExecution("lambda-name=PRODUCT CAROUSEL Static behavior and its elementsCOneThreezeroFour");
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "span[class=\"yCmsComponent btn btn-primary\"]" },
      "logs/Screenshots/zzrBxB.png");
    // add assertion for  try it live
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "a[href=\"https://cyzone.cyzone.com/pe/maquillador-virtual/\"]" }));
    ...
    takeScreenshotOfParticularElement(
      ...
      "logs/Screenshots/POxflR.png");
    // add assertion for  lipstick studio look matte to buy button
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "a[href=\"/labial-studio-look-mate-smokey-nude/p/200102116\"]" }));
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "a[href=\"/mascara-de-pestanas-studio-look/p/200101074\"]" },
      "logs/Screenshots/gKkHLl.png");
    // add assertion for  Studio look mascara button
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "a[href=\"/mascara-de-pestanas-studio-look/p/200101074\"]" }));
    ...
    takeScreenshotOfParticularElement(
      ...
      "logs/Screenshots/WHpcyD.png");
    // add assertion for skin first gel facial moisturizer to buy
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "a[href=\"/crema-hidratante-facial-en-gel-skin-first/p/200097894\"]" }));
  ...
  @Test
  public void HYBRISVOneOneOneSevenSevenSeven__ECOMPDP_A_variant_without_price_makes_the_price_not_shown_in_the_restCThreeTwoFiveFour() {
    javascriptExecution(
      "lambda-name=HYBRISVOneOneOneSevenSevenSeven  ECOMPDP A variant without price makes the price not shown in the restCThreeTwoFiveFour");
    ...
    takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"product-main-info\"]" },
      "logs/Screenshots/FkyhYR.png");

    status = "passed";
  }

  @Test
  public void HYBRISVOneOneSevenNineNinezero() {
    javascriptExecution("lambda-name=HYBRISVOneOneSevenNineNinezero");
  ...
  @Test
  public void UPDATE_NAVIGATION_ICONS_BY_BRAND__ESIKA_Product_with_VariantsCOneFourTwoNine__CThreeTwoThreeSeven() {
    javascriptExecution(
      "lambda-name=UPDATE NAVIGATION ICONS BY BRAND  ESIKA Product with VariantsCOneFourTwoNine  CThreeTwoThreeSeven");
  ...
  @Test
  public void DYNAMIC_RICH_RELEVANCE_CARROUSSELS_IN_POSITIONCOneFourFiveSeven__CThreeTwoThreeFour() {
    javascriptExecution(
      "lambda-name=DYNAMIC RICH RELEVANCE CARROUSSELS IN POSITIONCOneFourFiveSeven  CThreeTwoThreeFour");
  ...
  @Test
  public void TONE__ESIKA_DROP_BAR_Product_with_Variants_COneFourThreeThree__CThreeTwoThreeSix() {
    javascriptExecution("lambda-name=TONE  ESIKA DROP BAR Product with Variants COneFourThreeThree  CThreeTwoThreeSix");
  ...
  @Test
  public void Accordions__Buckets___SealsCThreeTwoTwoThree() {
    javascriptExecution("lambda-name=Accordions  Buckets   SealsCThreeTwoTwoThree");
  ...
  @Test
  public void Images_and_Video_in_gallery__CThreeTwoTwoSix() {
    javascriptExecution("lambda-name=Images and Video in gallery  CThreeTwoTwoSix");

    // Go to URL
    getURL("https://s1-lbel.tiendabelcorp.com/cl/concentre-total-crema-para-rostro/p/200099969/MaryEmy/");
    // click on video
  ...
  @Test
  public void HYBRISVOneOneOneThreeEightSix__Panama__PDP__Discriminate_verified_reviews_in_the_countries_that_applyCThreeTwoFiveThree() {
    javascriptExecution(
      "lambda-name=HYBRISVOneOneOneThreeEightSix  Panama  PDP  Discriminate verified reviews in the countries that applyCThreeTwoFiveThree");
    ...
    takeScreenshot("logs/Screenshoots/tcIQeu.png");
    // Click on LBEL
    ...
    takeScreenshot("logs/Screenshoots/NxtLGc.png");

    status = "passed";
  }

  @Test
  public void Check_the_behavior_of_the_guidesCOneThreeTwoNine_COneThreeThreeSeven() {
    javascriptExecution("lambda-name=Check the behavior of the guidesCOneThreeTwoNine COneThreeThreeSeven");
  ...
  @Test
  public void THUMBNAIL_FOR_FEATURED_VIDEOHYBRISVOneFourEightFiveNineCThreeTwoThreezero() {
    javascriptExecution("lambda-name=THUMBNAIL FOR FEATURED VIDEOHYBRISVOneFourEightFiveNineCThreeTwoThreezero");
  ...
  @Test
  public void UPDATE_NAVIGATION_ICONS_BY_BRAND__Product_with_Variants__CThreeTwoThreeSeven() {
    javascriptExecution("lambda-name=UPDATE NAVIGATION ICONS BY BRAND  Product with Variants  CThreeTwoThreeSeven");
  ...
  @Test
  public void HYBRISVOneFourEightSevenzero__THUMBNAIL_FOR_VIDEO_IN_GALLERY_FROM_MDM__CThreeTwoFivezero() {
    javascriptExecution(
      "lambda-name=HYBRISVOneFourEightSevenzero  THUMBNAIL FOR VIDEO IN GALLERY FROM MDM  CThreeTwoFivezero");
  ...
  @Test
  public void FEATURED_VIDEO_TITLE__HYBRISVOneNinezeroThreeEightCThreeTwoFourFive() {
    javascriptExecution("lambda-name=FEATURED VIDEO TITLE  HYBRISVOneNinezeroThreeEightCThreeTwoFourFive");
  ...
  @Test
  public void Stamp_bar__lbel__COneFourThreeNine__CThreeTwoThreeNine() {
    javascriptExecution("lambda-name=Stamp bar  lbel  COneFourThreeNine  CThreeTwoThreeNine");
    ...
    if (isElementAvailable(new String[] { XPATH, "//a[contains(@id,\'product_productName_200090365\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-2\']" })) {
        ...
        Assert.assertEquals(
          String.valueOf(getChildElements(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-2\']" }).size()),
          "2");
        // end of if statement
      }
      // add assertion for product name
  ...
  @Test
  public void VIDEO_TUTORIALS__Verify_behavior_of_the_arrows_swipeCOneThreeTwoSeven_COneThreeThreeFive() {
    javascriptExecution(
      "lambda-name=VIDEO TUTORIALS  Verify behavior of the arrows swipeCOneThreeTwoSeven COneThreeThreeFive");
  ...
  @Test
  public void TITLE_UGC_GALLERY__CThreeTwoThreeThree() {
    javascriptExecution("lambda-name=TITLE UGC GALLERY  CThreeTwoThreeThree");
  ...
  @Test
  public void HYBRISVOneOnezeroFourThreeTwoCThreeOneNineThree() {
    javascriptExecution("lambda-name=HYBRISVOneOnezeroFourThreeTwoCThreeOneNineThree");
  ...
  @Test
  public void HYBRISVOneNineFourTwoNine_NOMBRE_DE_PRODUCTO_EN_FIXED_BAR_DESDE_EL_INICIOCOneFourOneSeven_COneFourSixTwo() {
    javascriptExecution(
      "lambda-name=HYBRISVOneNineFourTwoNine NOMBRE DE PRODUCTO EN FIXED BAR DESDE EL INICIOCOneFourOneSeven COneFourSixTwo");
  ...
  @Test
  public void PROMOTIONS_IN_MENU__COneThreeSixSeven__CThreeOneSevenzero() {
    javascriptExecution("lambda-name=PROMOTIONS IN MENU  COneThreeSixSeven  CThreeOneSevenzero");
  ...
  @Test
  public void PANTALLA_PARA_DESPLEGAR_IMAGENES_ZOOMCThreeTwoFiveFive() {
    javascriptExecution("lambda-name=PANTALLA PARA DESPLEGAR IMAGENES ZOOMCThreeTwoFiveFive");
  ...
  @Test
  public void HYBRISVOneFourEightSevenzero__THUMBNAIL_FOR_VIDEO_IN_GALLERY_FROM_MDMCThreeTwoFivezero() {
    javascriptExecution(
      "lambda-name=HYBRISVOneFourEightSevenzero  THUMBNAIL FOR VIDEO IN GALLERY FROM MDMCThreeTwoFivezero");
  ...
  @Test
  public void UPDATE_NAVIGATION_ICONS_BY_BRAND__LBEL_Product_without__VariantsCOneFourThreezero() {
    javascriptExecution(
      "lambda-name=UPDATE NAVIGATION ICONS BY BRAND  LBEL Product without  VariantsCOneFourThreezero");
  ...
  @Test
  public void PRODUCT_CAROUSEL_Video_behavior__COneThreezeroSeven() {
    javascriptExecution("lambda-name=PRODUCT CAROUSEL Video behavior  COneThreezeroSeven");
    ...
    if (isElementAvailable(new String[] { XPATH,
      ...
      clickOnElement(new String[] { XPATH, "//button[@class=\'plyr__control plyr__control--overlaid\']" });
      // Take screenshot video is in same browser
      takeScreenshot("logs/Screenshoots/jDkCTP.png");
  ...
  @Test
  public void MARKINGS_IN_CARROUSELL_DE_RICH_RELEVANCE__DISPLACEMENT__PRODUCT_IMPRESSION__SevenEightFourFour__CThreeTwoThreeEight() {
    javascriptExecution(
      "lambda-name=MARKINGS IN CARROUSELL DE RICH RELEVANCE  DISPLACEMENT  PRODUCT IMPRESSION  SevenEightFourFour  CThreeTwoThreeEight");
  ...
  @Test
  public void HYBRISVOneSevenThreezeroSevenCOneThreeSevenNine() {
    javascriptExecution("lambda-name=HYBRISVOneSevenThreezeroSevenCOneThreeSevenNine");
  ...
  @Test
  public void STAMP_BAR__CThreeTwoThreeNine() {
    javascriptExecution("lambda-name=STAMP BAR  CThreeTwoThreeNine");
    ...
    if (isElementAvailable(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-4\']" })) {
      ...
      // Add Assertion for total no of stamp
      Assert.assertEquals(
        String.valueOf(getChildElements(new String[] { XPATH, "//div[@class=\'seals-flex-container-wp seals-items-4\']" }).size()),
        "4");
      // End  If Statement
    }
    // Start Else  Statement
  ...
  @Test
  public void IMAGE_DISPLAY_SCREEN_ZOOM__COneEightThreeEightSixzero__CThreeTwoFiveFive() {
    javascriptExecution("lambda-name=IMAGE DISPLAY SCREEN ZOOM  COneEightThreeEightSixzero  CThreeTwoFiveFive");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "a[href=\"/pe/maquillaje/ojos/studio-look/c/cyzone-020204\"]" }));
  ...
  @Test
  public void Component__ANCHOR_HEADER_BRANDS__COneTwoEightSeven__CThreeOneSixEight() {
    javascriptExecution("lambda-name=Component  ANCHOR HEADER BRANDS  COneTwoEightSeven  CThreeOneSixEight");
  ...
  @Test
  public void Seal_bar_cyzoneCOneFourFourzero() {
    javascriptExecution("lambda-name=Seal bar cyzoneCOneFourFourzero");
  ...
  @Test
  public void HYBRISVOneNineFourFiveOneCOneThreeSevenOne() {
    javascriptExecution("lambda-name=HYBRISVOneNineFourFiveOneCOneThreeSevenOne");
  ...
  @Test
  public void HYBRISVOneOnezeroSixzeroOne__ECOM__Unexpected_error_when_adding_variant_product_without_price_COneFourOneFive_COneFourSixzeroCThreeTwoFourNine() {
    javascriptExecution(
      "lambda-name=HYBRISVOneOnezeroSixzeroOne  ECOM  Unexpected error when adding variant product without price COneFourOneFive COneFourSixzeroCThreeTwoFourNine");
  ...
  @Test
  public void VIDEO_TUTORIALS__Check_component_designCOneThreeTwoThree_COneThreeThreeOne() {
    javascriptExecution("lambda-name=VIDEO TUTORIALS  Check component designCOneThreeTwoThree COneThreeThreeOne");
  ...
  @Test
  public void Carrousel_de_contenidos_LbelCOneThreeSixFour() {
    javascriptExecution("lambda-name=Carrousel de contenidos LbelCOneThreeSixFour");
  ...
  @Test
  public void Carrousel_de_contenidos_cyzoneCOneThreeSixFive() {
    javascriptExecution("lambda-name=Carrousel de contenidos cyzoneCOneThreeSixFive");
    ...
    pageRefresh();
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/yccGDt.png");

    status = "passed";
  }

  @Test
  public void RICH_RELEVANCE_CARROUSSELS_AND_DYNAMIC_UGC_IN_POSITIONCThreeTwoThreeFour() {
    javascriptExecution("lambda-name=RICH RELEVANCE CARROUSSELS AND DYNAMIC UGC IN POSITIONCThreeTwoThreeFour");
  ...
  @Test
  public void STAMP_BAR__ESIKACOneFourThreeEight__CThreeTwoThreeNine() {
    javascriptExecution("lambda-name=STAMP BAR  ESIKACOneFourThreeEight  CThreeTwoThreeNine");
  ...
  @Test
  public void Creation_of_spinner_by_clicking_on_the_add_to_cart_Set_Variables_and_Palette___CThreezeroFiveNine_CThreezeroSixFour() {
    javascriptExecution(
      "lambda-name=Creation of spinner by clicking on the add to cart Set Variables and Palette   CThreezeroFiveNine CThreezeroSixFour");
  ...
  @Test
  public void UPDATE_NAVIGATION_ICONS_BY_BRANDNo_VariantsCOneFourThreeTwo() {
    javascriptExecution("lambda-name=UPDATE NAVIGATION ICONS BY BRANDNo VariantsCOneFourThreeTwo");
  ...
  @Test
  public void TITULO_EN_VIDEO_DESTACADO_HYBRISVOneNinezeroThreeEight__CThreeTwoFourFive() {
    javascriptExecution("lambda-name=TITULO EN VIDEO DESTACADO HYBRISVOneNinezeroThreeEight  CThreeTwoFourFive");
  ...
  @Test
  public void UPDATE_NAVIGATION_ICONS_BY_BRANDcyzoneProduct_with_VariantsCOneFourThreeOne__CThreeTwoThreeSeven() {
    javascriptExecution(
      "lambda-name=UPDATE NAVIGATION ICONS BY BRANDcyzoneProduct with VariantsCOneFourThreeOne  CThreeTwoThreeSeven");
  ...
  @Test
  public void SET_ICONS_BY_BRAND_IN_TONE_FOLDERCThreeTwoThreeOne() {
    javascriptExecution("lambda-name=SET ICONS BY BRAND IN TONE FOLDERCThreeTwoThreeOne");
  ...
  @Test
  public void Verify_that_only_one_content_is_played_at_a_time__COneThreeTwoFive_COneThreeThreeThree() {
    javascriptExecution(
      "lambda-name=Verify that only one content is played at a time  COneThreeTwoFive COneThreeThreeThree");
    ...
    if (isDisplayed(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]" }, 0)) {
      ...
      clickOnElement(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[1]" });
      // Take screenshot for first video is playing
      takeScreenshot("logs/Screenshoots/oUxWnq.png");
      // video 2 is clickable
      Assert.assertTrue(
        isElementClickable(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[2]" }));
      // click on video 2
      clickOnElement(new String[] { XPATH, "(//button[@class=\'plyr__control plyr__control--overlaid\'])[2]" });
      // Take screenshot clicked video is playing
      takeScreenshot("logs/Screenshoots/aiQKjG.png");
  ...
  @Test
  public void PRODUCT_CAROUSEL_Behavior_on_clickCOneThreezeroThree() {
    javascriptExecution("lambda-name=PRODUCT CAROUSEL Behavior on clickCOneThreezeroThree");
  ...
  @Test
  public void PRODUCT_CAROUSEL_DesignCOneThreezeroTwo() {
    javascriptExecution("lambda-name=PRODUCT CAROUSEL DesignCOneThreezeroTwo");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//div[@class=\"bic-virtual-makeup-component__carousel\"]" }));
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//a[contains(text(),\'Máscara de pestañas studio look\')]" }));
  ...
  @Test
  public void UPDATE_GALLERY_CAROUSEL_ICONSCThreeTwoFourTwo() {
    javascriptExecution("lambda-name=UPDATE GALLERY CAROUSEL ICONSCThreeTwoFourTwo");
  ...
  @Test
  public void GIFS_IN_GALLERYCThreeTwoFiveSeven() {
    javascriptExecution("lambda-name=GIFS IN GALLERYCThreeTwoFiveSeven");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "(//div[@class=\"gallery-video-thumbnail__play\"])[1]" }));
  ...
  @Test
  public void PRODUCT_CAROUSEL_MTO__Video_behavior__COneThreeSixzero() {
    javascriptExecution("lambda-name=PRODUCT CAROUSEL MTO  Video behavior  COneThreeSixzero");
    ...
    if (isElementAvailable(new String[] { XPATH,
      ...
      // Take screenshot video is in same browser
      takeScreenshot("logs/Screenshoots/xbGLvN.png");
      // end if video is present
    }
    // else for video is  not present
    else {
