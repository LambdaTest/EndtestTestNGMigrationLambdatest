...
public class Checkout_Consolidated extends WebDriverHelper {
    ...
    public void scenario_OneCOneSevenEightNineEightSixCOneTwoOneNineCTwoEightNineNine() {
        ...
        clickOnElement(
                new String[]{XPATH, "(//a[@class=\"btn btn-just-border btn-block js-mini-cart-close-button \"])[2]"});
...
// click on enter key
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"quantity reduce button is not present\"");
            // end else statement
        }
        // scroll
        scroll("ScrollDown", 350);
...
// click on enter key
        ...
        // Add Assertion for The quantity of the product has been updated.
        Assert.assertTrue(
                isElementFound(new String[]{XPATH, "//div[@class=\"alert alert-success alert-dismissable\"]"}));
        // scroll down
        scroll("ScrollDown", 305);
        // clear qty
    ...
    */
        // write text in quantity
        updateValueOfElementViaJS(new String[]{XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]//input[@id=\"quantity_1\"]"},
                "2");
// click on enter key
        pressKey(new String[]{XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]//input[@id=\"quantity_1\"]"},
                "ENTER");
    ...
    public void HYBRISVOneOneEightzerozeroFour() {
        ...
        if (isElementClickable(new String[]{XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]"})) {
            ...
            takeScreenshotOfParticularElement(new String[]{CSS, "tr > td"}, "logs/Screenshots/qfiTer.png");
        ...
        // start else statement
            ...
            takeScreenshot("logs/Screenshoots/AuyfzC.png");
    ...
    public void ECOMMX_Free_shipping_bar_settingCOneTwoTwoSix() {
        ...
        if (checkContainsValue(
                ...
                "¡Felicitaciones, alcanzaste el envío gratis!")) {
            // print result
            printResults("PrintNote", "\"free shipping bar is present\"");
            // end if
        }
        ...
        takeScreenshot("logs/Screenshoots/rRJgrv.png");
    ...
    public void Send_as_gift_optionCTwoNineOneOnephaseTwo() {
        ...
        if (isElementClickable(new String[]{XPATH, "//button[@id=\'addToCartButton\']"})) {
            ...
            takeScreenshotOfParticularElement(new String[]{CSS, "tr > td"}, "logs/Screenshots/OSNEWb.png");
            // start if statement
            if (isElementAvailable(new String[]{XPATH, "//div[contains(text(),\'Regalo\')]"})) {
                ...
                takeScreenshotOfParticularElement(new String[]{CSS, "div.send-gift > div"}, "logs/Screenshots/IIdexd.png");
                ...
                takeScreenshot("logs/Screenshoots/INMrhr.png");
                // end if statement
            }
            // Start else
            else {
    ...
    public void MTO_CO_Change_of_message_of_Maximum_amount_per_order_COneTwoThreeEight() {
        ...
        // Start else
            ...
            // print result
            printResults("PrintNote", "\"product reaches maximum amount message is not coming  \"");
            // End else
        }
    ...
    public void MTO_Go_back_to_the_bagCOneEightThreeNineNineFourCOneTwoFourNineCTwoNineTwoOne() {
        ...
        Assert.assertTrue(isElementAvailable(new String[]{XPATH, "//h1[@class=\'cart-headline\']"}));
        // Take Screenshot
        takeScreenshot("logs/Screenshoots/UWbFVb.png");
    ...
    public void Ecomm_MX_Change_of_message_of_Maximum_amount_per_order_COneTwoThreeSix() {
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"reaches maxm amount message is not coming\"");
            // end else statement
        }
    ...
    public void Cart_IDTwoNinezeroSix() {
        ...
        takeScreenshotOfParticularElement(new String[]{CSS, "h1 > span"}, "logs/Screenshots/qErcSV.png");
        // clear cache
        // Clear cookies
        // deleteAllCookies();
        // Clear storage
        ...
        takeScreenshotOfParticularElement(new String[]{CSS, "h1 > span"}, "logs/Screenshots/tRuDJc.png");
    ...
    public void MTO_EC_Change_of_message_of_Maximum_amount_per_orderCOneTwoFourOne() {
        ...
        // Start Else Statement
            ...
            // Print Result
            printResults("PrintNote", "\"maxm amount error message  is not coming\"");
            // End Else Statement
        }
    ...
    public void MTOCOFree_shipping_bar_settingCOneTwoTwoEight() {
        ...
        // Click on go pay
        clickOnElement(new String[]{XPATH, "//li//a[contains(text(),\' Ir a pagar\')]"});
       // moveAndDoubleClickWithOffset(        new String[]{XPATH, "//div[@class=\'row row-bar\']/child::div[2]/child::div/child::button[2]"}, 60, 60);
        //
       // clickOnElement(
       //          new String[]{XPATH, "//div[@class=\'row row-bar\']/child::div[2]/child::div/child::button[2]"});
        ...
        takeScreenshot("logs/Screenshoots/RWiTpH.png");
        // Click on Eliminar
        //  clickOnElement(new String[]{CSS,
    ...
    public void ECOM_Login_as_a_guestCOneEightThreeNineNineSevenCOneTwoFiveSixCTwoNineTwoFour() {
        ...
        Assert.assertTrue(
                isElementFound(new String[]{XPATH, "//input[@id=\'Marca si perteneces al régimen común.\']"}));
...
//      isElementAvailable(new String[] { XPATH, "//div[@class=\"alert alert-success alert-dismissable\"]" }));
     ...
     /*   pressKey(new String[]{XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]//input[@id=\"quantity_1\"]"},
        ...
        // Start else
            ...
            // Print Result
            printResults("PrintNote", "\"congratulation message is not present\"");
            // End else
        }
        // Scroll Down
        scroll("ScrollDown", 442);
    ...
    public void MTO_PA_Change_of_Message_from_Maximum_Amount_per_Order_COneTwoFourTwo() {
      ...
      */
        // write text in quantity
        updateValueOfElementViaJS(new String[]{XPATH, "(//input[@class='form-control js-update-entry-quantity-input'])[2]"},
                "1000");
        // handle the popup
    ...
    public void scenario_TwoCOneSevenEightNineEightSevenCOneTwoTwozeroCTwoNinezerozero() {
     ...
     /*   pressKey(new String[]{XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]//input[@id=\"quantity_0\"]"},
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"decrease quantity button is not present\"");
            // end else statement
        }
        // scroll
        scroll("ScrollDown", 350);
