...
public class Checkout_Consolidated extends WebDriverHelper {
  ...
  public void MTOCOFree_shipping_bar_settingC() {
    ...
    takeScreenshot("logs/Screenshoots/ThVeHY.png");
    // Click on Eliminar
    clickOnElement(new String[] { CSS,
  ...
  public void ECOMMX_Free_shipping_bar_settingC() {
    ...
    takeScreenshot("logs/Screenshoots/MqYFOl.png");
  ...
  public void MTO_Go_back_to_the_bagCCC() {
    ...
    Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'cart-headline\']" }));
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/OdzRKW.png");
  ...
  public void Cart_ID() {
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "h1 > span" }, "logs/Screenshots/OIXHqt.png");
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "h1 > span" }, "logs/Screenshots/twHpae.png");
  ...
  public void Send_as_gift_optionCphase() {
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/tBeeWl.png");
      // start if statement
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Regalo\')]" })) {
        ...
        takeScreenshotOfParticularElement(new String[] { CSS, "div.send-gift > div" }, "logs/Screenshots/SmtIIO.png");
        ...
        takeScreenshot("logs/Screenshoots/HORhUU.png");
        // end if statement
      }
  ...
  public void HYBRISV() {
    ...
    if (isElementClickable(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/BGQTHN.png");
    ...
    // start else statement
      ...
      takeScreenshot("logs/Screenshoots/kSZYDG.png");
