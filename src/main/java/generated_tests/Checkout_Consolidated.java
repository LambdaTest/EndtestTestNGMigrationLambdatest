...
public class Checkout_Consolidated extends WebDriverHelper {
  ...
  @Test
  public void ECOM_Login_as_a_guestCCC() {
  ...
  @Test
  public void MTOMX_Free_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTOCOFree_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    takeScreenshot("logs/Screenshoots/CvEcDY.png");
    // Click on Eliminar
    clickOnElement(new String[] { CSS,
  ...
  @Test
  public void MTOEC__Free_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Mandatory_checkbox_in_guest_formC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOM_Mandatory_checkbox_in_guest_formC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOMMX_Free_shipping_bar_settingC() {
    // Clear cache cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    takeScreenshot("logs/Screenshoots/oColAa.png");

    status = "passed";
  }

  @Test
  public void ECOMCO_Free_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    clickOnElement(new String[] { XPATH, "(//button[text()=\'+\'])[2]" });
    // start if statement
    if (checkContainsValue(new String[] { XPATH, "//div[@class=\"col-xs-12 col-cart-totals-row\"]" })) {
      // Add assertion for free shipment
      Assert.assertTrue(
        getText(new String[] { XPATH, "//div[@class=\"col-xs-12 col-cart-totals-row\"]" }).contains("Gratis"));
  ...
  @Test
  public void Ecomm_MX_Change_of_message_of_Maximum_amount_per_order_C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Go_back_to_the_bagCCC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'cart-headline\']" }));
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/uKSWwN.png");

    status = "passed";
  }

  @Test
  public void MTO_EC_Change_of_message_of_Maximum_amount_per_orderC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_MX_Change_of_message_of_Maximum_amount_per_orderC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_CO_Change_of_message_of_Maximum_amount_per_order_C() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  public void Cart_ID() {
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "h1 > span" }, "logs/Screenshots/GGNwvh.png");
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    takeScreenshotOfParticularElement(new String[] { CSS, "h1 > span" }, "logs/Screenshots/blRKsi.png");

    status = "passed";
  }

  @Test
  public void Send_as_gift_optionCphase() {
    // Clear cache cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/FRHQMb.png");
      // start if statement
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Regalo\')]" })) {
        ...
        takeScreenshotOfParticularElement(new String[] { CSS, "div.send-gift > div" }, "logs/Screenshots/OiztEp.png");
        ...
        takeScreenshot("logs/Screenshoots/bCeTky.png");
        // end if statement
      }
  ...
  @Test
  public void ECOMCOChange_of_message_of_Maximum_amount_per_orderC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOM_Registro_de_nuevo_usuarioC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTOPA_Free_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_PA_Change_of_Message_from_Maximum_Amount_per_Order_C() {
    // Clear cookies and cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    typeText(new String[] { XPATH, "(//input[@class=\'form-control js-update-entry-quantity-input\'])[2]" }, "100");
    // Click on Again Go pay
    clickOnElement(new String[] { XPATH, "//div[@class=\'row row-bar\']/child::div[2]/child::div/child::button[2]" });
    // handle the popup
  ...
  @Test
  public void MTO_Form_adjustment_of_my_personal_data_C() {
    // Clear cookies and cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  public void HYBRISV() {
    ...
    if (isElementClickable(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/vDuPfl.png");
    ...
    javascriptExecution(
      ...
      waitUntil("CheckClickableElement", new String[] { CSS, "div#mpagoCreditCardDiv a#add-new-card" }, "10",
        "disabled");
    ...
    // start else statement
      ...
      takeScreenshot("logs/Screenshoots/KsgdBC.png");
  ...
  @Test
  public void ECOM_Go_back_to_the_stock_marketCC() {
    // Clear cookies and cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTOKeep_Floating_Buttons_C() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
