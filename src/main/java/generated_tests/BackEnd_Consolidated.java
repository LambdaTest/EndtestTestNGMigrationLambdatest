...
public class BackEnd_Consolidated extends WebDriverHelper {
  ...
  @Test
  public void CO__Customizable_Palette_PDP_Average_full_MTOC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// select second shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(2) > div.selectorContainer > div.checkboxContainer > input"});
// select third shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(3) > div.selectorContainer > div.checkboxContainer > input"});
// select 4th shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(4) > div.selectorContainer > div.checkboxContainer > input"});
// select 5th shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(5) > div.selectorContainer > div.checkboxContainer > input"});
// select 6th shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(6) > div.selectorContainer > div.checkboxContainer > input"});
// start if statement
if (!isElementClickable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(7) > div.selectorContainer > div.checkboxContainer > input"})){
// print in result
printResults("PrintNote", "\"7th color is not clickble after clicking 6 colors\"");
// end if statement
}
// add assertion for + button
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(1) > div.selectorContainer > div.inputContainer > button.upAmount"}));
// add assertion for - button
Assert.assertTrue(isElementClickable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(1) > div.selectorContainer > div.inputContainer > button.downAmount"}));
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)"}));
// take a snip of  X2 Shades of Blush and / or Powders
takeScreenshotOfParticularElement(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)" },"logs/Screenshots/azXdNc.png");
// Scroll Down
...
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div:nth-child(4) > div.selectorContainer > div.checkboxContainer > input"});
// start if statement
if (!isElementClickable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(5) > div.selectorContainer > div.checkboxContainer > input"})){
// print in result
...
Assert.assertFalse(isElementClickable(new String[] { CSS, "div.item__quantity.hidden-xs.hidden-sm > form#updateCartForm0 > button.item__quantity__action_btn.item__quantity__action_plus_btn"}));
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.payuForm > div.mpago-error.alert.alert-danger.alert-dismissible"}));
// print in result
...
// end else statement
  ...
  @Test
  public void EC_Check_add_product_to_bag___C() {
...
takeScreenshot("logs/Screenshoots/ZdkzgA.png");
...
// end else statement
  ...
  @Test
  public void Verify_My_personal_dataC() {
...
waitUntil("CheckVisibleElement", new String[]{XPATH, "//div[@class='onlyPageLogin register smalltitle']"}, "10","disabled");
...
waitUntil("CheckVisibleElement", new String[]{XPATH, "(//ul[@class='nav__links nav__links--account']/child::li)[3]"}, "10","disabled");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//form[@id=\'belcorpAddressForm\']/parent::div" },"logs/Screenshots/IEXrQq.png");
// Click on Save Address Button
clickOnElement( new String[] {XPATH, "//button[text()=\' GUARDAR DIRECCIÓN \']"});
// Validate  Address created successfully
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'alert alert-success alert-dismissable\']"}));
// Click on again loginSymbol
clickOnElement( new String[] {XPATH, "//li[@class=\'yCmsComponent\']/child::a"});
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[contains(@class,\'account-section-content\')]/parent::div" },"logs/Screenshots/EUQhWb.png");
// End of If Loop
}
// End Else Statement Loop
  ...
  @Test
  public void EC_Verify_Register_as_New_Account_from_BrandC() {
// Clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if
  ...
  @Test
  public void Verify_Footer_MTO_C() {
// Clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[4]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[5]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[6]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[7]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[8]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[9]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[10]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
closeTab();
// Click On Esika
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[1]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
closeTab();
// Click on Lbel
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[2]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
closeTab();
// Click on Cyzone
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[3]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
closeTab();
// Click On How To Buy
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[11]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[12]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[13]/child::a"}));
// Click on I Want To Be Consultant
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/ancestor::div[@class=\'row\']/descendant::li[14]/child::a"});
// Switch to next tab
switchToNextWindow();
// Validate URL
...
closeTab();
// Click on Esika
clickOnElement( new String[] {XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[1]"});
// Scroll to Bottom
scroll("ScrollBottom");
// Click on Facebook Symbol
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/child::li[1]"});
...
closeTab();
// Click on Cyzone
clickOnElement( new String[] {XPATH, "//header[@class=\'js-mainHeader bic-header HOMEPAGE\']/child::nav[1]/child::div/child::div/child::div[1]/child::div/child::div/child::a[3]"});
// Scroll To Bottom
scroll("ScrollBottom");
// Click on Facebook Symbol
clickOnElement( new String[] {XPATH, "//ul[@class=\'bic-social-networks__list\']/child::li[1]"});
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//ul[contains(@class,\'payment-quick-info\')]/child::li[1]"}));
// Validate Deliveries throughout the country
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//ul[contains(@class,\'payment-quick-info\')]/child::li[2]"}));
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//ul[contains(@class,\'payment-quick-info\')]/child::li[4]"}));
// Validate 3 attached logos
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[contains(@class,\'bic-payments\')]" },"logs/Screenshots/vOOWtF.png");

    status = "passed"; 
   }
  @Test
  public void ECSCENARIO__Purchase_in_virtual_store__With_Cash_plus_Coupon_and_PromotionC() {
// clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'js-voucher-validation-container help-block cart-voucher__help-block\']"})){
// Validate Coupon is not  applied
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'js-voucher-validation-container help-block cart-voucher__help-block\']"}));
// End of If Loop
}
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-indent\']" },"logs/Screenshots/fuDnQs.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[2]" },"logs/Screenshots/ICsoAt.png");
// Credit Card Details
...
// Explicit wait
waitUntil("CheckClickableElement", new String[]{XPATH, "(//tr[@ng-repeat='email in emails'])[1]"}, "120","disabled");
...
// Screenshot of Mail
takeScreenshot("logs/Screenshoots/pJLqrV.png");
// end if statement
}
// start else statemnet
else{
...
// end else statement
  ...
  @Test
  public void CL__Customizable_Palette_PDP_Average_Complete_ECOMC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'title-product-down down-bar-title\']"}));
// Validate \"Product name\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'col-sm-6 product-details-col\']/div/child::h1[@class=\'name\']"}));
// Validate \"Product content\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'content-text bundle-content-text-esika\']"}));
...
Assert.assertTrue(isElementClickable(new String[] { CSS, "div#cboxLoadedContent > div > div:nth-of-type(4) > div:nth-of-type(2) > button"}));
...
Assert.assertFalse(isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']"}));
// Click on Choose Shade
javascriptExecution("document.querySelector(\"div:nth-child(3) > div.bundleVariantDataContainer > div.product-select-variant-button.variantSelectorButtonContainer.bundleProductOptionButton > button#selectVariable\").click();");
// Choose First Shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// Add assertion for message change
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@id=\'cboxTitle\']"}));
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'add-to-cart add-to-cart-cross\']" },"logs/Screenshots/qDFUrX.png");
// Click on Go Pay Button
...
Assert.assertFalse(isElementClickable(new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > form > input:nth-of-type(4)"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[contains(@class,\'voucher-respond\')] /child::form/child::input"}));
...
// Start If Statement
if (isDisplayed(new String[] { XPATH, "//div[@class=\'mpago-error alert alert-danger alert-dismissible\']/child::span"}, 0)) {
// Print Message
...
// End Else Statement
  ...
  @Test
  public void Exclusive_Offers_FlowC() {
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
scrollIntoElementView( new String[] {CSS, "h3[class=\'genericProductCarousel-disclaimer horizontal-slider__description\']"});
// Click on perfume de hombre nitro
clickOnElement( new String[] {XPATH, "(//a[text()=\'perfume de hombre nitro\'])[2]"});
// wait for add to cart button
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[contains(text(),'Agregar a la bolsa')]"}, "10","disabled");
// Click on Add To Cart Button
...
// End else statement
  ...
  @Test
  public void CL_Customizable_PalettePDP_Full_Palette_ECOMC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if
  ...
  @Test
  public void Ec_Verify_NoEcomm_Footer__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshot("logs/Screenshoots/jeBFNF.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Términos y condiciones\')])[2]"}));
// verify \"Privacy Policy\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Política de privacidad\')])[2]"}));
// verify \"Conditions of Web Use\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Condiciones de uso web\')])[2]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Autorización para el envío de publicidad\')])[2]"}));
// verify \"Promotion dates Catalog\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Fechas de promociones Catálogo\')])[2]"}));
// verify \"I do not test on animals\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'No testeo en animales\')])[2]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Preguntas frecuentes\')])[2]"}));
// Verify write to us
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Escríbenos\')])[2]"}));
// Verify i want to be consultant
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Quiero ser consultora\')])[4]"}));
// end if contact us
}
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicseecyzonecataloglink\'])[2]"}));
// if condition for digital catalogs
}
  ...
  @Test
  public void EC_Verify_Register_as_a_Registered_Account_from_the_Brand__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[@class=\'loginBtn btn btn-black btn-block mt-15\']"});
// Verify that it returns to the Home Page
takeScreenshot("logs/Screenshoots/agptUx.png");
// verify  upper left corner it says Hello \'Name\'
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//li[@class=\'logged_in js-logged_in\']"}));
  ...
  @Test
  public void COCustomizable_PalettePDP__Average_Full_MTOC() {
// Clear Cache And Cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertFalse(isElementDisplayed(new String[] { CSS, "div#cboxLoadedContent div:nth-child(6) > div.selectorContainer > div.checkboxContainer > input"}));
...
Assert.assertFalse(isElementDisplayed(new String[] { CSS, "div#cboxLoadedContent div:nth-child(4) > div.selectorContainer > div.checkboxContainer > input"}));
// Click on Apply
clickOnElement( new String[] {CSS, "div#cboxLoadedContent div.col-xs-8.col-md-8.applyButton"});
// Scroll Down
scroll("ScrollDown", 400);
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.item__quantity.hidden-xs.hidden-sm > form#updateCartForm0 > button.item__quantity__action_btn.item__quantity__action_plus_btn"}));
...
// End Else Statement
  ...
  @Test
  public void EC__Verify_displayed_product_data_from_categories___C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
if (isElementAvailable(new String[] { XPATH, "//button[@class=\'btn btn-black btn-block js-enable-btn js-add-to-cart\']"})){
// Add assertion for add to cart button
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//button[@class=\'btn btn-black btn-block js-enable-btn js-add-to-cart\']"}));
// if \"add to cart\" button present
}
...
// end else
  ...
  @Test
  public void CO__Customizable_Palette__PDP_Average_Complete_ECOM__C() {
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "img[class=\"lazy loaded\"][src=\"/cdn-cgi/image/width=96,fit=contain,f=auto/https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/210094759-FotoFondoBlanco.jpg\"]"}));
// Add assertion for content
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'content-text bundle-content-text-esika\']"}));
...
if (isElementAvailable(new String[] { CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3) > div > div > div > div:nth-of-type(1) > div > a:nth-of-type(1)"})){
// click on go pay button
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > ul > li:nth-of-type(2) > table > tbody > tr > td > li:nth-of-type(1) > div:nth-of-type(3) > form > input:nth-of-type(4)"}));
// Scroll Down
scroll("ScrollDown", 276);
// click on go pay button
clickOnElement( new String[] {CSS, "div#StickySidebar > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"});
...
// end if go pay button present
  ...
  @Test
  public void EC_Verify_data_shown_of_the_product_from_the_FileC() {
// Clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// Validate Product Name
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'product__listing product__grid\']/child::div[1]/child::div[2]/child::div[1]/child::div/child::a"}));
// Validate Crossed Product Price
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'product__listing product__grid\']/child::div[1]/child::div[2]/child::div[1]/child::div/child::div/child::div[@class=\'strikethrough\']/child::p"}));
// Validate  Product offer price
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'product__listing product__grid\']/child::div[1]/child::div[2]/child::div[1]/child::div/child::div/child::div[@class=\'nuevoPrecio\']/child::p"}));
// Validate Add to Bag Clickable
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//div[@class=\'product__listing product__grid\']/child::div[1]/child::div[2]/child::div[2]/child::form"}));
// Click on first product
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-footer\']/child::a"}));
// End If Statement
}
// Scroll Down
...
// End If Statement
  ...
  @Test
  public void EC__Customizable_Palette_PDP_Full_Palette__MTOC() {
// Go to URL
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//div[@class=\'col-xs-8 col-md-8 applyButton\'])[3]"}));
// Click on APLICAR
...
Assert.assertFalse(isElementClickable(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]"}));
// start if statement
if (isElementClickable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(18) > div:nth-of-type(3) > button"})){
// scroll till X2 tones
scrollIntoElementView( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(18) > div:nth-of-type(3) > button"});
// Click on X2 tones
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(18) > div:nth-of-type(3) > button"});
// Click on 1st tone
clickOnElement( new String[] {XPATH, "(//div[@class=\'selectorContainer\'][@data-value=\'1\'])[3]"});
// Click on 2nd tone
clickOnElement( new String[] {XPATH, "(//div[@class=\'selectorContainer\'][@data-value=\'2\'])[3]"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[@class=\'item active gallery-image__thumbnail-js\'])[1]"}));
...
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(4) > div:nth-of-type(2) > input" }, "1234567890");
// Write text in address billing name
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(4) > div:nth-of-type(3) > input" }, "soumya");
// Select Option from province dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(1) > div > select" }, "000023");
// Select Option from canton dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(2) > div > select" }, "000023000006");
// Select Option from Sector Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(3) > div > select" }, "000023000006000053");
// Write text in address line1
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(4) > input" }, "near temple");
// Write text in address line2
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(5) > input" }, "n70-306");
// Write text in address secondary street
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(6) > input" }, "vanivihar");
// Write text in address neighbour
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(7) > input" }, "rasulgarh");
// Write text in address house no
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(10) > input" }, "100");
// Write text in addres postal Code
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(12) > input" }, "754215");
// Write text in address phone
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(16) > input" }, "7867876788");
// click on click here to continue button
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
// click on click here to continue button
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
// Select Option from Payment Method DropDown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > select" }, "belpay_cash");
// Write text in belpayDocNumber...
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--doc-number not-empty\"][data-checkout=\"belpayDocNumberCash\"]" }, "1234567890");
// click on click here to continue button
clickOnElement( new String[] {CSS, "div#belpay_accordion > button[type=\'button\']"});
// Click on Terms1
clickOnElement( new String[] {CSS, "input[type=\"checkbox\"]"});
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[text() = ' Finalizar tu compra']"}, "10","disabled");
// Click on Finalize your purchase button
...
// end else
  ...
  @Test
  public void PE_Customizable_PalettePDP_Full_Palette_ECOMC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)"}));
// take a snip of  X2 Shades of Blush and / or Powders
takeScreenshotOfParticularElement(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)" },"logs/Screenshots/MVRwND.png");
// Scroll Down
scroll("ScrollDown", 200);
// Click on Choose shades
clickOnElement( new String[] {XPATH, "(//button[@id=\"selectVariable\"])[2]"});
...
// end else
  ...
  @Test
  public void Recommended_Flow_SetsC() {
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@name=\"myBusinessSection4\"]" },"logs/Screenshots/OChBFv.png");
// validate see more button
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#myBusinessSection4 div:nth-child(5) > div > div > div > div.recommendedSetsCarousel-pdp-footer > a"}));
// take a screen shot to validate more than 6 bundles are present
takeScreenshot("logs/Screenshoots/IzJPpi.png");
// end if statement
}
// start else statemnet
else{
...
// end else statement
  ...
  @Test
  public void ECSCENARIO__Purchase_in_virtual_store__With_Debit_card_and_PromotionC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-header bundle2Prod\']"}));
// end if statement
}
// Click on Add to cart button
clickOnElement( new String[] {XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]"});
...
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(4) > div:nth-of-type(3) > input" }, "soumya");
// Select Option from Province Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(1) > div > select" }, "000011");
// Select Option from Canton Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(2) > div > select" }, "000011000009");
// Select Option from Department Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(3) > div > select" }, "000011000009000050");
// Write text in address.line1
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(4) > input" }, "near temple");
// Write text in address.line2
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(5) > input" }, "n70-306");
...
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(12) > input" }, "220564");
// Write text in address phone
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(16) > input" }, "7867876788");
// click on click here to continue button
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
...
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
// Select Option from Payment Method Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > select" }, "belpay_debit");
// Write text in cardNumber
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--card-number not-empty\"][data-checkout=\"cardNumber\"][onselectstart=\"return false\"][onpaste=\"return false\"][oncopy=\"return false\"][oncut=\"return false\"][ondrag=\"return false\"][ondrop=\"return false\"][autocomplete=\"off/\"]" }, "4100448504907330");
...
// Write text in docNumber
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(5) > input" }, "1234567890");
// Select Option From Month Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(6) > div:nth-of-type(1) > div:nth-of-type(1) > select" }, "11");
// Select Option from year dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(6) > div:nth-of-type(1) > div:nth-of-type(2) > select" }, "2025");
// Write text in cardholderName
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(7) > input" }, "APRO");
// Write text in securityCode
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(8) > input" }, "123");
// click on click here to continue button
clickOnElement( new String[] {CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(3) > div > div > form > button"});
// wait
...
// wait
waitUntil("CheckEnabledElement", new String[]{XPATH, "//button[text() = ' Finalizar tu compra']"}, "10","disabled");
// Click on Finalize your purchase button
clickOnElement( new String[] {XPATH, "//button[contains(text(),\"Finalizar tu compra\")]"});
// Add Assertion for success message
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div[class=\"checkout-success__body__headline\"]"}));
...
pressKey(new String[] { XPATH, "//input[@class=\'form-control input-text h-auto\']"}, "//input[@class=\'form-control input-text h-auto\']");
// wait
waitUntil("CheckVisibleElement", new String[]{XPATH, "(//tr[@ng-repeat='email in emails'])[1]"}, "120","disabled");
// click on first email
clickOnElement( new String[] {XPATH, "(//tr[@ng-repeat=\"email in emails\"])[1]"});
  ...
  @Test
  public void ECSCENARIO__Purchase_in_virtual_store__guest_user__credit_card__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'actions\']/child::button[contains(text(), \'Seguir Comprando\')]"})){
// if condition for \"continue shopping\" clickable
if (isElementClickable(new String[] { XPATH, "//div[@class=\'actions\']/child::button[contains(text(), \'Seguir Comprando\')]"})){
// click on \"continue shopping\" button
clickOnElement( new String[] {XPATH, "//div[@class=\'actions\']/child::button[contains(text(), \'Seguir Comprando\')]"});
...
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//div[@class='actions']/child::button[contains(text(),' Ir a pagar')]"}, "10","disabled");
...
// end else for terms1 present
  ...
  @Test
  public void MX__Customizable_Palette__PDP_Average_Complete_ECOM___C() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#cboxLoadedContent > div > div:nth-of-type(4) > div:nth-of-type(2) > button"}));
// click on apply button
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(4) > div:nth-of-type(2) > button"});
// click on choose shade
clickOnElement( new String[] {XPATH, "//button[text() = \"Elegir tono\"]"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//input[@name=\'voucherCode\']"}));
// click on cart go pay button
clickOnElement( new String[] {CSS, "div#StickySidebar > div > div:nth-of-type(7) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"});
// end if
}
// guest user login
// if statement
...
waitUntil("CheckClickableElement", new String[]{CSS, "label[for='belcorpNewCheckoutPaymentMode_mpago_cash']"}, "10","disabled");
// start if
...
// wait for pay button
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpagoCashForm button[type='button']"}, "10","disabled");
// click on pay button
...
// end if add to cart button present
}
// end if add to cart button present
}
// end if product shade present
}
// else product shade present
else{
// Print message
printResults("PrintNote", "Url is not working properly");
// end else product shade present
}

    status = "passed"; 
   }
  @Test
  public void EC__Customizable_Palette_PDP_Average_full_MTOC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)"}));
// take a snip of  X2 Shades of Blush and / or Powders
takeScreenshotOfParticularElement(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)" },"logs/Screenshots/XolEPz.png");
// Scroll Down
scroll("ScrollDown", 200);
// Click on Choose shades
clickOnElement( new String[] {XPATH, "(//button[@id=\"selectVariable\"])[2]"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h2[@class=\'genericProductCarousel-title horizontal-slider__title\']"}));
// start if statement
...
// end else statement
  ...
  @Test
  public void CL__Customizable_Palette__PDP_Average_full__MTOC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//input[@name=\'voucherCode\']"}));
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//div[@class='actions']/button[contains(.,'Ir a pagar')]"}, "10","disabled");
// click on go pay button
clickOnElement( new String[] {XPATH, "//div[@class=\'actions\']/button[contains(.,\'Ir a pagar\')]"});
// Write text in guest first Name
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Nombre*\"]" }, "photon ");
...
// end if
  ...
  @Test
  public void ECSCENARIO__Purchase_in_virtual_store__With_Credit_card_and_Discount_Coupon__C() {
// Clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[1]"}));
// Validate Shipping methods is Displayed
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-indent\']" },"logs/Screenshots/zVtaJo.png");
// Click on Again CLICK here to continue button
clickOnElement( new String[] {XPATH, "//button[@id=\'deliveryMethodSubmit\']"});
// Validate payment options
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[1]"}));
// Validate payment options is displayed
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[2]" },"logs/Screenshots/BgTxLo.png");
// Credit Card Details
// if payment option present
if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']"})){
// select payment option as credit card
...
// end else for terms1 present
  ...
  @Test
  public void HYBRISV__As_a_consumer_I_want_to_have_the_integration_with_custom_bundles_to_have_offers_recommended_just_for_me__ECC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[@class=\'loginBtn btn btn-black btn-block mt-15\']"});
// wait
waitUntil("CheckVisibleElement", new String[]{CSS, "h3[class='commercialCarousel-pdp-title js-owl-commercialCarouselPdp-title']"}, "10","disabled");
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(6) > div.row.linkProductDetailModal > div.col-md-8 > div.title > p"}));
// Add Assertion For Second Product
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#cboxLoadedContent div:nth-child(7) > div.row.linkProductDetailModal > div.col-md-8 > div > p"}));
// end if statement
}
// Start Else Satement
else{
...
javascriptExecution("
document.querySelector(\"li.liOffcanvas > a\").click()");
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End Else Statement
  ...
  @Test
  public void Customizable_Palette_PDP_Full_Palette_MTO__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(2) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// choose shade3
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(3) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// choose shade4
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(4) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// choose shade5
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(5) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// Add assertion for message change
Assert.assertTrue(isElementAvailable(new String[] { ID, "cboxTitle"}));
// choose shade6
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(6) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
...
// end if for shades present
}

    status = "passed"; 
   }
  @Test
  public void MX_Paleta_Customizable_PDP_Media_complete_MTO__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
if (!isElementClickable(new String[] { CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(3) > div:nth-of-type(3) > div:nth-of-type(1) > input"})){
// Print message
...
Assert.assertFalse(isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']"}));
// Add assertion for choose shade
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div:nth-child(3) > div.bundleVariantDataContainer > div.product-select-variant-button.variantSelectorButtonContainer.bundleProductOptionButton > button#selectVariable"}));
// click on choose shade
javascriptExecution("document.querySelector(\"div:nth-child(3) > div.bundleVariantDataContainer > div.product-select-variant-button.variantSelectorButtonContainer.bundleProductOptionButton > button#selectVariable\").click();");
// choose first shade
clickOnElement( new String[] {CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(1) > input"});
// if Add assertion can\'t choose more than one
if (!isElementClickable(new String[] { CSS, "div#cboxLoadedContent > div > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(1) > input"})){
...
// verify add to cart pop up
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'add-to-cart add-to-cart-cross\']" },"logs/Screenshots/AdEmFP.png");
// click on go pay button
// if condition for \"go pay\" present
if (isElementAvailable(new String[] { XPATH, "//a[contains(text(),\'Ir a pagar\')]"})){
// if condition for \"go pay\" clickable
...
// end else
  ...
  @Test
  public void ECSCENARIO__Purchase_in_virtual_store__start_Guest_User__debit_cardC() {
// clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[1]"}));
// Validate Shipping methods is Displayed
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-indent\']" },"logs/Screenshots/HgiEwl.png");
// Click on Again CLICK here to continue button
clickOnElement( new String[] {XPATH, "//button[@id=\'deliveryMethodSubmit\']"});
// Validate payment options
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[1]"}));
// Validate payment options is displayed
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[2]" },"logs/Screenshots/cLjIVy.png");
// Credit Card Details
// if payment option present
if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']"})){
// select payment option as credit card
...
clickOnElement( new String[] {XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]"});
// Screenshot of Mail
takeScreenshot("logs/Screenshoots/NcwtoW.png");
// End If Statement
}
  ...
  @Test
  public void Creation_of_spinner_by_clicking_on_the_add_to_cart_Set_Variables_and_Palette___CC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end else
  ...
  @Test
  public void MX__Customizable_Palette_PDP_Full_Palette_ECOMC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertFalse(isElementClickable(new String[] { XPATH, "(//input[@class=\"checkbox checkboxModalCustom\"])[59]"}));
// Click on Apply
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-block\"])[6]"});
...
clickOnElement( new String[] {CSS, "button#addToCartVariableSet"});
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//li//a[contains(text(),' Ir a pagar')]"}, "20","disabled");
// Click on go pay
clickOnElement( new String[] {XPATH, "//li//a[contains(text(),\' Ir a pagar\')]"});
// Assertion on price
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//div[@class=\"item__price\"])[2]"}));
...
// end else
  ...
  @Test
  public void ECOM__CL_Pop_up_in_Piloto_Chile_C() {
// Clear cookies and cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//div[@class=\'bic-consultant-top-bar\']/child::div/child::span"}));
// Close  \"Boost the business\" Pop up
clickOnElement( new String[] {CSS, "button#cboxClose > span"});
// Click on Perfumes Category
clickOnElement( new String[] {XPATH, "//a[@title=\'Perfumes\']"});
// Validate \"Boost the business\" Pop up
Assert.assertFalse(isElementDisplayed(new String[] { XPATH, "button#cboxClose > span"}));
// Click on lbel
clickOnElement( new String[] {XPATH, "(//img[@data-parent=\'lbel\'])[3]"});
// Explicit wait for \"Boost the business\" Pop up
waitUntil("CheckVisibleNotElement", new String[]{CSS, "button#cboxClose > span"}, "10","disabled");
...
// End of If Loop
  ...
  @Test
  public void HYBRISV__As_a_consumer_I_want_more_payment_options_in_agent__web_banking_to_be_able_to_secure_the_purchase__ECC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'bic-payments col-xs-12 col-sm-4 col-md-5 col-md-push-1\']" },"logs/Screenshots/UpSpCw.png");
// Click on perfumes
clickOnElement( new String[] {XPATH, "//a[text() = \"perfumes\"]"});
...
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(12) > input" }, "754215");
// Write text in address phone
typeText(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(16) > input" }, "7856786679");
// click on click here to continue button
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
// click on click here to continue button
clickOnElement( new String[] {XPATH, "//button[text() = \"CLICK AQUÍ PARA CONTINUAR\"]"});
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'checkout-order-summary\']" },"logs/Screenshots/FfiUIz.png");
// Select Option from Payment Method Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > select" }, "belpay_cash");
// Write text in belpay Document Number
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--doc-number not-empty\"][data-checkout=\"belpayDocNumberCash\"]" }, "1234567890");
// Add Assertion for Pago 100% secure payment
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(5)"}));
// click on click here to continue button
clickOnElement( new String[] {CSS, "div#belpay_accordion > button[type=\'button\']"});
// Click on Terms1
clickOnElement( new String[] {CSS, "input[type=\"checkbox\"]"});
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'order-detail-overview\']" },"logs/Screenshots/IUxZje.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'account-orderdetail account-orderdetail-payment-info well well-tertiary js-cash-order-confirmation js-account-orderdetail\']" },"logs/Screenshots/loKbDD.png");
// Add Assertion For Payment Section Details
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'account-orderdetail account-orderdetail-payment-info well well-tertiary js-cash-order-confirmation js-account-orderdetail\']"}));

    status = "passed"; 
   }
  @Test
  public void Scroll_down__up_with_the_scroll_bar__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshot("logs/Screenshoots/DkGxZN.png");
// Scroll up to the start of the tones
scroll("ScrollTop");
// Assert scrolling up
takeScreenshot("logs/Screenshoots/NadpRp.png");
...
// End else statement \"option to choose tones\"
  ...
  @Test
  public void CO__Customizable_Palette_PDP_Full_Palette_ECOMC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//a[text()=\'Eliminar\'])[2]"}));
// Click on go pay
clickOnElement( new String[] {CSS, "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(2) > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"});
...
// end else
  ...
  @Test
  public void PE_Customizable_PalettePDP_Full_Palette_MTOC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)"}));
// take a snip of  X2 Shades of Blush and / or Powders
takeScreenshotOfParticularElement(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)" },"logs/Screenshots/BNfyTw.png");
// Scroll Down
scroll("ScrollDown", 200);
// Click on Choose shades
clickOnElement( new String[] {XPATH, "(//button[@id=\"selectVariable\"])[2]"});
...
takeScreenshot("logs/Screenshoots/suunZD.png");
// add assertion for qty increase button
Assert.assertFalse(isElementClickable(new String[] { CSS, "div.item__quantity.hidden-xs.hidden-sm > form#updateCartForm0 > button.item__quantity__action_btn.item__quantity__action_plus_btn"}));
// add assertion for remove link
Assert.assertTrue(isElementClickable(new String[] { CSS, "div.item__remove-action > div#actionEntry_0 > a"}));
...
Assert.assertTrue(getText(new String[] { XPATH, "//div[@class=\'content\']/span" }).contains("Compra a través de una consultora online"));
// Click on commercial banner
clickOnElement( new String[] {XPATH, "//div[@class=\'content\']/span"});
// Add Assertion for prices and special discount
Assert.assertTrue(getText(new String[] { XPATH, "//p[@class=\'consultants-search-page-left-section-link\'][1]/a" }).contains("Precios y descuentos especiales"));
// Add Assertion for  20% OFF on your first purchase exclusive promotions and advice
Assert.assertTrue(getText(new String[] { XPATH, "//p[@class=\'consultants-search-page-left-section-link\'][2]/a" }).contains("20% OFF en tu primer compra promociones exclusivas y asesoría"));
// Add  Assertion for  Boost the business of an entrepreneur woman
Assert.assertTrue(getText(new String[] { XPATH, "//p[@class=\'consultants-search-page-left-section-link\'][3]/a" }).contains("Impulsa el negocio de una mujer emprendedora"));
// Add Assertion For Assign me as  consultant button
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@class=\'btn btn-black btn-block js-asign-consultant\']"}));
// Click on lbel
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@class=\'btn btn-black btn-block js-asign-consultant\']"}));
  ...
  @Test
  public void MXCustomizable_PalettePDP_Full_Palette_MTOC() {
// Clear Cache And Cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)"}));
// Take a snip of  X2 Shades of Blush and / or Powders
takeScreenshotOfParticularElement(new String[] { CSS, "div.products-variant-section.bundle-components > div:nth-child(3)" },"logs/Screenshots/LQMNlW.png");
// Scroll Down
scroll("ScrollDown", 200);
// Click on Choose shades
clickOnElement( new String[] {XPATH, "(//button[@id=\"selectVariable\"])[2]"});
