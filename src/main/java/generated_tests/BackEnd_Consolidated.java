...
public class BackEnd_Consolidated extends WebDriverHelper {
  ...
  public void EC_Verify_Register_as_a_Registered_Account_from_the_Brand__CThreezeroOneSix() {
    ...
    takeScreenshot("logs/Screenshoots/vQdeiQ.png");
  ...
  public void Scroll_down__up_with_the_scroll_bar__CThreezeroFiveEight() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//div[@class=\'div-tono shadeSelectedOpenBox\']" })) {
      ...
      takeScreenshot("logs/Screenshoots/DPUxOt.png");
      // Scroll up to the start of the tones
      scroll("ScrollTop");
      // Assert scrolling up
      takeScreenshot("logs/Screenshoots/pRlxCz.png");
  ...
  public void ECSCENARIO_One_Purchase_in_virtual_store__guest_user__credit_card__CTwoNineNineSeven() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
      ...
      status = "passed";
    } @Test public void CL__Customizable_Palette_PDP_Average_Complete_ECOMCOneFiveSixzero () {
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\'title-product-down down-bar-title\']" }));
    ...
    @Test public void MX__Customizable_Palette_PDP_Full_Palette_ECOMCOneFiveFiveSeven () {
    ...
    @Test public void ECSCENARIO_One_Purchase_in_virtual_store__With_Credit_card_and_Discount_Coupon__CThreezerozerozero
    () {
      javascriptExecution(
      ...
      clickOnElement(new String[] { XPATH,
        "//div[@class=\'product__listing product__grid\']/child::div[1]/child::div[2]/child::a" });
      // Click on Add to cart
      clickOnElement(new String[] { XPATH, "//button[@id=\'addToCartButton\']" });
      ...
      if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
        ...
        status = "passed";
      } @Test public void EC__Customizable_Palette_PDP_Full_Palette__MTOCOneFiveFourSix () {
        ...
        if (isElementAvailable(new String[] { XPATH, "div[class=\"checkout-success__body__headline\"]" })) {
          ...
          Assert.assertTrue(
            isElementAvailable(new String[] { CSS, "div[class=\"checkout-success__body__headline\"]" }));
          // end if statement
        }
      ...
      @Test public void Verify_Footer_MTO_CThreezeroOneEight () {
        ...
        takeScreenshotOfParticularElement(new String[] { XPATH, "//div[contains(@class,\'bic-payments\')]" },
          "logs/Screenshots/WghBqA.png");

        status = "passed";
      }
      @Test public void CL_Customizable_PalettePDP_Full_Palette_ECOMCOneFiveFiveSix () {
      ...
      @Test public void PE_Customizable_PalettePDP_Full_Palette_MTOCOneFiveFourFive () {
        ...
        if (isElementAvailable(new String[] { XPATH, "(//div[@class=\"product-variant-container\"])[1]" })) {
          ...
          if (checkCurrentUrlContains("cart")) {
            ...
            takeScreenshot("logs/Screenshoots/EQGLnK.png");
            ...
            Assert.assertTrue(
              isElementClickable(new String[] { CSS, "div.item__remove-action > div#actionEntry_0 > a" }));
            // write text in coupon text field
      ...
      @Test public void EC_Verify_data_shown_of_the_product_from_the_FileCThreezeroOneFour () {
      ...
      @Test public void EC_Verify_Register_as_New_Account_from_BrandCThreezeroOneFive () {
      ...
      @Test public void EC_Check_add_product_to_bag___CThreezeroTwoOne () {
        ...
        clickOnElement(new String[] { XPATH, "//button[@class=\'loginBtn btn btn-black btn-block mt-15\']" });
        // Verify that it returns to the Home Page
        takeScreenshot("logs/Screenshoots/zwKZck.png");
        // verify  upper left corner it says Hello \'Name\'
        Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//li[@class=\'logged_in js-logged_in\']" }));
        // click on make up
        ...
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "//input[@class=\'form-control js-qty-selector-input\']" }));
        // click on add to cart button
        // if condition for \"add to cart\" present
        if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
          // if condition for \"add to cart\" clickable
      ...
      @Test public void ECOM__CL_Pop_up_in_Piloto_Chile_CThreeOneOneFour () {
        ...
        Assert.assertTrue(isElementClickable(
          new String[] { XPATH, "//div[@class=\'bic-consultant-top-bar\']/child::div/child::span" }));
      ...
      @Test public void EC__Verify_displayed_product_data_from_categories___CThreezeroOneThree () {
      ...
      @Test public void HYBRISVOneOnezeroThreeThreeFourCOneSevenTwozero () {
        ...
        Assert.assertTrue(isElementClickable(
          new String[] { XPATH, "//button[@class=\'btn btn-black btn-block js-asign-consultant\']" }));
        // Click on lbel
      ...
      @Test public void Flujo_Kit_InicioCThreezeroThreeTwo () {
        ...
        if (isElementAvailable(new String[] { XPATH, "//a[text()=\'perfume de hombre nitro\']" })) {
          ...
          if (isElementAvailable(new String[] { XPATH, "(//div[@class=\"cart_popup_error_msg\"])[2]" })) {
            ...
            Assert.assertTrue(
              isElementAvailable(new String[] { XPATH, "(//div[@class=\"cart_popup_error_msg\"])[2]" }));
            // end if statement
          }
          // start else statemnet
          else {
        ...
        @Test public void EC__Customizable_Palette_PDP_Average_full_MTOCOneFiveFiveOne () {
        ...
        @Test public void CL__Customizable_Palette__PDP_Average_full__MTOCOneFiveFiveTwo () {
        ...
        @Test public void ECSCENARIO_Three_Purchase_in_virtual_store__start_Guest_User__debit_cardCTwoNineNineNine () {
          javascriptExecution(
          ...
          // Click on Apply button
          clickOnElement(
            new String[] { XPATH, "//div[contains(@class,\'voucher-respond\')] /child::form/child::button" });
          // Click on Again Go pay
          clickOnElement(
          ...
          if (isElementAvailable(new String[] { XPATH, "//input[@id=\'guest.firstName\']" })) {
            ...
            typeText(new String[] { XPATH, "//input[@id=\'guest.lastName\']" }, "user");
            // write text in email
            typeText(new String[] { XPATH, "//input[@id=\'guest.email\']" },
          ...
          if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
            ...
            if (isElementAvailable(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" })) {
              ...
              // Screenshot of Mail
              takeScreenshot("logs/Screenshoots/ETrzSa.png");
              // End If Statement
            }
            // start else
            else {
          ...
          () {
            ...
            if (isElementAvailable(new String[] { XPATH, "//span[text() = \"Cupón aplicado exitosamente\"]" })) {
              ...
              Assert.assertTrue(
                isElementAvailable(new String[] { XPATH, "//span[text() = \"Cupón aplicado exitosamente\"]" }));
              // End of If Loop
            }
            // strt else
            else {
            ...
            if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
              ...
              pressKey(new String[] { XPATH, "//input[@id=\'search\']" }, "//input[@id=\'search\']");
              // Explicit wait
              waitUntil("CheckClickableElement", new String[] { XPATH, "(//tr[@ng-repeat='email in emails'])[1]" },
                "120", "disabled");
              ...
              if (isElementAvailable(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" })) {
                ...
                clickOnElement(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" });
                // Screenshot of Mail
                takeScreenshot("logs/Screenshoots/ojJmrW.png");
                // end if statement
              }
              // start else statemnet
              else {
            ...
            @Test public void CO__Customizable_Palette__PDP_Average_Complete_ECOM__COneFiveSixTwo () {
              ...
              Assert.assertTrue(
                isElementAvailable(new String[] { XPATH, "//div[@class=\'product-variant-container\']" }));
              ...
              if (isElementAvailable(new String[] { CSS,
                ...
                if (isElementClickable(new String[] { CSS, "form#mpago_credit input#cardholderName" })) {
                  ...
                  waitUntil("CheckClickableElement", new String[] { CSS, "form#mpago_credit input#cardholderName" },
                    "10", "disabled");
            ...
            @Test public void ECSCENARIO_Two_Purchase_in_virtual_store__With_Debit_card_and_PromotionCThreezerozeroOne
            () {
              javascriptExecution(
              ...
              if (isElementAvailable(
                new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-header bundle2Prod\']" })) {
              ...
              // wait
              waitUntil("CheckEnabledElement", new String[] { XPATH, "//button[text() = ' Finalizar tu compra']" },
                "10", "disabled");
              // Click on Finalize your purchase button
              clickOnElement(new String[] { XPATH, "//button[contains(text(),\"Finalizar tu compra\")]" });
              // Add Assertion for success message
            ...
            @Test public void COCustomizable_PalettePDP__Average_Full_MTOCOneFiveFiveFour () {
              ...
              // Go to URL
              getURL(
                "https://s1-esika.tiendabelcorp.com/co/beauty-box-%28paleta-completa%29/p/3_1_202108_co/monicarey");
              // Start if statement
              ...
              if (isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]" })) {
                // add assertion for order placed successfully
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]" }));
                // Order Placed
            ...
            @Test public void Exclusive_Offers_FlowCThreezeroThreezero () {
              ...
              waitUntil("CheckClickableElement",
                new String[] { XPATH, "//button[contains(text(),'Agregar a la bolsa')]" }, "10", "disabled");
              // Click on Add To Cart Button
              clickOnElement(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" });
              // click on go pay button
              // explicit wait for Go Pay Button
            ...
            () {
              ...
              if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "//button[@class=\'variantSelectorButton \']" }));
                ...
                // click on apply button
                clickOnElement(new String[] { CSS,
                  "div#cboxLoadedContent > div > div:nth-of-type(4) > div:nth-of-type(2) > button" });
            ...
            @Test public void MX_Paleta_Customizable_PDP_Media_complete_MTO__COneFiveFiveThree () {
              ...
              // Go to URL
              getURL(
                "https://s1-esika.tiendabelcorp.com/mx/beauty-box-%28paleta-de-3-refills%29/p/3_1000001_202108_mx/mx202108");
              // Validate \"Shades of Shadows and / or lips\"
              Assert.assertTrue(
                isElementAvailable(new String[] { XPATH, "//div[@class=\'product-variant-container\']" }));
              // validate \"Shades of Blush and / or Powders\"
              ...
              if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" })) {
                // Validate that the add to cart button is disabled
                Assert.assertFalse(
                  isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" }));
              ...
              // Validate \"Product name\"
              Assert.assertTrue(isElementAvailable(new String[] { XPATH,
                "//div[@class=\'col-sm-6 product-details-col\']/div/child::h1[@class=\'name\']" }));
              // Validate \"Product content\"
              Assert.assertTrue(
                isElementAvailable(new String[] { XPATH, "//div[@class=\'content-text bundle-content-text-esika\']" }));
              // Add assertion for choose shade
              ...
              // verify add to cart pop up
              takeScreenshotOfParticularElement(
                new String[] { XPATH, "//div[@class=\'add-to-cart add-to-cart-cross\']" },
                "logs/Screenshots/xixSsA.png");
              // click on go pay button
              // if condition for \"go pay\" present
              if (isElementAvailable(new String[] { XPATH, "//a[contains(text(),\'Ir a pagar\')]" })) {
                // if condition for \"go pay\" clickable
              ...
              if (isElementAvailable(new String[] { XPATH, "//input[@id=\"guest.firstName\"]" })) {
                ...
                // click on login
                clickOnElement(
                  new String[] { XPATH, "//button[@class=\'btn btn-magenta btn-block guestCheckoutBtn\']" });
                // end if statement
              }
              // start statement
              else {
              ...
              if (isElementAvailable(new String[] { XPATH, "//input[@id=\'address.postalCode\']" })) {
                ...
                typeText(new String[] { XPATH, "//input[@id=\'address.phone\']" }, "1234567890");
                // wait for address submit
                waitUntil("CheckClickableElement", new String[] { XPATH, "//button[@id='addressSubmit']" }, "10",
                  "disabled");
                // click on address submit button
                clickOnElement(new String[] { XPATH, "//button[@id=\'addressSubmit\']" });
                // end if statement
            ...
            @Test public void MX__Customizable_Palette__PDP_Average_Complete_ECOM___COneFiveSixOne () {
              ...
              if (isElementAvailable(new String[] { XPATH, "(//div[@class=\'product-variant-container\'])[1]" })) {
                ...
                Assert.assertTrue(isElementAvailable(
                  new String[] { XPATH, "//div[@class=\'content-text bundle-content-text-esika\']" }));
                // click on choose shade
                clickOnElement(new String[] { XPATH, "//button[text() = \"Elegir tonos\"]" });
                // Click on first shade
                clickOnElement(new String[] { CSS,
                ...
                if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" })) {
                  ...
                  if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" })) {
                    ...
                    if (isElementAvailable(new String[] { XPATH, "//input[@id=\'address.postalCode\']" })) {
                      // wait until postal code
                      waitUntil("CheckClickableElement", new String[] { XPATH, "//input[@id='address.postalCode']" },
                        "10", "disabled");
                      // Fill postal code details
                      typeText(new String[] { XPATH, "//input[@id=\'address.postalCode\']" }, "44600");
                      // select address region
                    ...
                    // wait for agency banking
                    waitUntil("CheckClickableElement",
                      new String[] { CSS, "label[for='belcorpNewCheckoutPaymentMode_mpago_cash']" }, "10", "disabled");
                    // start if
                    if (isElementAvailable(new String[] { CSS, "input#Terms1_mpagoCashForm" })) {
                      // click on agency banking
                      javascriptExecution(
                      ...
                      // wait for pay button
                      waitUntil("CheckClickableElement",
                        new String[] { CSS, "form#mpagoCashForm button[type='button']" }, "10", "disabled");
                      // click on pay button
                      clickOnElement(new String[] { CSS, "form#mpagoCashForm button[type=\'button\']" });
                      // end if statement
                    }
                  ...
                  // Start else statment add to cart
                  else {
                    // Print
                    printResults("PrintNote", "Element is not present");
                    // end else statment
              ...
              status = "passed";
            } @Test public void CO__Customizable_Palette_PDP_Average_full_MTOCOneFiveFourNine () {
              ...
              if (checkCurrentUrlContains("cart")) {
                ...
                if (isElementAvailable(new String[] { CSS, "div#voucherSuccessMessageDesktop > span" })) {
                  // ADD ASSERTION FOR COUPON apply message
                  Assert.assertTrue(
                    isElementAvailable(new String[] { CSS, "div#voucherSuccessMessageDesktop > span" }));
                  // end if statement
                }
                // start else statement
                else {
            ...
            @Test public void Ec_Verify_NoEcomm_Footer__CThreezeroOneNine () {
              ...
              takeScreenshot("logs/Screenshoots/VCCwki.png");
              ...
              if (isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Términos y condiciones\')])[2]" })) {
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Derechos ARCO\')])[2]" }));
                ...
                Assert.assertTrue(isElementAvailable(
                  new String[] { XPATH, "(//a[contains(text(),\'Fechas de promociones Catálogo\')])[2]" }));
              ...
              if (isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicbrandesikalink\'])[2]" })) {
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicbrandesikalink\'])[2]" }));
                // verify lbel footer link
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicbrandlbellink\'])[2]" }));
                // verify cyzone footer link
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicbrandcyzonelink\'])[2]" }));
              ...
              if (isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Cómo comprar\')])[2]" })) {
                // Verify how to buy
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Cómo comprar\')])[2]" }));
                // Verify frequent questions
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Preguntas frecuentes\')])[2]" }));
                // Verify write to us
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[contains(text(),\'Escríbenos\')])[2]" }));
              ...
              if (isElementAvailable(new String[] { XPATH, "//ul[@class=\'bic-social-networks__list\']" })) {
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "//ul[@class=\'bic-social-networks__list\']" }));
              ...
              if (isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicseeesikacataloglink\'])[2]" })) {
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicseeesikacataloglink\'])[2]" }));
                // verify digital catalogs for lbel
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "(//a[@id=\'lnk-foo-bicseelbelcataloglink\'])[2]" }));
              ...
              status = "passed";
            } @Test public void PE_Customizable_PalettePDP_Full_Palette_ECOMCOneFiveFiveFive () {
              ...
              if (isElementAvailable(new String[] { XPATH, "//button[@id=\"addToCartVariableSet\"]" })) {
                ...
                // wait
                waitUntil("CheckVisibleElement", new String[] { XPATH, "//div[@id='addToCartLayer']" }, "30",
                  "disabled");
                // start if statement
                if (isDisplayed(new String[] { XPATH, "//p[@class=\"titleBar\"]" }, 0)) {
                  // Add Assertion for product name
                ...
                if (checkCurrentUrlContains("checkout")) {
                  ...
                  // Write text in guest last Name
                  typeText(
                    new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Apellido*\"]" },
                    "test");
                  // Write text in guest email
                  typeText(new String[] { CSS, "input[class=\"guestEmail form-control\"]" },
                    "ec.esc2.mto.fb@gmail.com");
                  // Click on Agree To Receive Pubicity Checkbox
                  clickOnElement(new String[] { CSS,
                    "section > div > div > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(5) > div > div:nth-of-type(1) > form > div:nth-of-type(7) > div > div > div > input:nth-of-type(1)" });
                  // Click on  T&C checkbox
                  ...
                  // Write text in address line1
                  typeText(
                    new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Dirección*\"]" },
                    "near temple");
                  // Write text in address line2
                  typeText(new String[] { CSS,
                      "input[class=\"form-control form-control\"][placeholder=\"Dpto. / Int / Piso / Edificio (Opcional)\"]" },
                  ...
                  // Write text in address reference
                  typeText(new String[] { CSS,
                    "input[class=\"form-control form-control\"][placeholder=\"Referencia (Opcional)\"]" }, "100");
                  // Write text in address phone
                  typeText(new String[] { CSS,
                      "input[class=\"form-control form-control\"][placeholder=\"Teléfono de contacto*\"]" },
                    "7867876788");
                  // wait
                  waitUntil("CheckClickableElement",
                    new String[] { CSS, "button[type='submit'][form='belcorpAddressForm']" }, "10", "disabled");
                  // Click on Continue Button
                  clickOnElement(new String[] { CSS, "button[type=\"submit\"][form=\"belcorpAddressForm\"]" });
            ...
            @Test public void Customizable_Palette_PDP_Full_Palette_MTO__COneFiveFourSeven () {
              ...
              // Go to URL
              getURL(
                "https://s1-esika.tiendabelcorp.com/cl/beauty-box-%28paleta-completa%29/p/3_1_202108_cl/pruebaqas222");
              ...
              if (isElementAvailable(new String[] { XPATH, "//div[@class=\'product-variant-container\']" })) {
                ...
                if (isElementAvailable(
                  new String[] { XPATH, "//button[contains(@class,\'variantSelectorButton\')]" })) {
                  ...
                  if (isElementClickable(
                    ...
                    if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" })) {
                      ...
                      if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" })) {
                        ...
                        clickOnElement(new String[] { XPATH, "//button[@id=\'addToCartVariableSet\']" });
                        // wait until
                        waitUntil("CheckVisibleElement", new String[] { XPATH, "//a[contains(text(),'Ir a pagar')]" },
                          "5", "disabled");
                        // end if for \"add to cart\" clickable
                      }
                      // Else statement \"add to cart\" clickable
                    ...
                    // if condition for \" go pay\" present
                    if (isElementAvailable(new String[] { XPATH,
                      "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]" })) {
                      // if condition for \" go pay\" clickable
                      if (isElementClickable(new String[] { XPATH,
                        "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]" })) {
                        // click on \"go pay\" button
                        clickOnElement(new String[] { XPATH,
                          "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]" });
                    ...
                    if (isElementAvailable(new String[] { XPATH, "//input[@id=\'j_username\']" })) {
                      ...
                      // click on login
                      clickOnElement(
                        new String[] { XPATH, "//button[@class=\'loginBtn btn btn-black btn-block mt-15\']" });
                      // end if email
                    }
                    // else email
                    else {
                    ...
                    if (isDisplayed(new String[] { XPATH, "//select[@id=\'address.regionIsoParent2\']" }, 0)) {
                      // Select region
                      selectOption(new String[] { XPATH, "//select[@id=\'address.regionIsoParent2\']" },
                        "ANTOFAGASTA (II)");
                      // Select commune
            ...
            status = "passed";
          } @Test public void CO__Customizable_Palette_PDP_Full_Palette_ECOMCOneFiveFiveEight () {
          ...
          @Test public void Recommended_Flow_SetsCThreezeroThreeFive () {
            ...
            if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Sets recomendados\')]" })) {
              ...
              takeScreenshot("logs/Screenshoots/vgktiq.png");
              // end if statement
            }
            // start else statemnet
            else {
          ...
          @Test public void MXCustomizable_PalettePDP_Full_Palette_MTOCOneFiveFourEight () {
          ...
          @Test public void Verify_My_personal_dataCThreezeroTwozero () {
            ...
            waitUntil("CheckVisibleElement",
              new String[] { XPATH, "//div[@class='onlyPageLogin register smalltitle']" }, "10", "disabled");
            ...
            // Else Statement
              ...
              waitUntil("CheckVisibleElement",
                new String[] { XPATH, "(//ul[@class='nav__links nav__links--account']/child::li)[3]" }, "10",
                "disabled");
              // Login Symbol is Visible
              if (isDisplayed(new String[] { XPATH, "(//ul[@class=\'nav__links nav__links--account\']/child::li)[3]" },
                0)) {
                // Click on again Login Symbol
                clickOnElement(
                  new String[] { XPATH, "(//ul[@class=\'nav__links nav__links--account\']/child::li)[3]" });
                ...
                Assert.assertTrue(
                  isElementAvailable(new String[] { XPATH, "//li[@class=\'logged_in js-logged_in\']" }));
                ...
                clickOnElement(
                  new String[] { XPATH, "//div[contains(@class,\'add-new-address-container\')]/child::a" });
                // Write text in Document No text field
                typeText(new String[] { XPATH, "//input[@id=\'address.documentNumber\']" }, "7865567892");
                // Write text in Billing Name text field
                typeText(new String[] { XPATH, "//input[@id=\'address.billingName\']" }, "karthik bala");
                ...
                takeScreenshotOfParticularElement(
                  new String[] { XPATH, "//form[@id=\'belcorpAddressForm\']/parent::div" },
                  "logs/Screenshots/WBggyE.png");
                // Click on Save Address Button
                clickOnElement(new String[] { XPATH, "//button[text()=\' GUARDAR DIRECCIÓN \']" });
                // Validate  Address created successfully
                Assert.assertTrue(isElementAvailable(
                  new String[] { XPATH, "//div[@class=\'alert alert-success alert-dismissable\']" }));
                // Click on again loginSymbol
                clickOnElement(new String[] { XPATH, "//li[@class=\'yCmsComponent\']/child::a" });
