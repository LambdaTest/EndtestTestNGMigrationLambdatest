...
public class BackEnd_Consolidated extends WebDriverHelper {
  ...
  public void EC_Check_add_product_to_bag___C() {
    ...
    takeScreenshot("logs/Screenshoots/sVGbUs.png");
  ...
  public void ECSCENARIO__Purchase_in_virtual_store__With_Cash_plus_Coupon_and_PromotionC() {
    ...
    if (isElementAvailable(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" })) {
      ...
      // Screenshot of Mail
      takeScreenshot("logs/Screenshoots/xhALPb.png");
      // end if statement
    }
    // start else statemnet
    else {
  ...
  public void Ec_Verify_NoEcomm_Footer__C() {
    ...
    takeScreenshot("logs/Screenshoots/itXfSX.png");
  ...
  public void EC_Verify_Register_as_a_Registered_Account_from_the_Brand__C() {
    ...
    clickOnElement(new String[] { XPATH, "//button[@class=\'loginBtn btn btn-black btn-block mt-15\']" });
    // Verify that it returns to the Home Page
    takeScreenshot("logs/Screenshoots/NmgVnW.png");
    // verify  upper left corner it says Hello \'Name\'
    Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//li[@class=\'logged_in js-logged_in\']" }));
  ...
  public void Recommended_Flow_SetsC() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Sets recomendados\')]" })) {
      ...
      takeScreenshot("logs/Screenshoots/pmavGW.png");
      // end if statement
    }
    // start else statemnet
    else {
  ...
  public void Flujo_Kit_InicioC() {
    ...
    @Test public void CL__Customizable_Palette__PDP_Average_full__MTOC () {
      // clear cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void ECSCENARIO__Purchase_in_virtual_store__With_Credit_card_and_Discount_Coupon__C () {
      // Clear cookies and cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
      ...
      @Test public void HYBRISV__As_a_consumer_I_want_to_have_the_integration_with_custom_bundles_to_have_offers_recommended_just_for_me__ECC
      () {
        // clear cache
        // Clear cookies
        deleteAllCookies();
        ...
        if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver detalle del set\"]" })) {
          ...
          Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver detalle del set\"]" }));
          // Click on see Set Details
          javascriptExecution(" document.querySelector(\
            "div#lazyLoadCommercialCarousel div:nth-child(1) > div > div > div > div.commercialCarousel-pdp-footer > a\").click();");
          // Add Assertion For First Product
          Assert.assertTrue(isElementAvailable(new String[] { CSS,
            "div#cboxLoadedContent div:nth-child(6) > div.row.linkProductDetailModal > div.col-md-8 > div.title > p" }));
          // Add Assertion For Second  Product
        ...
        status = "passed";
      } @Test public void Customizable_Palette_PDP_Full_Palette_MTO__C () {
        // clear cache and cookies
        // Clear cookies
        deleteAllCookies();
        // Clear storage
      ...
      status = "passed";
    } @Test public void MX_Paleta_Customizable_PDP_Media_complete_MTO__C () {
      // clear cache and cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
      ...
      status = "passed";
    } @Test public void ECSCENARIO__Purchase_in_virtual_store__start_Guest_User__debit_cardC () {
      // clear cookies and cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
      ...
      if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
        ...
        getURL("https://www.mailinator.com/");
        // Write Text In search bar text field
        typeText(new String[] { XPATH, "//input[@class=\'form-control input-text h-auto\']" },
        ...
        if (isElementAvailable(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" })) {
          ...
          clickOnElement(new String[] { XPATH, "(//tr[@ng-repeat=\'email in emails\'])[1]" });
          // Screenshot of Mail
          takeScreenshot("logs/Screenshoots/SYwHQV.png");
          // End If Statement
        }

        status = "passed";
      } @Test public void Creation_of_spinner_by_clicking_on_the_add_to_cart_Set_Variables_and_Palette___CC () {
        // clear cache and cookies
        // Clear cookies
        deleteAllCookies();
        // Clear storage
      ...
      @Test public void MX__Customizable_Palette_PDP_Full_Palette_ECOMC () {
        // clear cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
      ...
      @Test public void ECOM__CL_Pop_up_in_Piloto_Chile_C () {
        // Clear cookies and cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
      ...
      @Test public void HYBRISV__As_a_consumer_I_want_more_payment_options_in_agent__web_banking_to_be_able_to_secure_the_purchase__ECC
      () {
        // clear cache
        // Clear cookies
        deleteAllCookies();
      ...
      @Test public void Scroll_down__up_with_the_scroll_bar__C () {
        // clear cache and cookies
        // Clear cookies
        deleteAllCookies();
        // Clear storage
        ...
        pressKey(new String[] { XPATH, "//input[@id=\'js-site-search-input\']" },
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\'div-tono shadeSelectedOpenBox\']" })) {
          ...
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//div[@class=\'div-tono shadeSelectedOpenBox\']" }));
          ...
          takeScreenshot("logs/Screenshoots/tOIlVW.png");
          // Scroll up to the start of the tones
          scroll("ScrollTop", 250);
          // Assert scrolling up
          takeScreenshot("logs/Screenshoots/VknMFS.png");
      ...
      @Test public void CO__Customizable_Palette_PDP_Full_Palette_ECOMC () {
        // clear cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
        ...
        status = "passed";
      } @Test public void PE_Customizable_PalettePDP_Full_Palette_MTOC () {
        // clear cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
        ...
        if (isElementAvailable(new String[] { XPATH, "(//div[@class=\"product-variant-container\"])[1]" })) {
          ...
          if (checkCurrentUrlContains("cart")) {
            ...
            takeScreenshot("logs/Screenshoots/rGVPzk.png");
            // add assertion for qty increase button
            Assert.assertFalse(isElementClickable(new String[] { CSS,
              "div.item__quantity.hidden-xs.hidden-sm > form#updateCartForm0 > button.item__quantity__action_btn.item__quantity__action_plus_btn" }));
            // add assertion for remove link
      ...
      @Test public void MXCustomizable_PalettePDP_Full_Palette_MTOC () {
        // Clear Cache And Cookies
        // Clear cookies
        deleteAllCookies();
        // Clear storage
