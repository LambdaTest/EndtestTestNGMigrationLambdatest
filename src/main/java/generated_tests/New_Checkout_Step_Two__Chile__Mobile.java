  ...
  public void Verify_behavior_in_Billing_Address_for_TJ_Debit_CL_TSevenTwoEightzero() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[@class=\"navbar-toggle js-toggle-sm-navigation\"]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//button[@class=\"navbar-toggle js-toggle-sm-navigation\"]" })) {
        ...
        clickOnElement(new String[] { XPATH, "//button[@id=\"addToCartButton\"]" });
        // wait until cart
        waitUntil("CheckVisibleElement", new String[] { XPATH, "//a[contains(text(),'Ir a pagar')]" }, "10",
          "disabled");
        // click on gopay
        // explicit wait for Go Pay Button
        waitUntil("CheckClickableElement", new String[] { XPATH, "//a[contains(text(),'Ir a pagar')]" }, "10",
        ...
        Assert.assertTrue(getText(new String[] { XPATH,
          "//div[@class=\'address-selector delivery-address-selector\']/child::div[1]" }).contains(
          "Dirección de envío"));
        // Validate Shipping Address
        takeScreenshotOfParticularElement(
          new String[] { XPATH, "//div[@class=\'address-selector delivery-address-selector\']" },
          "logs/Screenshots/WIZawY.png");
        // Add New Address Link is Visible
        if (isDisplayed(new String[] { XPATH, "//a[@id=\'checkout-add-new-address\']" }, 0)) {
          // Click on Add New Address Link
          clickOnElement(new String[] { XPATH, "//a[@id=\'checkout-add-new-address\']" });
          ...
          // Explicit wait  Saved Address
          waitUntil("CheckElement",
            new String[] { XPATH, "//a[@class='checkout-view-saved-addresses js-checkout-view-saved-addresses']" },
            "10", "disabled");
          // Click on Saved Address
          javascriptExecution(
            "document.querySelector(\"a[class=\'checkout-view-saved-addresses js-checkout-view-saved-addresses\']\").click();");
      ...
      @Test public void Verify_criteria_in_Pending_Payment_in_new_checkoutTSevenTwoSevenFive () {
      ...
      @Test public void Verify_behavior_in_Billing_Address_for_TJ_CreditTSevenTwoSevenEight () {
        ...
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "(//div[contains(text(),\'Dirección de pago\')])[1]" }));
      ...
      @Test public void Check_criteria_of_selected_TJTSevenTwoSevenTwo () {
      ...
      @Test public void Check_Billing_Address_layout_for_TJ_CreditTSevenTwoSevenSeven () {
      ...
      @Test public void Verify_criteria_in_Payment_Approved_in_new_checkoutTSevenTwoSevenThree () {
        ...
        if (checkCurrentUrlContains("orderConfirmation")) {
          ...
          if (isDisplayed(new String[] { XPATH, "//div[contains(text(),\'just now\')]" }, 0)) {
            ...
            takeScreenshot("logs/Screenshoots/zSvCcK.png");
            // end if statement
          }
        ...
        if (checkCurrentUrlContains("orderConfirmation")) {
          ...
          if (isDisplayed(new String[] { XPATH, "//div[contains(text(),\'just now\')]" }, 0)) {
            ...
            javascriptExecution(
              "document.querySelector(\"div#main_inbox_area div:nth-child(1) > div > div.block-subject.w-100 > a\").click();");
            // take a screen shot for mail validation
            takeScreenshot("logs/Screenshoots/Btfdwy.png");
            // end if statement
          }
          // switch back to initial tab
          switchToPreviousTab();
        ...
        status = "passed";
      } @Test public void Verify_behavior_of_old_CheckoutTSevenTwoSevenSix () {
        ...
        Assert.assertTrue(
          isElementAvailable(new String[] { CSS, "div.securePay-container.hidden-securePay > div > span" }));
        // Click on Credit Card Section
        javascriptExecution(
          "document.querySelector(\"label[for=\'belcorpNewCheckoutPaymentMode_mpago_credit\']\").click();");
        // wait until debit card text field
      ...
      @Test public void Verify_criteria_in_Payment_Rejected__in_new_checkoutTSevenTwoSevenFour () {
      ...
      @Test public void Verify_layout_Billing_Address_for_TJ_DebitTSevenTwoSevenNine () {
        ...
        if (isElementAvailable(new String[] { XPATH, "//button[@class=\"navbar-toggle js-toggle-sm-navigation\"]" })) {
          ...
          // click on hamburgur menu
          javascriptExecution(
            "document.querySelector(\"div.new-header.header-izq > button[type=\'button\']\").click();");
          // Click on makeup
          clickOnElement(new String[] { XPATH, "//a[@title=\"Maquillaje\"]" });
          // Click on first product
          javascriptExecution(
      ...
      @Test public void Verify_layout_Step_Two_Payment_with_TJ_Credit__New_CheckoutTSevenTwoSevenOne () {
