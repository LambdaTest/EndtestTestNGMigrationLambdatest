...
public class SB_Test_cases__regression extends WebDriverHelper {
...
// End if statement
  ...
  @Test
  public void CL__EE_Add_supported_from_carousel_in_PDPC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
waitUntil("CheckElement", new String[]{ID, "deliveryMethodSubmit"}, "15","disabled");
  ...
  @Test
  public void PA__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC() {
...
// End Loop Else Statement
  ...
  @Test
  public void CL__EE_Add_supported_from_PDP_carousel__Free_Sample__send_to_SB__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'panel-body\'])[1]" },"logs/Screenshots/lxyDrd.png");
...
// end if product present  in sets
  ...
  @Test
  public void MX__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
waitForTime(6);
// take screenshot
takeScreenshot("logs/Screenshoots/blQvUc.png");

    status = "passed"; 
   }
  @Test
  public void CO__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC_C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div//li[text()=\'cyzonapp11@gmail.com\']"}));
  ...
  @Test
  public void CL__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBCCC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End  else statement
  ...
  @Test
  public void EC__EE_Add_supported_from_PDP_carousel__Free_Sample__send_to_SBC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if confirmation page present
  ...
  @Test
  public void CO__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC() {
// Go to URL
getURL("https://s1-esika.tiendabelcorp.com/co/?consultantUrl=tiendaCO98");
...
// end else statement
  ...
  @Test
  public void CL__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
goForward();
  ...
  @Test
  public void PE__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End  else statement
  ...
  @Test
  public void CL__EE_Search_by_Name_with_Login_Networks_and_checkout_by_SBCC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
