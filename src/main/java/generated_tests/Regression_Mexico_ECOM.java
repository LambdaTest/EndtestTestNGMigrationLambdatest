...
public class Regression_Mexico_ECOM extends WebDriverHelper {
  ...
  @Test
  public void MX__EE_apply_Discount_coupon__CCCC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "(//div[@class=\"horizontal-scroll-list__product-cards\"]//div[@class=\"productCard__title\"]/a)[3]"});
