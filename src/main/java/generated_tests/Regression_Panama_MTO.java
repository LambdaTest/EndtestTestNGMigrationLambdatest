...
public class Regression_Panama_MTO extends WebDriverHelper {
  ...
  @Test
  public void PA__ETwoE_Access_from_the_landing_of_brands__categories__guest_user_and_checkout_Agency_BankingCOneSevenFiveSixSevenOneCEightThreeEight() {
    javascriptExecution(
      "lambda-name=PA  ETwoE Access from the landing of brands  categories  guest user and checkout Agency BankingCOneSevenFiveSixSevenOneCEightThreeEight");
    ...
    selectOption(new String[] { CSS,
        "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(3) > div > select" },
      "000004000001000008");
    ...
    typeText(new String[] { CSS,
        "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(7) > input" },
      "near bridge");
    // Write text in address reference
    typeText(new String[] { CSS,
        "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(9) > input" },
      "100");
    // Write text in phone textbox
    typeText(new String[] { CSS,
        "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(11) > input" },
      "7894561123");
    ...
    typeText(new String[] { CSS,
        "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > div > form > div:nth-of-type(5) > input" },
      "12345678");
    // Write text in cardholderName
    typeText(new String[] { CSS,
        "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > div > form > div:nth-of-type(7) > input" },
    ...
    // wait
    waitUntil("CheckVisibleElement", new String[] { CSS, "div[class='checkout-success__body__headline']" }, "10",
      "disabled");
    // if visible message
  ...
  @Test
  public void PA__ETwoE_with_Search_by_CUV_with_Account_Login_and_checkout_by_CCCOneEightzerozeroSevenSixCTwoNineFourFive() {
    javascriptExecution(
      "lambda-name=PA  ETwoE with Search by CUV with Account Login and checkout by CCCOneEightzerozeroSevenSixCTwoNineFourFive");
    ...
    if (isElementAvailable(new String[] { XPATH, "//div[@class=\"details\"]//a[@class=\"name\"]" })) {
      // Click on first product
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\"item__remove-action\"]/child::div/child::a" }));
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]/form" }));
      // Add Assertion for price
      Assert.assertTrue(isElementAvailable(new String[] { XPATH,
        "//div[@class=\"item__quantity hidden-xs hidden-sm\"]/following-sibling::div[@class=\"item__price\"]" }));
      // Add Assertion for total price
      Assert.assertTrue(isElementAvailable(new String[] { XPATH,
        "//div[@class=\"item__quantity hidden-xs hidden-sm\"]/following-sibling::div[@class=\"item__total js-item-total hidden-xs hidden-sm\"]" }));
      // Click on go pay button
      clickOnElement(
        new String[] { XPATH, "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]" });
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[text() = \"Resumen de tu bolsa de compras\"]" }));
      // Add Assertion for product
  ...
  @Test
  public void PA__ETwoE_Access_from_the_landing_of_brands_categories__guest_user_and_checkout_Agency__BankingCOneEightzerozeroFourOneCFiveFiveSix() {
    javascriptExecution(
      "lambda-name=PA  ETwoE Access from the landing of brands categories  guest user and checkout Agency  BankingCOneEightzerozeroFourOneCFiveFiveSix");
    ...
    // if image present
    if (isElementAvailable(new String[] { CSS, "ul#productGalleryThumbnails div:nth-child(2) > div > li > a > img" })) {
    ...
    Assert.assertTrue(isElementAvailable(new String[] { CSS,
      "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > ul > li:nth-of-type(2) > div:nth-of-type(3) > div:nth-of-type(1) > span" }));
    // Add Assertion for total cart price
    Assert.assertTrue(isElementAvailable(new String[] { CSS,
      "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div:nth-of-type(2) > span" }));
  ...
  @Test
  public void PA__ETwoE_with_Search_by_CUV_with_Account_Login_and_checkout_by_CC__COneSevenFiveSixFourSevenCFiveFourSix() {
    javascriptExecution(
      "lambda-name=PA  ETwoE with Search by CUV with Account Login and checkout by CC  COneSevenFiveSixFourSevenCFiveFourSix");
    ...
    typeText(new String[] { XPATH,
        "//div[@class=\'col-md-4 col-md-offset-4 text-center\']/../..//input[@id=\'js-site-search-input\']" },
      "200090365");
    // Click on search
  ...
  @Test
  public void PA__ETwoE_apply_Discount_coupon__CCCFiveSixSix__CThreeSevenFourSix() {
    javascriptExecution("lambda-name=PA  ETwoE apply Discount coupon  CCCFiveSixSix  CThreeSevenFourSix");
    ...
    clickOnElement(
      new String[] { XPATH, "(//button[@class=\"item__quantity__action_btn item__quantity__action_plus_btn\"])[2]" });
    // start of if loop
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//div[@class=\"col-xs-6 cart-totals-right text-right discount\"]" }));
  ...
  @Test
  public void PA__ETwoE_apply_Discount_coupon__CCCFiveEightOne__CThreeSevenFourSix() {
    javascriptExecution("lambda-name=PA  ETwoE apply Discount coupon  CCCFiveEightOne  CThreeSevenFourSix");
  ...
  @Test
  public void PA__ETwoE_Access_from_the_brands_categories_landing__guest_user__Credit_cardCTwoNineFiveSeven__PHASETwo() {
    javascriptExecution(
      "lambda-name=PA  ETwoE Access from the brands categories landing  guest user  Credit cardCTwoNineFiveSeven  PHASETwo");
  ...
  @Test
  public void PA__ETwoE_create_account__Tiered_Discount__CCCFiveSixOne__CThreeSevenFourOne() {
    javascriptExecution("lambda-name=PA  ETwoE create account  Tiered Discount  CCCFiveSixOne  CThreeSevenFourOne");
