...
public class Regression_Colombia_Ecom extends WebDriverHelper {
  ...
  public void Document_type_validation_at_CheckoutC_PHASE() {
    ...
    Assert.assertTrue(getText(new String[] { XPATH, "//div[@id=\'docNumberDebit-error\']" })
      .contains("El NIT debe tener 10 caracteres numéricos"));
    ...
    Assert.assertTrue(getText(new String[] { XPATH, "//div[@id=\'docNumberDebit-error\']" })
      .contains("Los siguientes caracteres ingresados no son válidos: (*@), solo se aceptan números"));
    ...
    Assert.assertTrue(getText(new String[] { XPATH, "//div[@id=\'docNumberDebit-error\']" })
      .contains("El documento debe tener entre 5 y 20 caracteres"));
    ...
    // Validating Error Message
    Assert.assertTrue(getText(new String[] { XPATH, "//div[@id=\'docNumberDebit-error\']" })
      .contains("El documento debe tener entre 6 y 20 caracteres"));
