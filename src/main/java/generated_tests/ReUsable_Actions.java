...
if (checkContainsValue(new String[] { XPATH, "//div[@class=\"visible-md visible-lg\"]//div[@class=\"cart-popup-progress-text\"]"})){
// end if
}
...
// Full Screen
takeScreenshotOfEntirePage(logs/Screenshoots/WBJHiM.png);
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/FRXLrN.png");
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/ZUFLKs.png");
// start else statement
else{
// print result
...
takeScreenshot("logs/Screenshoots/MVcMVg.png");
// end if statement
}
...
");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/haHZVr.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'checkout-order-summary\'])[1]" },"logs/Screenshots/lwUzMf.png");
// end if statement
}
// else statement
else{
