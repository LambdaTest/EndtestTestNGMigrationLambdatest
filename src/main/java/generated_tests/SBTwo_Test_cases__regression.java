...
public class SBTwo_Test_cases__regression extends WebDriverHelper {
  ...
  public void EC__ETwoE_Add_supported_from_PDP_carousel__Free_Sample__send_to_SBTwoCOneEightzeroTwozeroSix() {
    javascriptExecution(
      "lambda-name=EC  ETwoE Add supported from PDP carousel  Free Sample  send to SBTwoCOneEightzeroTwozeroSix");
    ...
    () {
      javascriptExecution(
        "lambda-name=CL  ETwoE Search by Name with Login Networks and checkout by SBTwoCOneEightzerozeroThreeTwoCFiveFourSevenCTwoNineFourSeven");
      ...
      if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Enviar pedido\"]" })) {
        ...
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "//h3[text() = \"¡Listo! Tu pedido fue enviado\"]" }));
    ...
    @Test public void MX__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCFiveFourNine () {
      javascriptExecution(
        "lambda-name=MX  ETwoE Search by Name with Login Networks and checkout by SBTwoCFiveFourNine");
...
Assert.assertTrue(
  ...
  isElementDisplayed(new String[] {
    XPATH, "//li//div//div//div[@class=\'nav-cart\']//div//div[@class=\'add-to-cart add-to-cart-cross\']//a[contains(text(),\'     Seguir Comprando\')]"
  }));
  // assertion on \"Go Pay\"
Assert.assertTrue(
  ...
  // Click on go pay
  clickOnElement( new String[] {
    XPATH, "//div[@class=\'down-bar-actions col-md-6 col-xs-12\']//button[@id=\'checkout-display-continueCheckout\']"
  });
  // Add Assertion for social network button
Assert.assertTrue(

  isElementAvailable(new String[] {
    XPATH, "//span[text() = \"Ingresar con Facebook\"]"
  }));
  ...
  // take screenshot
  takeScreenshot("logs/Screenshoots/zAvltB.png");
  ...
  public void PA__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCOneSevenFiveSixFiveOne() {
    javascriptExecution(
      "lambda-name=PA  ETwoE Search by Name with Login Networks and checkout by SBTwoCOneSevenFiveSixFiveOne");
    ...
    Assert.assertTrue(isElementAvailable(new String[] { XPATH,
      "(//div[@class=\'details\']/child::div/child::div[@class=\'strikethrough\']/child::p)[1]" }));
    // Add assertion for crossed price
    Assert.assertTrue(isElementDisplayed(
      new String[] { XPATH, "//div[@class=\'details\']/child::div[2]/child::span[@class=\'old-price\']" }));
    // Click on Go Pay
    // explicit wait for Go Pay Button
    waitUntil("CheckClickableElement", new String[] { XPATH, "//a[contains(text(),'Ir a pagar')]" }, "10", "disabled");
    // Click on go pay
    ...
    // start else statement
      ...
      // Else Statement
        ...
        if (isElementClickable(new String[] { XPATH,
          "//strong[text()=\'Coordinando la entrega con tu Consultora\']/parent::div/child::a[text()=\'Enviar pedido\']" })) {
          ...
          Assert.assertTrue(isElementDisplayed(new String[] { XPATH,
            "//div[contains(@class,\'consultant-confirmation-button-wsp-container\')]/child::a" }));
      ...
      @Test public void PE__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCTwoNineFivezero () {
        javascriptExecution(
          "lambda-name=PE  ETwoE Search by Name with Login Networks and checkout by SBTwoCTwoNineFivezero");
        ...
        if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Enviar pedido\"]" })) {
          ...
          // Add Assertion for send message by whatsapp
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//a[text() = \"Enviar mensaje por Whatsapp\"]" }));
          // Add Assertion for send message by whatsapp
          Assert.assertTrue(
            isElementClickable(new String[] { XPATH, "//a[text() = \"Enviar mensaje por Whatsapp\"]" }));
          // end if
        }
        // start else statement
        else {
      ...
      @Test public void PA__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCOneEightzerozeroThreeSix () {
        javascriptExecution(
          "lambda-name=PA  ETwoE Search by Name with Login Networks and checkout by SBTwoCOneEightzerozeroThreeSix");
        ...
        if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
          ...
          // Add Assertion for go pay
          Assert.assertTrue(isElementAvailable(
            new String[] { CSS, "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(1)" }));
          // add  assertion for go pay checkout
          Assert.assertTrue(isElementAvailable(new String[] { ID, "checkout-display-continueCheckout" }));
          // Click on go pay continue
          clickOnElement(new String[] { CSS,
            "div#StickySidebar > div > div:nth-of-type(5) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)" });
          // Add Assertion for social network button
          Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"Ingresar con Facebook\"]" }));
          // login fb
          // Click on Ingresar con Fa...
      ...
      @Test public void CL__ETwoE_Add_supported_from_PDP_carousel__Free_Sample__send_to_SBTwo__CFiveSixSeven () {
        javascriptExecution(
          "lambda-name=CL  ETwoE Add supported from PDP carousel  Free Sample  send to SBTwo  CFiveSixSeven");
        ...
        if (isElementAvailable(new String[] { XPATH, "//a[@class=\'name\']" })) {
          ...
          if (isElementAvailable(new String[] { XPATH, "(//div[@class=\'panel-body\'])[1]" })) {
            // Add assertion for free sample
            takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'panel-body\'])[1]" },
              "logs/Screenshots/KyuGQg.png");
      ...
      @Test public void MX__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCTwoNineFourNine () {
        javascriptExecution(
          "lambda-name=MX  ETwoE Search by Name with Login Networks and checkout by SBTwoCTwoNineFourNine");
        ...
        Assert.assertTrue(isElementAvailable(new String[] { CSS,
          "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > ul > li:nth-of-type(3) > table > tbody > tr > td > li:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(1) > div > a" }));
        // Add Assertion for Remove button
        ...
        // write text in postal code
        typeText(
          new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Ingresa tu código postal\"]" },
          "22056");
        // select option from cologne dropdown
        selectOption(new String[] { CSS,
            "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(3) > form > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(3) > div > select" },
          "MX-BCN-TIJUANA-HIDALGO");
        // Write text in address.line1
        typeText(new String[] { CSS,
            "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(3) > form > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(4) > input" },
          "plot no-100 ,2nd street road");
        // Write text in address.phone
        typeText(new String[] { CSS,
            "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(3) > form > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(7) > input" },
          "7896567434");
        ...
        clickOnElement(new String[] { CSS,
          "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(3) > form > div:nth-of-type(2) > label > input:nth-of-type(1)" });
        // click on finalize your purchase button
      ...
      () {
        javascriptExecution(
          "lambda-name=CL  ETwoE Search by Name with Login Networks and checkout by SBTwoCOneSevenFiveSixTwoSixCTwoNineFourSeven");
      ...
      @Test public void CO__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCTwoNineFourEight () {
        javascriptExecution(
          "lambda-name=CO  ETwoE Search by Name with Login Networks and checkout by SBTwoCTwoNineFourEight");
        ...
        // Add Assertion for remove button
        Assert.assertTrue(isElementClickable(new String[] { CSS,
          "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > ul > li:nth-of-type(3) > table > tbody > tr > td > li:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > div > a" }));
        // Add Assertion for remove button
        Assert.assertTrue(isElementAvailable(new String[] { CSS,
          "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > ul > li:nth-of-type(3) > table > tbody > tr > td > li:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div:nth-of-type(2) > div > a" }));
        // click on remove button
      ...
      {
        javascriptExecution(
          "lambda-name=CO  ETwoE Search by Name with Login Networks and checkout by SBTwoCFiveFourEight CTwoNineFourEight");
        ...
        Assert.assertTrue(isElementDisplayed(
          new String[] { XPATH, "//p[@class=\'product-variant-detailButton product-variant-detail-button-esika\']" }));
        // assertion on \"Add to cart\"
        Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" }));
        // refresh
        pageRefresh();
        ...
        selectOption(new String[] { CSS,
            "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div > select" },
          "25-GAMARRA");
        ...
        // Click on CLICK AQUÍ PARA...
        clickOnElement(new String[] { CSS,
          "button[type=\"button\"][class=\"btn btn-magenta btn-primary btn-block submit_mpagoCashForm checkout-next\"]" });
        // Click on Terms1
        clickOnElement(new String[] { CSS, "input[type=\"checkbox\"]" });
        // Click on Pay
      ...
      @Test public void PE__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCFiveFivezero () {
        javascriptExecution(
          "lambda-name=PE  ETwoE Search by Name with Login Networks and checkout by SBTwoCFiveFivezero");
      ...
      @Test public void CL__ETwoE_Search_by_Name_with_Login_Networks_and_checkout_by_SBTwoCOneEightzerozeroThreeTwo () {
        javascriptExecution(
          "lambda-name=CL  ETwoE Search by Name with Login Networks and checkout by SBTwoCOneEightzerozeroThreeTwo");
      ...
      @Test public void CL__ETwoE_Add_supported_from_carousel_in_PDPCOneSevenFiveSixTwoNine () {
