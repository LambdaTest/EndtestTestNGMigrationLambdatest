...
public class Regression_Peru_Ecom extends WebDriverHelper {
  ...
  @Test
  public void Validate_card_supported_by_Free_LbelC() {
// Go to URL
...
scrollIntoElementView( new String[] {CSS, "a[class=\'btn promotionButton viewDetailProductCommercialCarousel\']"});
...
// end else statement
  ...
  @Test
  public void Validate_Lbel_carousel_styles__C() {
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"¡Combínalo con otros productos para obtener\"]"}));
...
// end if promotion
  ...
  @Test
  public void Validate_card_in_Cyzone_supported_productCC() {
...
// explicit wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//span[contains(text(),'RECOMENDADOS')]/parent::h2/parent::div/child::div/child::div[4]/child::div/child::div[@class='addtocart bicCyzoneVirtualMakeupProductsButton']"}, "20","disabled");
// Click on Máscara de product
clickOnElement( new String[] {XPATH, "//span[contains(text(),\'RECOMENDADOS\')]/parent::h2/parent::div/child::div/child::div[4]/child::div/child::div[@class=\'addtocart bicCyzoneVirtualMakeupProductsButton\']/child::a"});
...
if (isElementAvailable(new String[] { XPATH, "h3[class=\"commercialCarousel-pdp-title js-owl-commercialCarouselPdp-title\"]"})){
...
// Add assertion for discount icon
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-header\']/child::i"}));
// Enf of If Loop
}
  ...
  @Test
  public void Validate_card_supported_by_Free_CyzoneC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// Click On Pay Button
clickOnElement( new String[] {CSS, "main > div:nth-of-type(4) > div > div:nth-of-type(1) > div:nth-of-type(3) > div:nth-of-type(2) > div > div > div:nth-of-type(6) > div > div > form > div:nth-of-type(7) > div > button"});
// end if  add to cart button
  ...
  @Test
  public void Shop_by_CategoryC_C_C() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 2 Simple Responsive Banner Component\"]"});
// Go to URL
getURL("https://s1-lbel.tiendabelcorp.com/pe/");
// scroll
scroll("ScrollDown", 1155);
...
clickOnElement( new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 1 Simple Responsive Banner Component\"]"});
...
clickOnElement( new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 3 Simple Responsive Banner Component\"]"});
...
mouseHoverOnElement(new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 2 Simple Responsive Banner Component\"]"});
// Add assertion for  Tratamiento Facial
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 2 Simple Responsive Banner Component\"]"}));
// mousehover on  Maquillaje img
mouseHoverOnElement(new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 1 Simple Responsive Banner Component\"]"});
// add asserttion for  Maquillaje img
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 1 Simple Responsive Banner Component\"]"}));
// mousehover on  Fragancias img
mouseHoverOnElement(new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 4 Simple Responsive Banner Component\"]"});
// add assertion for  Fragancias img
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 4 Simple Responsive Banner Component\"]"}));
// mousehover on  Cuidado personal img
mouseHoverOnElement(new String[] {XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 3 Simple Responsive Banner Component\"]"});
// add assertion for  Cuidado personal img
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@alt=\"PE Bic L\'Bel Shop By Category Item 3 Simple Responsive Banner Component\"]"}));

    status = "passed"; 
   }
  @Test
  public void Purchase_in_virtual_store_guest_user_credit_card_C_C_C_C_C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if
  ...
  @Test
  public void Validate_card_LBel_stylesC() {
// Go to URL
getURL(" https://cyzone.tiendabelcorp.com/pe/sets/c/cyzone-32/mitiendaonlineelizabeth");
// Click on L\'BEL
clickOnElement( new String[] {XPATH, "(//a[@id=\'lnk-sup-lbel\'])[2]"});
...
clickOnElement( new String[] {XPATH, "//a[text() = \"Ver detalle del regalo\"]"});
// Take screenshot
takeScreenshot("logs/Screenshoots/UMPupG.png");
// end if statement
}
// start else statement
else{
...
// end else statement
  ...
  @Test
  public void Facial_treatment_sectionC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//img[@title=\"Bic L\'Bel Treatment Lines Simple Responsive Banner Component\"]"});
// Click on LBel
clickOnElement( new String[] {XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"});
// scroll
scroll("ScrollDown", 2000);
// assertion on \"meet our facial treatment lines\"
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//h3[contains(text(),\'Conoce nuestras líneas de tratamiento facial\')]"}));
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@title=\"Bic L\'Bel Hyaluronic Acid Simple Responsive Banner Component\"]"}));
// click on second image
clickOnElement( new String[] {XPATH, "//img[@title=\"Bic L\'Bel Hyaluronic Acid Simple Responsive Banner Component\"]"});
// come back to main url
getURL("https://s1-cyzone.tiendabelcorp.com/pe/");
// Click on LBel
clickOnElement( new String[] {XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"});
// assertion on  \"All about hyaluronic acid\"
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//h3[contains(text(),\'Todo sobre el ácido hialurónico\')]"}));
// click on name
...
clickOnElement( new String[] {XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"});
// assertion on image
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@title=\"Bic L\'Bel Skin Diagnosis Simple Responsive Banner Component\"]"}));
// click on 3rd image
clickOnElement( new String[] {XPATH, "//img[@title=\"Bic L\'Bel Skin Diagnosis Simple Responsive Banner Component\"]"});
// go to LBel url
getURL("https://s1-cyzone.tiendabelcorp.com/pe/");
// Click on LBel
clickOnElement( new String[] {XPATH, "//header/child::nav/child::div/div/div/div/div//a[@id=\'lnk-sup-lbel\']"});
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//img[@title=\"Bic L\'Bel Concentre Simple Responsive Banner Component\"]"}));
...
Assert.assertTrue(isElementClickable(new String[] { CSS, "h3[class=\"belcorp-cms-carousel-item__title bic-virtual-makeup-component_btn\"]"}));
// Click on \"Concentré total\" name
clickOnElement( new String[] {CSS, "h3[class=\"belcorp-cms-carousel-item__title bic-virtual-makeup-component_btn\"]"});
// wait
waitForTime(5);
// go to url
getURL("https://s1-cyzone.tiendabelcorp.com/pe/");
...
clickOnElement( new String[] {XPATH, "//span[text() = \"COMPRAR AHORA\"]"});
  ...
  @Test
  public void Validate_that_the_product_name__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'product-name-sticky product-name-sticky-lbel\']"}));
// if add to cart present
...
// end if add to cart present
  ...
  @Test
  public void Validate_dynamic_title__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// if promotion icon present
if (isDisplayed(new String[] { XPATH, "//h3[@class=\'commercialCarousel-pdp-title js-owl-commercialCarouselPdp-title\']"}, 0)) {
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"mejores Dsctos!\"]"}));
// Add Assertion for content display
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"Solo al agregar Labial Studio Look Mate\"]"}));
// end if promotion
}
  ...
  @Test
  public void Register_Recommended_Bundle_Order_From_Conditional_SupportC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if lipstick present
  ...
  @Test
  public void Validate_Add_to_Bag_modalC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//a[text() = \"Máscara de pestañas studio look\"]"}));
// Click on Ir a pagar
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Ir a pagar\')]"});
// Add Assertion for Máscara de pest...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"Máscara de pestañas studio look\"]"}));
// if present
...
// end if add to cart present
  ...
  @Test
  public void Ask_for_a_giftC_PHASE() {
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "div:nth-child(2) > div.inner-card > div.addtocart > form > button > span.has-stock-text"});
...
clickOnElement( new String[] {CSS, "div:nth-child(4) > div.inner-card > div.addtocart > form > button > span.has-stock-text"});
// click on go pay button
// explicit wait for Go Pay Button
waitUntil("CheckClickableElement", new String[]{XPATH, "//a[contains(text(),'Ir a pagar')]"}, "10","disabled");
// Click on go pay
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Ir a pagar\')]"});
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//input[@class='js-send-as-gift-checkbox']"}, "10","disabled");
...
waitUntil("CheckVisibleElement", new String[]{CSS, "div#cboxLoadedContent div.gift-popup-title > span"}, "10","disabled");
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//div[@class=\'checkout-field-condition-msg-left\'])[2]"}));
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//div[@class=\'checkout-field-condition-msg\'])[2]"}));
...
clickOnElement( new String[] {CSS, "button[type=\"submit\"][form=\"belcorpAddressForm\"]"});
  ...
  @Test
  public void Purchase_in_virtual_store__C_C_C_C_C() {
...
getURL("https://s1-cyzone.tiendabelcorp.com/pe/");
// Click on cyzone
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(2) > div > div:nth-of-type(2) > div:nth-of-type(1) > div > div:nth-of-type(2) > div > div > div > form > div > div"});
...
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200104007_fotocrosselling.jpg\"]"});
// if add to cart present
if (isElementAvailable(new String[] { ID, "addToCartButton"})){
// Click on Add to bag
clickOnElement( new String[] {ID, "addToCartButton"});
// if continue shopping present
if (isElementAvailable(new String[] { CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(4) > div > div > div > div:nth-of-type(1) > div > a:nth-of-type(2)"})){
...
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(5) > div > div > div > div:nth-of-type(1) > div > a:nth-of-type(2)"});
// end if add to cart present
}
// Click on lbel
clickOnElement( new String[] {CSS, "header > nav:nth-of-type(1) > div > div > div:nth-of-type(1) > div > div > a:nth-of-type(2) > img"});
...
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200061181_preview_delice_manos_almendras.jpg\"]"});
...
// if go pay visible
if (isDisplayed(new String[] { CSS, "div#StickySidebar > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"}, 0)) {
// Click on Go pay
...
Assert.assertTrue(isElementDisplayed(new String[] { CSS, "img[class=\"lazy loaded\"][alt=\"twitter\"]"}));
  ...
  @Test
  public void Scenario__PECOCLMX__Pending_payment_by_credit_cardC_PHASE() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "label[for=\"belcorpNewCheckoutPaymentMode_mpago_credit\"]"});
// Write Text In CardHolder name
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--card-name not-empty\"][data-checkout=\"cardholderName\"][placeholder=\"Nombre del titular*\"][aria-describedby=\"cardholderName-error\"]" }, "CONT");
// Write  Text In Card No
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--card-number not-empty\"][data-checkout=\"cardNumber\"][placeholder=\"Número de la tarjeta*\"][onselectstart=\"return false\"][onpaste=\"return false\"][oncopy=\"return false\"][oncut=\"return false\"][ondrag=\"return false\"][ondrop=\"return false\"][autocomplete=\"off\"][aria-describedby=\"cardNumber-error\"]" }, "4168818844447115");
// select Option From Month Dropdown
selectOption(new String[] { XPATH, "//select[@name=\'expirationMonth\']" }, "11");
...
Assert.assertTrue(getText(new String[] { CSS, "div.text-center > b:nth-child(2)" }).contains("Tu transacción está pendiente"));
// Take Snip Of Pending message
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/yOsugE.png");
...
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Ir a pagar\')]"});
// click on go pay button
javascriptExecution("document.querySelector(\"div#StickySidebar div.down-bar-actions.col-md-6.col-xs-12 > div > button#checkout-display-continueCheckout\").click();");
// Login As Guest User
...
Assert.assertTrue(getText(new String[] { CSS, "div.text-center > b:nth-child(2)" }).contains("Tu transacción está pendiente"));
// Take Snip of pending Message
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/EKisza.png");
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/lcLsrF.png");
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div.text-center > b:nth-child(2)" }).contains("Tu transacción está pendiente"));
// Take snip Of pending Message
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/HlmcBN.png");

    status = "passed"; 
   }
  @Test
  public void SCENARIO__Purchase_in_virtual_store__log_in_with_google__debit_cardC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "ul[class=\"nav__links nav__links--products js-offcanvas-links\"]"}));
...
typeText(new String[] { CSS, "header > nav:nth-of-type(2) > div > div:nth-of-type(2) > div:nth-of-type(1) > div > div:nth-of-type(2) > div > div > div > form > div > div > div > input" }, "labial");
// press enter key
...
// end if add to cart present
  ...
  @Test
  public void PE__EE_Add_supported_from_PDP_carousel__Free_Sample__send_to_SBC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if makeup present
  ...
  @Test
  public void Validate_Cyzone_Carousel_Styles__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver productos\"]"}));
  ...
  @Test
  public void Brand_equityCphase_() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "div#EsikaBicSection7 div#dualbanner_banner_1 > div > p"}));
// add assertion for description
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "div#EsikaBicSection7 div#dualbanner_banner_1 > div > h2"}));
...
// end else
  ...
  @Test
  public void Validate_card_in_conditioned_CyzoneC_C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// if product present
if (isDisplayed(new String[] { XPATH, "(//a[@class=\'spanTitle ecarousel_product_productName_210097511\'])[1]"}, 0)) {
...
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'owl-item active\']//div//div//a[text()=\'Ver combinaciones\']"})){
// Click on see combinations
clickOnElement( new String[] {XPATH, "//div[@class=\'owl-item active\']//div//div//a[text()=\'Ver combinaciones\']"});
// Click on combination product
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Base de Maquillaje Studio Look Mate de Alta Cobertura\')]"});
// scroll
scroll("ScrollDown", 500);
// end of if loop
}
...
printResults("PrintNote", "\"This product is not applicable for see combination promotion\"");
  ...
  @Test
  public void Validate_card_in_conditioned_LbelC_C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// Click on first product
javascriptExecution("
document.querySelector(\"a[class=\'name\']\").click()");
// Refresh
pageRefresh();
// if promotion exclusive visible
if (isElementAvailable(new String[] { CSS, "h3[class=\"commercialCarousel-pdp-title js-owl-commercialCarouselPdp-title\"]"})){
...
// end if promotion exclusive visible
  ...
  @Test
  public void Validate_card_esika_styles__C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[text() = \"Promociones disponibles\"]"}));
// if promotion icon present
if (isDisplayed(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(5) > div > div:nth-of-type(1) > div > div:nth-of-type(1) > div > div > div > div:nth-of-type(1) > i"}, 0)) {
// Add Assertion for promotion icon
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(5) > div > div:nth-of-type(1) > div > div:nth-of-type(1) > div > div > div > div:nth-of-type(1) > i"}));
// end if promotion icon
}
// Add Assertion for combine with other products
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"¡Combínalo con otros productos para obtener\"]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"mejores Dsctos!\"]"}));
// Add Assertion for content display
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"Solo al agregar Máscara Mega Full Size APA\"]"}));
