...
clickOnElement( new String[] {XPATH, "//a[text() = \"Ver detalle del regalo\"]"});
// Take screenshot
takeScreenshot("logs/Screenshoots/FmlFiQ.png");
// end if statement
}
// start else statement
else{
...
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/arjXxY.png");
...
Assert.assertTrue(getText(new String[] { CSS, "div.text-center > b:nth-child(2)" }).contains("Tu transacción está pendiente"));
// Take Snip of pending Message
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/kWqoAJ.png");
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/ueKUFw.png");
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div.text-center > b:nth-child(2)" }).contains("Tu transacción está pendiente"));
// Take snip Of pending Message
takeScreenshotOfParticularElement(new String[] { CSS, "div.text-center > b:nth-child(2)" },"logs/Screenshots/VfRyGH.png");
