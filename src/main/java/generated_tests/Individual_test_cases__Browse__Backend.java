...
public class Individual_test_cases__Browse__Backend extends WebDriverHelper {
  ...
  @Test
  public void Backend__MTO_ECOM__PE__CO__CL__MX_EC_Consultant_search_engine__with_integration_of_Datalake_consultantsC__C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/kgqcFe.png");
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/sDXLxS.png");
...
// Take Snip Of Consultant Popup
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/NtWpjd.png");
// Click On Shop With me Button
clickOnElement( new String[] {XPATH, "//a[@id=\'js-buy-with-me\']"});
// if present
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/IifoTp.png");
// start else statement
else{
// print result
...
if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']"}, 0)) {
// Take Snip Of Consultant Popup
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/kjZZjv.png");
// Click On Shop With me Button
clickOnElement( new String[] {XPATH, "//a[@id=\'js-buy-with-me\']"});
// if present
if (isElementAvailable(new String[] { XPATH, "//span[@class=\'consultant-info\']"})){
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/YqXHZN.png");
// start else statement
else{
// print result
printResults("PrintNote", "\"consultant popup is not visible\"");
...
if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']"}, 0)) {
// Take Snip Of Consultant Popup
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/brgfMX.png");
// Click On Shop With me Button
clickOnElement( new String[] {XPATH, "//a[@id=\'js-buy-with-me\']"});
// if present
if (isElementAvailable(new String[] { XPATH, "//span[@class=\'consultant-info\']"})){
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/YJqkPO.png");
// start else statement
else{
// print result
printResults("PrintNote", "\"consultant popup is not visible\"");
...
if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']"}, 0)) {
// Take Snip Of Consultant Popup
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/fETRxu.png");
// Click On Shop With me Button
clickOnElement( new String[] {XPATH, "//a[@id=\'js-buy-with-me\']"});
// if present
if (isElementAvailable(new String[] { XPATH, "//span[@class=\'consultant-info\']"})){
...
// Take ScreenShot
takeScreenshot("logs/Screenshoots/bgeRUE.png");
// start else statement
else{
// print result
printResults("PrintNote", "\"consultant popup is not visible\"");
...
// end if
  ...
  @Test
  public void TONE__LBEL_DROP_BAR_Product_with_Variants_C__C() {
...
// end if makeup category present
  ...
  @Test
  public void I_want_to_receive_advice_from_the_consultants_pop_upC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end else statement
  ...
  @Test
  public void Backend__ECSCENARIO__NoEcomm_selecting_Consultant_to_be_able_to_buyC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Ingresa nombre*\"]" }, "Luis");
// Write text in consultant surname
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Ingresa apellido*\"]" }, "Robles");
// Select Option from Province Dropdown
...
Assert.assertTrue(getText(new String[] { XPATH, "//div[@class=\'results-table-row\']/div[3]" }).contains("GUAYAQUIL"));
// Click on Shop with me button
...
// Select Option from Province Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(1) > div > select" }, "000010");
// Select Option from Canton Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(2) > div > select" }, "000010000003");
// Select Option from Sector Dropdown
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(2) > div > select" }, "000010000001");
// Select Option from IBARRALA ESPERA...
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(2) > form > div:nth-of-type(1) > div:nth-of-type(10) > div:nth-of-type(3) > div > select" }, "000010000001000050");
...
typeText(new String[] { CSS, "input[type=\"text\"][class=\"form-control input--card-number not-empty\"][data-checkout=\"cardNumber\"][onselectstart=\"return false\"][onpaste=\"return false\"][oncopy=\"return false\"][oncut=\"return false\"][ondrag=\"return false\"][ondrop=\"return false\"][autocomplete=\"off\"]" }, "4168818844447115");
// Select Option from CédulaRUC
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > div > form > div:nth-of-type(5) > select" }, "RUC");
// clear input
...
selectOption(new String[] { CSS, "main > div:nth-of-type(3) > div > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > div > form > div:nth-of-type(6) > div:nth-of-type(1) > div:nth-of-type(1) > select" }, "12");
...
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[text() = ' Finalizar tu compra']"}, "20","disabled");
...
takeScreenshot("logs/Screenshoots/avgpcd.png");
// end if statement
}
...
// end if Look For Button present
  ...
  @Test
  public void Backend__Consultant_search_engine_C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// Write text in consultant Surname
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Ingresa apellido*\"]" }, "a");
// Select Option from Province Dropdown
selectOption(new String[] { CSS, "select[class=\"form-control\"]" }, "PE-DEP-06");
// if  Look For Button  present
if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'Buscar\')]"})){
...
// Click On Assign Me as Consultant Button
javascriptExecution("document.querySelector(\"button[class=\'btn btn-black btn-block js-asign-consultant\']\").click();");
// end else statement
}
// Take snip of Consultant Popup
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'cboxContent\']" },"logs/Screenshots/Ltyzsz.png");
// Click on Shop With Me Button
...
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Elige otra consultora\')]"});
// Take Screenshot
takeScreenshot("logs/Screenshoots/rLbhVJ.png");
// end if
}
