...
public class Individual_test_cases__Browse__Backend extends WebDriverHelper {
  ...
  public void Backend__MTO_ECOM__PE__CO__CL__MX_EC_Consultant_search_engine__with_integration_of_Datalake_consultantsC__C() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[text() = \" Buscar\"]" })) {
      ...
      // Take ScreenShot
      takeScreenshot("logs/Screenshoots/CLyVas.png");
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'ASIGNARME UNA CONSULTORA\')]" })) {
      ...
      if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']" }, 0)) {
        ...
        // Take ScreenShot
        takeScreenshot("logs/Screenshoots/jIbWiC.png");
        // start else statement
        // print result
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'ASIGNARME UNA CONSULTORA\')]" })) {
      ...
      if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']" }, 0)) {
        ...
        // Take ScreenShot
        takeScreenshot("logs/Screenshoots/ZOltNx.png");
        // start else statement
        // print result
        printResults("PrintNote", "\"consultant popup is not visible\"");
        // end else
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'ASIGNARME UNA CONSULTORA\')]" })) {
      ...
      if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']" }, 0)) {
        ...
        // Take ScreenShot
        takeScreenshot("logs/Screenshoots/neWDcw.png");
        // start else statement
        // print result
        printResults("PrintNote", "\"consultant popup is not visible\"");
        // end else
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'ASIGNARME UNA CONSULTORA\')]" })) {
      ...
      if (isDisplayed(new String[] { XPATH, "//div[@id=\'cboxContent\']" }, 0)) {
        ...
        // Take ScreenShot
        takeScreenshot("logs/Screenshoots/JCXAzd.png");
        // start else statement
        // print result
        printResults("PrintNote", "\"consultant popup is not visible\"");
        // end else
  ...
  public void Backend__ECSCENARIO__NoEcomm_selecting_Consultant_to_be_able_to_buyC() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'Buscar\')]" })) {
      ...
      if (isDisplayed(new String[] { XPATH, "//div[contains(text(),\'just now\')]" }, 0)) {
        ...
        takeScreenshot("logs/Screenshoots/UPQoaY.png");
        // end if statement
      }
  ...
  public void Backend__Consultant_search_engine_C() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[contains(text(),\'Buscar\')]" })) {
      ...
      clickOnElement(new String[] { XPATH, "//a[contains(text(),\'Elige otra consultora\')]" });
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/CAQhLK.png");
      // end if
    }
