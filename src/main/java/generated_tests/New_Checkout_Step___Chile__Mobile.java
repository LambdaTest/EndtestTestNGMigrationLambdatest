...
public class New_Checkout_Step___Chile__Mobile extends WebDriverHelper {
  ...
  public void Verify_behavior_in_Billing_Address_for_TJ_Debit_CL_T() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[@class=\"navbar-toggle js-toggle-sm-navigation\"]" })) {
      ...
      Assert.assertTrue(
        getText(new String[] { XPATH, "//div[@class=\'address-selector delivery-address-selector\']/child::div[1]" })
          .contains("Dirección de envío"));
      // Validate Shipping Address
      takeScreenshotOfParticularElement(
        new String[] { XPATH, "//div[@class=\'address-selector delivery-address-selector\']" },
        "logs/Screenshots/ntXhcK.png");
      ...
      if (isElementAvailable(
        ...
        takeScreenshotOfParticularElement(
          ...
          "logs/Screenshots/ocZuRA.png");
        // Validate Shipping address  Text
        Assert.assertTrue(getText(new String[] { XPATH, "(//span[@class=\'title shipping-address-title\'])[2]" })
          .contains("Dirección de envío"));
  ...
  public void Verify_criteria_in_Payment_Approved_in_new_checkoutT() {
    ...
    if (checkCurrentUrlContains("orderConfirmation")) {
      ...
      typeText(new String[] { XPATH, "//input[@class=\'form-control input-text h-auto\']" },
        "belcorp_test_user_86292523@testuser.com");
      // Press Enter Key
  ...
  public void Check_criteria_of_the_Dept_int__floor_fieldC() {
    ...
    String $deptTextFieldLength = String.valueOf(getTextLength($deptTextField));
    // add assertion for number of characters
    Assert.assertTrue(checkVariableAssertion("variableLessThanOrEqualsValue", "10", "10"));
    // write text in Apartment / int / floor
    typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
    // take a snip to verify the adress is accepting character
    takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },
      "logs/Screenshots/NWxHik.png");
  ...
  public void Check_criteria_of_the_Reference_fieldC() {
    ...
    String $referenceTextFieldLength = String.valueOf(getTextLength($referenceTextField));
    // add assertion for number of characters
    Assert.assertTrue(checkVariableAssertion("variableLessThanOrEqualsValue", "50", "50"));
    // write text in  reference
    typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
    // take a snip to verify the adress is accepting character
    takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },
      "logs/Screenshots/ORLXzN.png");
  ...
  public void Check_criteria_of_the_Contact_phone_fieldC() {
    ...
    String $contactTextFieldLength = String.valueOf(getTextLength($contactTextField));
    // add assertion for  Contact phone field
    Assert.assertTrue(checkVariableAssertion("variableLessThanOrEqualsValue", "20", "20"));
    // take a snip to verify the  Contact phone field is accepting character
    takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },
      "logs/Screenshots/aoOrJn.png");
  ...
  public void Verify_behavior_of_old_CheckoutT() {
    ...
    Assert.assertTrue(
      isElementAvailable(new String[] { CSS, "label[for=\'belcorpNewCheckoutPaymentMode_mpago_credit\']" }));
    // Add assertion For  Debit Card Section
    Assert.assertTrue(
      isElementAvailable(new String[] { CSS, "label[for=\'belcorpNewCheckoutPaymentMode_mpago_debit_w2w\']" }));
    ...
    Assert
      .assertTrue(isElementAvailable(new String[] { CSS, "div.securePay-container.hidden-securePay > div > span" }));
    // Click on Credit Card Section
    javascriptExecution(
      "document.querySelector(\"label[for=\'belcorpNewCheckoutPaymentMode_mpago_credit\']\").click();");
    // wait until debit card text field
  ...
  public void Check_criteria_of_the_Address_fieldC() {
    ...
    String $addressTextFieldLength = String.valueOf(getTextLength($addressTextField));
    // add assertion for number of characters
    Assert.assertTrue(checkVariableAssertion("variableLessThanOrEqualsValue", "60", "60"));
    // write text in address line
    typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
    // take a snip to verify the adress is accepting character
    takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },
      "logs/Screenshots/LdXdEB.png");
