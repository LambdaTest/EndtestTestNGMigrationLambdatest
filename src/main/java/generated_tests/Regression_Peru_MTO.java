...
public class Regression_Peru_MTO extends WebDriverHelper {
  ...
  @Test
  public void PE__ETwoE_Access_from_the_brands__categories_landing__guest_user_and_checkout_Agency__BankingCEightThreeSeven() {
    javascriptExecution(
      "lambda-name=PE  ETwoE Access from the brands  categories landing  guest user and checkout Agency  BankingCEightThreeSeven");
    ...
    clickOnElement(new String[] { CSS,
      "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(2) > div > div > div > a > div:nth-of-type(1)" });
    ...
    // Add Assertion for qty selector button(-)
    Assert.assertTrue(isElementAvailable(
      new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > form > button:nth-of-type(1)" }));
  ...
  @Test
  public void Purchase_in_virtual_store__invited_user_Gift_deliveryCOneEightzeroOneSevenNine() {
    javascriptExecution("lambda-name=Purchase in virtual store  invited user Gift deliveryCOneEightzeroOneSevenNine");
    ...
    clickOnElement(new String[] { CSS,
      "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(3) > div > div > div > div:nth-of-type(1) > div > a:nth-of-type(2)" });
  ...
  @Test
  public void Validate_defined_order_of_cards_in_MTOCFourFourOne() {
    javascriptExecution("lambda-name=Validate defined order of cards in MTOCFourFourOne");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-item item t1-Supported\']" }));
  ...
  @Test
  public void PE__ETwoE_Fixed_levels__Discount_coupon__Credid_cardCThreeSevenTwozerophaseTwo() {
    javascriptExecution("lambda-name=PE  ETwoE Fixed levels  Discount coupon  Credid cardCThreeSevenTwozerophaseTwo");
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
        ...
        takeScreenshot("logs/Screenshoots/duDrnz.png");
        // Go back to PDP
        goBack();
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/mkGVET.png");
      // add gift card
  ...
  @Test
  public void Validate_Cyzone_card_stylesCFourEightzero() {
    javascriptExecution("lambda-name=Validate Cyzone card stylesCFourEightzero");
  ...
  @Test
  public void Validate_card_in_supported_product_LbelCFourFiveFive() {
    javascriptExecution("lambda-name=Validate card in supported product LbelCFourFiveFive");
  ...
  @Test
  public void Validate_card_in_conditioned_EsikaCFourFiveSixCFourSixOne() {
    javascriptExecution("lambda-name=Validate card in conditioned EsikaCFourFiveSixCFourSixOne");
    ...
    // Click on Random product
    clickOnElement(
      new String[] { XPATH, "//div[@class=\'product__listing product__grid\']/child::div[12]/child::div[2]/child::a" });
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" }));
      // Add assertion for available promotion
      Assert.assertTrue(
      ...
      Assert.assertTrue(
        isElementClickable(new String[] { XPATH, "//div[@class=\'commercialCarousel-pdp-footer\']/child::a" }));
  ...
  @Test
  public void PE__ETwoE_Add_supported_from_carousel_in_PDP__credit_cardCThreeSevenFourNinephaseTwo() {
    javascriptExecution(
      "lambda-name=PE  ETwoE Add supported from carousel in PDP  credit cardCThreeSevenFourNinephaseTwo");
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//a[contains(text(),\'Ver productos\')]" })) {
        ...
        Assert.assertTrue(checkCurrentUrlContains("condition"));
        // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
        takeScreenshot("logs/Screenshoots/vITrpC.png");
        // Go back to PDP
        goBack();
        // wait until add to cart button clickeble
        waitUntil("CheckClickableElement", new String[] { XPATH, "//button[@id='addToCartButton']" }, "10", "disabled");
  ...
  @Test
  public void PE__ETwoE_apply_Discount_coupon__CCCFiveSevenNine__CThreeSevenFourFour() {
    javascriptExecution("lambda-name=PE  ETwoE apply Discount coupon  CCCFiveSevenNine  CThreeSevenFourFour");
  ...
  @Test
  public void Validate_link_See_combinationsCFourSixFourCFourSixzero() {
    javascriptExecution("lambda-name=Validate link See combinationsCFourSixFourCFourSixzero");
  ...
  @Test
  public void PurchaseInVirtualStoreGuestUserCreditCardCTwoNineNineSeven() {
    javascriptExecution("lambda-name=PurchaseInVirtualStoreGuestUserCreditCardCTwoNineNineSeven");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "main > div:nth-of-type(4) > div > div > div:nth-of-type(1)" }));

    status = "passed";
  }

  @Test
  public void SCENARIO__Purchase_in_virtual_store__Google_User__cash_internet_bankingCTwoSevenOneFour() {
    javascriptExecution(
      "lambda-name=SCENARIO  Purchase in virtual store  Google User  cash internet bankingCTwoSevenOneFour");
    ...
    // Click on Random Product
    clickOnElement(
      new String[] { XPATH, "(//div[@class=\'product__listing product__grid\']/child::div/child::div/child::a)[16]" });
    // Click on Add to cart
    clickOnElement(new String[] { XPATH, "//button[@id=\'addToCartButton\']" });
    // Click on Go Pay
    clickOnElement(new String[] { XPATH,
      "//div[@class=\'nav__right\']/../..//a[@class=\'btn btn-black btn-block add-to-cart-button\']" });
  ...
  @Test
  public void PE__ETwoE_with_Search_by_CUV_with_Account_Login_and_checkout_by_CCCFiveFourFour() {
    javascriptExecution("lambda-name=PE  ETwoE with Search by CUV with Account Login and checkout by CCCFiveFourFour");
  ...
  @Test
  public void Validate_modal__Choose_toneCFourEightSeven() {
    javascriptExecution("lambda-name=Validate modal  Choose toneCFourEightSeven");
    ...
    if (isElementAvailable(new String[] { ID, "selectVariable" })) {
      ...
      // Assertion on shade
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "(//div[@class=\"row variantItemModalContainer\"])[5]" }));
      // Click on input
      clickOnElement(new String[] { CSS,
    ...
    if (isElementAvailable(new String[] { ID, "selectVariable" })) {
      ...
      if (isElementAvailable(
        new String[] { XPATH, "//button[@id=\"yie-close-button-4cefd59f-96cb-5194-8b6b-121ed0fdd93a\"]" })) {
        // Handle popup
        clickOnElement(
          new String[] { XPATH, "//button[@id=\"yie-close-button-4cefd59f-96cb-5194-8b6b-121ed0fdd93a\"]" });
        // End of if loop
  ...
  @Test
  public void PE__ETwoE_Set_variable_conditional__supported__Free_Shipping__Agency_BankingCThreeSevenOnezero__PHASETwo() {
    javascriptExecution(
      "lambda-name=PE  ETwoE Set variable conditional  supported  Free Shipping  Agency BankingCThreeSevenOnezero  PHASETwo");
    ...
    if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver productos\"]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver combinaciones\"]" })) {
        ...
        // Add Assertion For Share Link
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "//span[@class=\'share-btn-icon shareBtnShare\']" }));
        // end if statement
      }
      // start else statement
      else {
  ...
  @Test
  public void SCENARIO_Five_Purchase_in_virtual_store_COD_CTwoSixSixNineCTwoSixSevenFour() {
  ...
  @Test
  public void Validate_card_in_Esika_supported_productCFourFiveFour() {
    javascriptExecution("lambda-name=Validate card in Esika supported productCFourFiveFour");
    ...
    if (checkContainsValue(new String[] { XPATH, "//div[@class=\"commercialCarousel-pdp-header\"]" },
      ...
      takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'shadow\']" },
        System.getProperty("user.dir") + "src/main/resources/files/actual_Image.png");
      compareImage(new File(System.getProperty("user.dir") + "src/main/resources/files/expected_Image.png"),
        new File(System.getProperty("user.dir") + "src/main/resources/files/actual_Image.png"));
      // Click on See products button
      clickOnElement(new String[] { XPATH, "//a[text() = \"Ver productos\"]" });
      // Add Assertion for Your search results
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//h1[text() = \"Los resultados de tu búsqueda:\"]" }));
      // end if statement
    }
    // start else staement
    else {
  ...
  @Test
  public void TV__Validations_in_the_modification_of_Personal_Data_functionalityCTwoSevenzeroThree() {
    javascriptExecution(
      "lambda-name=TV  Validations in the modification of Personal Data functionalityCTwoSevenzeroThree");
    ...
    clickOnElement(new String[] { XPATH,
      "//a[@class=\'myAccountLinksHeader collapsed js-myAccount-toggle\' and @data-parent=\'.nav__right\']" });
  ...
  @Test
  public void ALTERNATIVE_SCENARIO_Six_TV__Change_password_functionality_validationsCTwoSevenOneSeven() {
    javascriptExecution(
      "lambda-name=ALTERNATIVE SCENARIO Six TV  Change password functionality validationsCTwoSevenOneSeven");
    ...
    // Add Assertion for \"Please correct the errors below.\"
    Assert.assertTrue(isElementAvailable(
      new String[] { XPATH, "//span[text() = \"Por favor, corrija los errores a continuación.\"]" }));
    // Click on password
  ...
  @Test
  public void Validate_added_priceCFourFiveNine() {
    javascriptExecution("lambda-name=Validate added priceCFourFiveNine");
    ...
    Assert.assertTrue(isElementAvailable(new String[] { XPATH,
      "//div[@class=\'simple-price-container hidden-xs hidden-sm\']/child::span[@class=\'old-price\']" }));
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/jjqmMH.png");
    // Add Assertion for add to cart
    Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//button[@id=\"addToCartButton\"]" }));
    // Click on add to cart
    clickOnElement(new String[] { XPATH, "//button[@id=\"addToCartButton\"]" });
  ...
  @Test
  public void PE__ETwoE_with_Search_by_CUV_with_Account_Login_and_checkout_by_CC__CTwoNineFourThree() {
    javascriptExecution(
      "lambda-name=PE  ETwoE with Search by CUV with Account Login and checkout by CC  CTwoNineFourThree");
    ...
    typeText(new String[] { XPATH,
      "//div[@class=\'col-md-4 col-md-offset-4 text-center\']/../..//input[@id=\'js-site-search-input\']" }, "18567");
    // Click on search
    clickOnElement(new String[] { XPATH,
      "//div[@class=\'col-md-4 col-md-offset-4 text-center\']/../..//button[@class=\'btn js_search_button searchBoxButtonIconShort\']" });
    // if product present
    if (isElementAvailable(new String[] { XPATH, "//a[@id=\'product_thumb_200092361\']" })) {
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\'slick-slide slick-current slick-active\']" }));
      ...
      Assert.assertTrue(isElementClickable(
        new String[] { XPATH, "//div[@class=\'nav__left js-site-logo\']/../..//a[@href=\'/pe/cart\']" }));
      // Validate \"continue shopping\" button
      Assert.assertTrue(isElementClickable(new String[] { XPATH,
        "//div[@class=\'nav__left js-site-logo\']/../..//a[@class=\'continueShopping btn btn-just-border btn-block js-mini-cart-close-button\']" }));
      // click on \"go pay\" button
      clickOnElement(new String[] { XPATH, "//div[@class=\'nav__left js-site-logo\']/../..//a[@href=\'/pe/cart\']" });
      // Validate trash icon
      Assert.assertTrue(isElementAvailable(new String[] { CSS,
      ...
      Assert.assertTrue(isElementClickable(
        new String[] { XPATH, "//div[@class=\'actions\']/../..//button[@id=\'checkout-display-continueCheckout\']" }));
      ...
      takeScreenshot("logs/Screenshoots/QTzGCX.png");
  ...
  @Test
  public void Validate_link_See_combinationsCFourSixzeroCFourSixThree() {
    javascriptExecution("lambda-name=Validate link See combinationsCFourSixzeroCFourSixThree");
    ...
    if (isElementAvailable(new String[] { XPATH,
      "//div[@class=\'commercialCarousel-pdp-footer\']/child::a[text()=\'Ver combinaciones\']" })) {
      // Click on see combination
      clickOnElement(new String[] { XPATH,
        "//div[@class=\'commercialCarousel-pdp-footer\']/child::a[text()=\'Ver combinaciones\']" });
      // handle popup
  ...
  @Test
  public void Purchase_in_virtual_store___CTwoSixSixSeven() {
    javascriptExecution("lambda-name=Purchase in virtual store   CTwoSixSixSeven");
    ...
    // wait for rose
    waitUntil("CheckClickableElement",
      new String[] { XPATH, "//a[@class='spanTitle ecarousel_product_productName_200098633']" }, "10", "disabled");
    ...
    clickOnElement(new String[] { CSS,
      "div#StickySidebar > div > div:nth-of-type(3) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(1)" });
    ...
    // click on hair
    clickOnElement(
      new String[] { XPATH, "//div[@class=\'category_menu_item_principal nav__link\']/../..//a[@title=\'Cabello\']" });
    ...
    Assert.assertTrue(isElementAvailable(new String[] { CSS,
      "div#StickySidebar > div > div:nth-of-type(3) > div:nth-of-type(2) > div > div > div:nth-of-type(1) > div > span > span" }));
  ...
  @Test
  public void Compra_en_tienda_virtual_Usuario_Google_efectivo_CTwoSevenOneThree() {
    javascriptExecution("lambda-name=Compra en tienda virtual Usuario Google efectivo CTwoSevenOneThree");
    ...
    // Click on login
    clickOnElement(
      new String[] { CSS, "main > section:nth-of-type(1) > div > div > div:nth-of-type(1) > div > form > button" });
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/ufYMcY.png");
    // close consultant popup
    clickOnElement(new String[] { XPATH, "//button[@id=\'cboxClose\']" });
    ...
    // wait
    waitUntil("CheckClickableElement", new String[] { CSS, "button[type='submit'][form='belcorpAddressForm']" }, "20",
      "disabled");
    // Click On Address Submit Button
    clickOnElement(new String[] { CSS, "button[type=\"submit\"][form=\"belcorpAddressForm\"]" });
    // wait
    waitUntil("CheckVisibleElement", new String[] { CSS, "label[for='belcorpNewCheckoutPaymentMode_mpago_cash']" },
      "10", "disabled");
    // Checkout Using
    // Wait untill agency banking
    waitUntil("CheckClickableElement", new String[] { CSS, "label[for='belcorpNewCheckoutPaymentMode_mpago_cash']" },
  ...
  @Test
  public void Purchase_in_virtual_store__cash_agents_and_agencies_CTwoSixSevenTwo() {
    javascriptExecution("lambda-name=Purchase in virtual store  cash agents and agencies CTwoSixSevenTwo");
  ...
  @Test
  public void PE__ETwoE_Access_from_the_brands__categories_landing__guest_user_and_checkout_Agency__BankingCFiveFiveFive() {
    javascriptExecution(
      "lambda-name=PE  ETwoE Access from the brands  categories landing  guest user and checkout Agency  BankingCFiveFiveFive");
  ...
  @Test
  public void PE__ETwoE_create_account__Tiered_Discount__CCCThreeSevenThreeNine() {
    javascriptExecution("lambda-name=PE  ETwoE create account  Tiered Discount  CCCThreeSevenThreeNine");
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
        ...
        // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
        takeScreenshot("logs/Screenshoots/ihBIgP.png");
        // Go back to PDP
        goBack();
        // wait until add to cart button clickeble
        waitUntil("CheckClickableElement", new String[] { XPATH, "//button[@id='addToCartButton']" }, "10", "disabled");
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/FsuiGn.png");
  ...
  @Test
  public void Validate_consulting_mail_by_request_of_your_consumerCFourNineThree() {
    javascriptExecution("lambda-name=Validate consulting mail by request of your consumerCFourNineThree");
  ...
  @Test
  public void PurchaseInVirtualStoreGuestUserCreditCardCTwoSixSixTwoCTwoSixSixSixCTwoSixSevenOneCTwoSixSevenSevenCTwoSixEightOne() {
    javascriptExecution(
      "lambda-name=PurchaseInVirtualStoreGuestUserCreditCardCTwoSixSixTwoCTwoSixSixSixCTwoSixSevenOneCTwoSixSevenSevenCTwoSixEightOne");
    ...
    // Click on cbox
    clickOnElement(new String[] { CSS,
      "header > nav:nth-of-type(1) > div > div > div:nth-of-type(2) > div > ul > li:nth-of-type(2) > div > div > div > div:nth-of-type(2)" });
    // Add Assertion for Rose D’Amelie P...
    Assert.assertTrue(isElementAvailable(
      new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2)" }));
    // Click on add to cart
    clickOnElement(new String[] { XPATH, "//button[@id=\'addToCartButton\']" });
    // Click on go pay
    clickOnElement(new String[] { XPATH, "//div[@class=\'nav__left js-site-logo\']/../..//a[@href=\'/pe/cart\']" });
  ...
  @Test
  public void Validate_card_in_Lbel_levelsCFourSixSix() {
    javascriptExecution("lambda-name=Validate card in Lbel levelsCFourSixSix");
  ...
  @Test
  public void Validate_consulting_mail_by_request_of_your_consumerCFourNineFour() {
    javascriptExecution("lambda-name=Validate consulting mail by request of your consumerCFourNineFour");
  ...
  @Test
  public void Validate_modal_See_detailCFourEightSix() {
    javascriptExecution("lambda-name=Validate modal See detailCFourEightSix");
  ...
  @Test
  public void Validate_customer_email_order_reservationCFourNineTwo() {
    javascriptExecution("lambda-name=Validate customer email order reservationCFourNineTwo");
  ...
  @Test
  public void Validate_card_in_cyzone_levelsCFourSixSeven() {
    javascriptExecution("lambda-name=Validate card in cyzone levelsCFourSixSeven");
  ...
  @Test
  public void PE__ETwoE_create_account__Tiered_Discount__CCCFiveFiveNine() {
    javascriptExecution("lambda-name=PE  ETwoE create account  Tiered Discount  CCCFiveFiveNine");
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
        ...
        Assert.assertTrue(checkCurrentUrlContains("isConditionOf"));
        // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
        takeScreenshot("logs/Screenshoots/RSYCbx.png");
        // Go back to PDP
        goBack();
        // wait until add to cart button clickeble
        waitUntil("CheckClickableElement", new String[] { XPATH, "//button[@id='addToCartButton']" }, "10", "disabled");
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]" }));
      // take a snip to validate product title /CUV/stock
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/bjMeHO.png");
      // add assertion for eliminate link
      Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.item__remove-action > div#actionEntry_0 > a" }));
      // start if statement for tiered discount
      if (isElementAvailable(new String[] { XPATH, "//span[@class=\"cart-entry-message\"]" })) {
       /* // change the qty of product
        ...
        updateValueOfElementViaJS(new String[] { XPATH, "//div[@class=\"item__quantity hidden-xs hidden-sm\"]//input[@id=\"quantity_0\"]" },
                "2");
        // click on enter key
    ...
    // wait until address submit
    waitUntil("CheckClickableElement", new String[] { CSS, "button#addressSubmit" }, "20", "disabled");
    // click on address submit button
    clickOnElement(new String[] { CSS, "button#addressSubmit" });
    // Click On Credit Card Section
    javascriptExecution(
  ...
  @Test
  public void Validate_recommended_bundle_added_to_cartCFourEightEight() {
    javascriptExecution("lambda-name=Validate recommended bundle added to cartCFourEightEight");
  ...
  @Test
  public void Validate_eCommerce_displayCFourFourTwo() {
    javascriptExecution("lambda-name=Validate eCommerce displayCFourFourTwo");
  ...
  @Test
  public void Validate_card_in_conditioned_LbelCFourSixTwoCFourFiveSeven() {
    javascriptExecution("lambda-name=Validate card in conditioned LbelCFourSixTwoCFourFiveSeven");
  ...
  @Test
  public void PE__ETwoE_apply_Discount_coupon__CCCFiveSixFour__CThreeSevenFourFour() {
    javascriptExecution("lambda-name=PE  ETwoE apply Discount coupon  CCCFiveSixFour  CThreeSevenFourFour");
  ...
  @Test
  public void Validate_card_in_esika_levelsCFourSixFive() {
    javascriptExecution("lambda-name=Validate card in esika levelsCFourSixFive");
  ...
  @Test
  public void Validations_in_Remember_password_functionality__CTwoSevenOneEight() {
    javascriptExecution("lambda-name=Validations in Remember password functionality  CTwoSevenOneEight");
