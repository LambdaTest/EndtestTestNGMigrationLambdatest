...
public class Regression_Colombia_MTO extends WebDriverHelper {
  ...
  @Test
  public void SCENARIO__Purchase_in_virtual_store__COD_CC() {
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div > div.checkout-success__body__headline.cash-on-delivery"}));
  ...
  @Test
  public void Validate_that_the_product_name_is_displayed_as_it_is_from_MDM__CyzoneC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//a[@class=\'name\'])[1]"}));
  ...
  @Test
  public void CO__EE_create_account__Tiered_Discount__CCC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div[class=\"checkout-success__body__headline\"]"}));
  ...
  @Test
  public void CO__EE_apply_Discount_coupon__CCC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
typeText(new String[] { CSS, "input[class=\"js-voucher-code cart-voucher__input form-control input-sm\"]" }, "BIENVENIDO20");
// Click on Apply Button
...
// End Else statement
  ...
  @Test
  public void CO__EE_Access_from_the_brand_guest_user_and_checkout__C() {
...
clickOnElement( new String[] {CSS, "a[class=\"name\"][href=\"/co/ligne-experte-shampoo-ultra-nutritif/p/200059969\"]"});
// Add assertion for \"ligne experte img1\"
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > ul > div > div > div:nth-of-type(1) > div > li > a > img"}));
// Add assertion for \"ligne experte img2\"
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > ul > div > div > div:nth-of-type(2) > div > li > a > img"}));
// Add assertion for \"ligne experte img3\"
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(2) > div:nth-of-type(1) > ul > div > div > div:nth-of-type(3) > div > li > a > img"}));
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "main > div:nth-of-type(3) > div:nth-of-type(1) > div > div:nth-of-type(3) > div:nth-of-type(4) > div > div > div:nth-of-type(2) > div > input"}));
// Add assertion for \"share link\"
...
clickOnElement( new String[] {CSS, "main > section:nth-of-type(1) > div:nth-of-type(2) > div > div:nth-of-type(2) > div > div:nth-of-type(5) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"});
// Login as guest user
// Write text in guest firstName text field
typeText(new String[] { ID, "guest.firstName" }, "photon");
// Write text in guest lastName text field
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div[class=\"well-headline orderPending\"]"}));
  ...
  @Test
  public void CO__EE_Access_from_the_brands__categories_landing__guest_user_and_checkout_Agency__BankingC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end else statement
  ...
  @Test
  public void CO__EE_Add_supported_from_carousel_in_PDP__Free_Sample_C() {
// Clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if add to cart clickable
  ...
  @Test
  public void CO__EE_Add_supported_from_link__Free_Shipping__Agency_BankingC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End else Statement
  ...
  @Test
  public void CO__EE_Add_supported_from_link__Free_Shipping__Agency_C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End Else statement
  ...
  @Test
  public void COEE_create_account__Tiered_Discount__CCC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end else statement
  ...
  @Test
  public void CO_EE_apply_Discount__CC_couponC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div[class=\"well-headline orderPending\"]"}));
  ...
  @Test
  public void COEE_apply_Discount_coupon__CCC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
