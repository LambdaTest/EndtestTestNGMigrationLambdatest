...
public class Regression_Colombia_MTO extends WebDriverHelper {
  ...
  public void CO__ETwoE_Add_supported_from_carousel_in_PDP__Free_Sample_COneSevenFiveSixSixThree() {
    ...
    Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//a[contains(text(),\'Seguir Comprando\')]" }));
    // assertion on \"Go Pay\"
    ...
    if (isElementAvailable(new String[] { XPATH, "//div[@class=\'owl-wrapper-outer autoHeight\']" })) {
    ...
    // start else
      ...
      // Print Result
      printResults("PrintNote", "\"go pay button in cart page is not present\"");
      // end else statement
    }
    ...
    // start else
      ...
      // Print Result
      printResults("PrintNote", "\"confirmation page is not displayed\"");
      // end else statement
    }
  ...
  @Test
  public void CO__ETwoE_Add_supported_from_link__Free_Shipping__Agency_BankingCThreeSixNineEight() {
    javascriptExecution(
      "lambda-name=CO  ETwoE Add supported from link  Free Shipping  Agency BankingCThreeSixNineEight");
    ...
    if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver productos\"]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//button[@class=\'variantSelectorButton \']" })) {
        ...
        javascriptExecution(
          "document.querySelector(\"div#cboxLoadedContent div.col-xs-8.col-md-8.applyButton \").click();");
        // End If statement
      }
      // Start Else
      else {
  ...
  @Test
  public void COETwoE_create_account__Tiered_Discount__CCCFiveFiveEight() {
    ...
    // Click on enter key
    pressKey(new String[] { XPATH, "//input[@class=\'form-control js-qty-selector-input\']" }, "ENTER");
    // Click on add to cart button
    clickOnElement(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" });
    // Click on go pay button
    // explicit wait for Go Pay Button
    ...
    if (isElementAvailable(new String[] { XPATH, "//div[@class=\'col-xs-6 cart-totals-left discount\']" })) {
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//div[@class=\'col-xs-6 cart-totals-left discount\']" }));
      // End If Statement
    }
    // Start Else Statement
    else {
  ...
  @Test
  public void COETwoE_apply_Discount_coupon__CCCThreeSevenOneSix() {
    ...
    // start else
      ...
      // Print Result
      printResults("PrintNote", "\"checkout success message is not coming\"");
      // end else statement
    }
  ...
  @Test
  public void CO__ETwoE_apply_Discount_coupon__CCCFiveSixThree() {
  ...
  @Test
  public void Validate_that_the_product_name_is_displayed_as_it_is_from_MDM__CyzoneCOneSevenFiveNineFourSeven() {
    javascriptExecution(
      "lambda-name=Validate that the product name is displayed as it is from MDM  CyzoneCOneSevenFiveNineFourSeven");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//div[@class=\'product-name-sticky product-name-sticky-cyzone\']" }));
    // Click on Add to cart button
    clickOnElement(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" });
  ...
  @Test
  public void CO_ETwoE_apply_Discount__CC_couponCFiveSixThree() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//span[text()=\'Cupón aplicado exitosamente\']" })) {
      ...
      Assert.assertTrue(getText(new String[] { XPATH, "//span[text()=\'Cupón aplicado exitosamente\']" }).contains(
  ...
  @Test
  public void CO__ETwoE_create_account__Tiered_Discount__CCCThreeSevenThreeEight() {
  ...
  @Test
  public void CO__ETwoE_Access_from_the_brands__categories_landing__guest_user_and_checkout_Agency__BankingCTwoNineFiveFour() {
    javascriptExecution(
      "lambda-name=CO  ETwoE Access from the brands  categories landing  guest user and checkout Agency  BankingCTwoNineFiveFour");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { XPATH, "//div[@class=\'col-xs-12 col-sm-8 col-md-9 relative\']" }));
    // Add Assertion For Product name
  ...
  @Test
  public void SCENARIO_Five_Purchase_in_virtual_store__COD_CTwoSixSixNineCTwoSixSevenFour() {
    ...
    // start else
      ...
      // Print Result
      printResults("PrintNote", "\"suggestion not coming\"");
      // end else statement
    }
    // scroll to bottom
    scroll("ScrollBottom");
    ...
    Assert.assertTrue(
      isElementFound(new String[] { CSS, "div > div.checkout-success__body__headline.cash-on-delivery" }));
