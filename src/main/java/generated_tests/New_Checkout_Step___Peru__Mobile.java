...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/Uthwpg.png");
...
takeScreenshotOfParticularElement(new String[] { CSS, "div.consultant-header-cart.visible-xs.multi-checkout-consultantHeader" },"logs/Screenshots/sOlIWS.png");
// wait
...
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/gnlyZF.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/JoiCki.png");
// start if statement
...
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "100","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/BSxjXm.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "form#mpago_card_saved div.payment-installments-outer > div"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/dMfrcY.png");
...
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/VBwKgB.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/uopwvf.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/PjOxKx.png");
// take a snip to verify the delivery time and shipping cost
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"delivery_method\"]" },"logs/Screenshots/jNnSDP.png");
...
// take a snip to verify the delivery time and shipping cost
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"delivery_method\"]" },"logs/Screenshots/JkZomJ.png");
...
waitUntil("CheckVisibleElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "10","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/mFehPD.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "(//form[@id='mpago_card_saved']/div)[1]"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/ABbNlc.png");
...
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "100","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/gYWAHm.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "form#mpago_card_saved div.payment-installments-outer > div"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/jINUOX.png");
// start if statement for To divide the payment into installments, you must coordinate it directly with your bank.
if (isElementAvailable(new String[] { CSS, "form#mpago_card_saved div.payment-installments-outer > div"})){
// add assertion for To divide the payment into installments, you must coordinate it directly with your bank.
Assert.assertTrue(getText(new String[] { CSS, "form#mpago_card_saved div.payment-installments-outer > div" }).contains("Para dividir el pago en cuotas deberás coordinarlo directamente con tu banco."));
...
takeScreenshot("logs/Screenshoots/vqVFdj.png");
// Click on credit card
clickOnElement( new String[] {XPATH, "//label[@for=\'belcorpNewCheckoutPaymentMode_mpago_credit\']"});
// Wrire text in name of owner
typeText(new String[] { XPATH, "(//input[@id=\'cardholderName\'])[1]" }, "APRO");
...
takeScreenshot("logs/Screenshoots/wpvFyS.png");
// end if statement
}
...
typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
// take a snip to verify the adress is accepting character
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/puCuEq.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/eWSOwi.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/JsmNHd.png");
// select option from province
selectOption(new String[] { XPATH, "//select[@id=\"address.regionIsoParent1\"]" }, "18-HUANTA");
// take a snip to verify filling lvl1 and 2 enables lvl 3
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/tHJHsN.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/QplrlA.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/lViyDF.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//section[@class=\"account-section\"]" },"logs/Screenshots/NVsLie.png");
...
typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
// take a snip to verify the adress is accepting character
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/CGxAjG.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/sDIjUQ.png");
...
");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/eaHreh.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/ovHDRV.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/iajout.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/PJyxjg.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'checkout-order-summary\'])[1]" },"logs/Screenshots/ApJqWe.png");
// end if statement
}
// else statement
else{
