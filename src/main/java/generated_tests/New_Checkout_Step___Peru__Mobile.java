...
public class New_Checkout_Step___Peru__Mobile extends WebDriverHelper {

 
  @Test
  public void Verify_the_payment_method_CashC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_cash.radiompago_cashPE > label"});
...
clickOnElement( new String[] {CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_cash.radiompago_cashPE > label"});
// add assertion for cash payment
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#mpago_mpago_pagoefectivo_atm_pe > div.payment-method-container"}));

    status = "passed"; 
   }
  @Test
  public void Verify_behavior_of_old_CheckoutC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
javascriptExecution("document.querySelector(\"div#mpagoDebitCardDiv a#add-new-card\").click();");
// wait until debit card text field
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "100","disabled");
// write text in card name
typeText(new String[] { CSS, "form#mpago_debit input#cardholderName" }, "APRO");
// write text in card number
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
// wait
waitUntil("CheckVisibleElement", new String[]{XPATH, "//button[@class='btn btn-magenta btn-block checkout-next']"}, "20","disabled");
...
// wait until submit button clickeble
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[@class='btn btn-block submit_mpagoCardSavedForm checkout-next']"}, "10","disabled");
// Click on Continue
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
// Select credit card option
waitUntil("CheckVisibleElement", new String[]{XPATH, "//button[@class='btn btn-magenta btn-block checkout-next']"}, "30","disabled");
// Select credit card option
clickOnElement( new String[] {XPATH, "//label[@for=\"belcorpNewCheckoutPaymentMode_mpago_credit\"]"});
// write cvv
typeText(new String[] { XPATH, "(//input[@name=\"securityCodeCardSaved\"])[1]" }, "123");
...
// wait until submit button
waitUntil("CheckClickableElement", new String[]{XPATH, "(//button[@class='btn btn-block submit_mpagoCardSavedForm checkout-next'])[1]"}, "10","disabled");
// click on submit button
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-block submit_mpagoCardSavedForm checkout-next\"])[1]"});
// start if statement for sucess message
if (isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success\"]"})){
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/hpzqjB.png");

    status = "passed"; 
   }
  @Test
  public void Verify_criteria_in_Payment_Rejected_in_new_checkoutC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div#cboxLoadedContent div > span" }).contains("Recuerda que tu tarjeta debe estar autorizada para hacer pagos por internet. Contacta a tu banco"));
// end if statement
}
// start else statement
else{
...
// end else statement
  ...
  @Test
  public void Verify_criteria_in_Rejected_Payment_in_new_checkoutC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementDisplayed(new String[] { CSS, "form#mpago_debit div.action-fixed-bottom > div > button"}));
// Click on Pay Button
clickOnElement( new String[] {CSS, "form#mpago_debit div.action-fixed-bottom > div > button"});
...
javascriptExecution("document.querySelector(\"input#Terms1_mpagoDebitCardForm\").click();");
// Add Assertion For Pay Button
Assert.assertTrue(isElementClickable(new String[] { CSS, "form#mpago_debit div.action-fixed-bottom > div > button"}));
// Click On Pay Button
clickOnElement( new String[] {CSS, "form#mpago_debit div.action-fixed-bottom > div > button"});
// start if statement
...
javascriptExecution("
document.querySelector(\"button#cboxClose\").click();");
// end if statement
}
// start else statement
else{
...
// end else statement
  ...
  @Test
  public void Desktop_and_Mobile__Validate_that_the_banner_for_mto_is_displayedC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[contains(text(),\'Continuar como invitado\')]"});
// wait
waitUntil("CheckVisibleElement", new String[]{CSS, "div.consultant-header-cart.visible-xs.multi-checkout-consultantHeader"}, "10","disabled");
// assert for user email
Assert.assertTrue(getText(new String[] { CSS, "div.consultant-header-cart.visible-xs.multi-checkout-consultantHeader" }).contains("Estás en la tienda online de:"));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { CSS, "div.consultant-header-cart.visible-xs.multi-checkout-consultantHeader" },"logs/Screenshots/ybgGUY.png");
// wait
waitUntil("CheckVisibleElement", new String[]{CSS, "div.multiSteps-widget.help-message-wrapper.hidden-md.hidden-lg > div.mt-12.helpMessage > div"}, "10","disabled");
// Add assertion for help email
Assert.assertTrue(isElementDisplayed(new String[] { CSS, "div.multiSteps-widget.help-message-wrapper.hidden-md.hidden-lg > div.mt-12.helpMessage > div"}));

    status = "passed"; 
   }
  @Test
  public void Verify_the_type_of_cash_payment_Agents_and_agenciesC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div#mpago_mpago_pagoefectivo_atm_pe div.js-payment-option.js-payment-option-1 > div.alert.alert-info.cash-method-alert" }).contains("Para esta opción se debe realizar el pago en los próximos 60 minutos. Luego de ese tiempo será cancelado."));
...
clickOnElement( new String[] {CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_cash.radiompago_cashPE > label"});
// add assertion for banner
Assert.assertTrue(getText(new String[] { CSS, "div#mpago_mpago_pagoefectivo_atm_pe div.js-payment-option.js-payment-option-1 > div.alert.alert-info.cash-method-alert" }).contains("Para esta opción se debe realizar el pago en los próximos 180 minutos. Luego de ese tiempo será cancelado."));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//ol[@class=\"bullet-list list-margin\"]"}));
  ...
  @Test
  public void Verify_layout_Step__Payment_with_TJ_Credit__New_CheckoutC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/qniRAq.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/JmOzhm.png");
// start if statement
...
Assert.assertTrue(getText(new String[] { CSS, "form#mpago_card_saved div.payment-installments-outer > div" }).contains("Para dividir el pago en cuotas deberás coordinarlo directamente con tu banco."));
// end if statement
}
// start else statemnet
else{
// print in result
printResults("PrintNote", "\"To divide the payment into installments, you must coordinate it directly with your bank. not present\"");
// end else statement
}
// Clear cache cookies
// Clear cookies
...
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "100","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/rpRrdQ.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "form#mpago_card_saved div.payment-installments-outer > div"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/VOuElU.png");
...
// print in result
printResults("PrintNote", "\"To divide the payment into installments, you must coordinate it directly with your bank. is not present\"");
// end else statement
}
  ...
  @Test
  public void Verify_criteria_in_Payment_Rejected__in_new_checkoutC() {
...
// Click on \"I accept terms and conditions\"
javascriptExecution("document.querySelector(\"input[id=\'agreeToReceiveWhatsappNotificationsCheck_mpagoCreditCardForm\']\").click();");
// Wait
waitForTime(5);
// Start If Statement
if (isElementClickable(new String[] { XPATH, "(//button[@class=\'btn btn-block submit_mpagoForm checkout-next\'])[1]"})){
// click on  pay button
...
// Validate pay button
Assert.assertFalse(isElementClickable(new String[] { XPATH, "(//button[@class=\'btn btn-block submit_mpagoForm checkout-next\'])[1]"}));
// Validate another payment method
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//label[@for=\'belcorpNewCheckoutPaymentMode_mpago_debit\']"}));
...
Assert.assertTrue(checkCurrentUrlContains( "checkout"));
  ...
  @Test
  public void Filter_COD_delivery_method_on_new_checkout_groupC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'cuidado personal\')]"});
// wait
waitUntil("CheckVisibleElement", new String[]{CSS, "div:nth-child(4) > div.inner-card > div.product-item-info > div.details > a"}, "5","disabled");
// Click on second   product
javascriptExecution("document.querySelector(\"div:nth-child(4) > div.inner-card > div.product-item-info > div.details > a\").click();");
// wait
waitForTime(5);
...
clickOnElement( new String[] {XPATH, "//button[@id=\"checkout-display-continueCheckout\"]"});
// wait untill chekout
waitUntil("CheckVisibleElement", new String[]{XPATH, "//div[@class='headerRegisterUser']/span"}, "20","disabled");
// assert for user email
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/YwtSvW.png");
// click on add new address
javascriptExecution("document.querySelector(\"a#checkout-add-new-address\").click();");
// wait until adress dropdowns
waitUntil("CheckClickableElement", new String[]{XPATH, "//select[@id='address.regionIsoParent2']"}, "10","disabled");
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
// wait untill COD
waitUntil("CheckClickableElement", new String[]{XPATH, "//label[@for='belcorpNewCheckoutPaymentMode_belc_cash_delivery']"}, "10","disabled");
// start if statement
if (isElementClickable(new String[] { XPATH, "//label[@for=\"belcorpNewCheckoutPaymentMode_belc_cash_delivery\"]"})){
// click on cash on delivery
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiobelc_cash_delivery.radiobelc_cash_deliveryPE > label\").click();");
// click on cash on delivery checkbox
javascriptExecution("document.querySelector(\"input#Terms1_cashOnDeliveryForm\").click();");
// wait until submit button clickeble
waitUntil("CheckEnabledElement", new String[]{CSS, "form#cashOnDeliveryForm button[type='button']"}, "10","disabled");
// click on submit
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/dDoHfY.png");

    status = "passed"; 
   }
  @Test
  public void Validate_that_the_banner_must_appear_in_each_step_as_part_of_the_headerC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Dpto. / Int / Piso / Edificio (Opcional)\"]"});
// Write text in address.line2
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Dpto. / Int / Piso / Edificio (Opcional)\"]" }, "bcd");
// Click on address.referen...
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Referencia (Opcional)\"]"});
// Write text in address.referen...
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Referencia (Opcional)\"]" }, "cde");
// Click on address.phone
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Teléfono de contacto*\"]"});
// Write text in address.phone
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Teléfono de contacto*\"]" }, "12345678");
// Click on Continue
...
// End of if loop
  ...
  @Test
  public void Validate_that_the_banner_is_displayed_above_the_text_Payment_methodC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Dpto. / Int / Piso / Edificio (Opcional)\"]"});
// Write text in address.line2
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Dpto. / Int / Piso / Edificio (Opcional)\"]" }, "b");
// Click on address.referen...
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Referencia (Opcional)\"]"});
// Write text in address.referen...
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Referencia (Opcional)\"]" }, "c");
// Click on address.phone
clickOnElement( new String[] {CSS, "input[class=\"form-control form-control\"][placeholder=\"Teléfono de contacto*\"]"});
// Write text in address.phone
typeText(new String[] { CSS, "input[class=\"form-control form-control\"][placeholder=\"Teléfono de contacto*\"]" }, "12345667");
// Click on Continue
clickOnElement( new String[] {CSS, "button[type=\"submit\"][form=\"belcorpAddressForm\"]"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[@class=\"info\"]"}));
  ...
  @Test
  public void Verify_behavior_in_Billing_Address_for_TJ_CreditC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
javascriptExecution("document.querySelector(\"form#mpago_credit div.address-selector.billing-address-selector > div:nth-child(2) > label\").click();");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\"address\"])[1]"}));
  ...
  @Test
  public void Check_the_shipping_cost_and_delivery_time_criteriaC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/rkWFrc.png");
// take a snip to verify the delivery time and shipping cost
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"delivery_method\"]" },"logs/Screenshots/sYvTpD.png");
...
// take a snip to verify the delivery time and shipping cost
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"delivery_method\"]" },"logs/Screenshots/PgyqoA.png");
...
clickOnElement( new String[] {CSS, "button[id=\"checkout-display-continueCheckout\"][class=\"checkout-display-continueCheckout btn btn-magenta btn-block btn--continue-checkout js-continue-checkout-button\"]"});
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[@class=\'title shipping-address-title\'])[3]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'total\'])[1]"}));
  ...
  @Test
  public void Check_criteria_of_selected_TJC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
waitUntil("CheckVisibleElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "10","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/PqVdsE.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "(//form[@id='mpago_card_saved']/div)[1]"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/MHWOmD.png");
...
// print in result
printResults("PrintNote", "\"To divide the payment into installments, you must coordinate it directly with your bank. not found\"");
// end else statement
}
// Clear cache cookies
// Clear cookies
...
waitUntil("CheckClickableElement", new String[]{CSS, "form#mpago_debit input#cardholderName"}, "100","disabled");
// take a snip to verify debit card radio button is pre selected
takeScreenshotOfParticularElement(new String[] { CSS, "div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_debit.radiompago_debitPE" },"logs/Screenshots/MKOGqZ.png");
// click on credit card
javascriptExecution("document.querySelector(\"div#belcorpNewCheckoutPaymentModeSelector div.paymentMethod-radio.radiompago_credit.radiompago_creditPE > label\").click();");
// wait until page loads saved cards
waitUntil("CheckVisibleElement", new String[]{XPATH, "form#mpago_card_saved div.payment-installments-outer > div"}, "10","disabled");
// take a snip to verify The order of the cards
takeScreenshotOfParticularElement(new String[] { XPATH, "(//form[@id=\"mpago_card_saved\"]/div)[1]" },"logs/Screenshots/ISSSpt.png");
// start if statement for To divide the payment into installments, you must coordinate it directly with your bank.
if (isElementAvailable(new String[] { CSS, "form#mpago_card_saved div.payment-installments-outer > div"})){
// add assertion for To divide the payment into installments, you must coordinate it directly with your bank.
Assert.assertTrue(getText(new String[] { CSS, "form#mpago_card_saved div.payment-installments-outer > div" }).contains("Para dividir el pago en cuotas deberás coordinarlo directamente con tu banco."));
...
// Add Assertion For pay Button
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@class=\"btn btn-block submit_mpagoCardSavedForm checkout-next\"]"}));
// Click on pay button
clickOnElement( new String[] {XPATH, "//button[@class=\"btn btn-block submit_mpagoCardSavedForm checkout-next\"]"});
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
// Enter cvv
typeText(new String[] { CSS, "form#mpago_card_saved div:nth-child(1) > div > div.card-saved-cvv-content-container > div > div.form-group > div.tooltip-group > input[name=\"securityCodeCardSaved\"]" }, "123");
// click on checkbox
javascriptExecution("document.querySelector(\"#Terms1_MPagoCardSavedForm_mpago_debmaster\").click();");
// Add Assertion For Pay Button
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@class=\"btn btn-block submit_mpagoCardSavedForm checkout-next\"]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-success__body__headline\']"}));
  ...
  @Test
  public void Verify_criteria_in_Payment_Approved__in_new_checkoutC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertFalse(getText(new String[] { XPATH, "(//input[@placeholder=\'Número de la tarjeta*\'])[1]" }).contains("5031755734530604"));
// Validate mandatory fields are empty
takeScreenshot("logs/Screenshoots/lHvosO.png");
// Click on credit card
clickOnElement( new String[] {XPATH, "//label[@for=\'belcorpNewCheckoutPaymentMode_mpago_credit\']"});
// Wrire text in name of owner
typeText(new String[] { XPATH, "(//input[@id=\'cardholderName\'])[1]" }, "APRO");
...
javascriptExecution("document.querySelector(\"input[id=\'agreeToReceiveWhatsappNotificationsCheck_mpagoCreditCardForm\']\").click();");
// Add Assertion for pay button
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//button[@class=\"btn btn-block submit_mpagoForm checkout-next\"])[1]"}));
// click on  pay button
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-block submit_mpagoForm checkout-next\"])[1]"});
// end of if
}
...
takeScreenshot("logs/Screenshoots/xcUYeu.png");
// end if statement
}
...
typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
// take a snip to verify the adress is accepting character
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/kfBPuI.png");

    status = "passed"; 
   }
  @Test
  public void Verify_behavior_of_old_Checkout_C() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div > div.checkout-success" }).contains("Tu transacción está pendiente"));
// End of If Loop
}
// End Else Statement
}
...
// End Else Statement
  ...
  @Test
  public void Verify_the_criteria_as_a_Recurring_RegistrarC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
  ...
  @Test
  public void HYBRISV__PEDelivery_InformationGuestReturn_from_StepTwo() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/uMTVCw.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/HsuFDH.png");
// select option from province
selectOption(new String[] { XPATH, "//select[@id=\"address.regionIsoParent1\"]" }, "18-HUANTA");
// take a snip to verify filling lvl1 and 2 enables lvl 3
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/zNvexf.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/veMudr.png");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//select[@id=\"address.regionIso\"]"}));
  ...
  @Test
  public void Verify_type_of_cash_payment_Internet_banking_and_mobile_bankingC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"headerRegisterUser\"]/span"}));
// take a snip to verify shipping address stored
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\'deliveryAddressesSelector\']" },"logs/Screenshots/HJyCKP.png");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//section[@class=\"account-section\"]" },"logs/Screenshots/ZMvpno.png");

    status = "passed"; 
   }
  @Test
  public void Validate_that_the_banner_for_ecom_was_displayedC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementDisplayed(new String[] { CSS, "div.multiSteps-widget.help-message-wrapper.hidden-md.hidden-lg > div.mt-12.helpMessage > div"}));
  ...
  @Test
  public void Check_layout__Billing_Address_for_TJ_Credit_C() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@id=\"billingAddressForm\"])[1]"}));
  ...
  @Test
  public void Check_layout_Billing_Address__for_TJ_Debit__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[@id=\"checkout-display-continueCheckout\"]"});
// wait
waitUntil("CheckVisibleElement", new String[]{CSS, "div#deliveryAddressesSelector div:nth-child(3) > label"}, "20","disabled");
// start if statement
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//label[@for=\'mpagoUseDeliveryAddress_on_debitSaved\']"}));
// Add assertion for other directions
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//label[@for=\'mpagoUseDeliveryAddress_off_debitSaved\']"}));
...
typeText(new String[] { XPATH, "//input[@id=\"address.line1\"]" }, "ÁÉÍÓÚáéíóúüÜ");
// take a snip to verify the adress is accepting character
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/DfwvQf.png");

    status = "passed"; 
   }
  @Test
  public void Check_card_criteriaC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End Else Statement
  ...
  @Test
  public void Verify_criteria_in_Pending_Payment_in_new_checkoutC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
waitUntil("CheckClickableElement", new String[]{XPATH, "(//button[@class='btn btn-block submit_mpagoForm checkout-next'])[1]"}, "10","ten");
// click on  pay button
clickOnElement( new String[] {XPATH, "(//button[@class=\'btn btn-block submit_mpagoForm checkout-next\'])[1]"});
// Start If Statement
if (checkCurrentUrlContains("orderConfirmation")) {
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@id=\"i18nAddressForm\"]" },"logs/Screenshots/JUfVlW.png");

    status = "passed"; 
   }
  @Test
  public void Verify_criteria_in_Payment_Approved_in_new_checkoutC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
javascriptExecution("document.querySelector(\"div#main_inbox_area div:nth-child(1) > div > div.block-subject.w-100 > a\").click();");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/FdtusJ.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
javascriptExecution("document.querySelector(\"div#main_inbox_area div:nth-child(1) > div > div.block-subject.w-100 > a\").click();");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/pEqayc.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-black btn-block js-enable-btn js-add-to-cart\"])[1]"});
// Click on keep buying
clickOnElement( new String[] {XPATH, "//li//div//div//div[@class=\'nav-cart\']//div//div[@class=\'add-to-cart add-to-cart-cross\']//a[contains(text(),\'     Seguir Comprando\')]"});
// Add 2nd product to cart
clickOnElement( new String[] {XPATH, "(//button[@class=\"btn btn-black btn-block js-enable-btn js-add-to-cart\"])[2]"});
// Click on go pay
...
typeText(new String[] { XPATH, "(//input[@class=\"form-control input--card-number not-empty\"])[2]" }, "5178781622202455");
// Select expiry month
selectOption(new String[] { XPATH, "(//select[@id=\"expirationMonth\"])[2]" }, "11");
// Select expiry year
selectOption(new String[] { XPATH, "(//select[@id=\"expirationYear\"])[2]" }, "2025");
...
javascriptExecution("document.querySelector(\"div#main_inbox_area div:nth-child(1) > div > div.block-subject.w-100 > a\").click();");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/NFWnoh.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
javascriptExecution("document.querySelector(\"div#main_inbox_area div:nth-child(1) > div > div.block-subject.w-100 > a\").click();");
// take a screen shot for mail validation
takeScreenshot("logs/Screenshoots/pOhXxs.png");
// end if statement
}
// switch back to initial tab
switchToPreviousTab();
...
// end else statement
  ...
  @Test
  public void Verify_layout_Step__Payment_with_TJ_Debit__New_CheckoutC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//input[@id=\"belcorpNewCheckoutPaymentMode_mpago_debit\"]"}));
// End If Statement
}
// Start Else Statement
else{
...
javascriptExecution("document.querySelector(\"label[for=\'belcorpNewCheckoutPaymentMode_mpago_debit\']\").click();");
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\"contentCardsSaved\"])[1]"}));
  ...
  @Test
  public void Check_Type_of_DocumentC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[text()=\'El documento debe tener 8 caracteres\']"}));
// Enter document number
...
// Assertion on error message
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[text()=\'Los siguientes caracteres ingresados no son válidos: (a), solo se aceptan números\']"}));
...
typeText(new String[] { XPATH, "//input[@id=\"docNumber\"]" }, "123456781234");
  ...
  @Test
  public void Verify_criteria_in_Pending_Payment_in_new_checkout__C() {
// Clear cache and  cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "form#mpago_debit div.action-fixed-bottom > div > button"}));
// Click on submit button
clickOnElement( new String[] {CSS, "form#mpago_debit div.action-fixed-bottom > div > button"});
// start if statement
if (isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success\"]"})){
...
// end else statement
  ...
  @Test
  public void Validate_the_total_amount_with_or_without_Cart_DiscountsC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'total\'])[1]"}));
  ...
  @Test
  public void Verify_behavior_in_Billing_Address__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if home page present
  ...
  @Test
  public void Validate_that_it_does_not_impact_other_countriesC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "(//div[@class=\'checkout-order-summary\'])[1]" },"logs/Screenshots/Adurcz.png");
// end if statement
}
// else statement
else{
...
// end else statement
  ...
  @Test
  public void Validate_the_total_amount_with_or__without_Product_discountsC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//a[contains(text(),\'Ir a pagar\')]"});
// wait
waitUntil("CheckClickableElement", new String[]{CSS, "div#StickySidebar div.col-sm-5.col-md-12.pull-right.checkout__cart_actions_btn_container.js-gift-popup-candidate > button#checkout-display-continueCheckout"}, "5","disabled");
// click on go pay continue
clickOnElement( new String[] {CSS, "div#StickySidebar div.col-sm-5.col-md-12.pull-right.checkout__cart_actions_btn_container.js-gift-popup-candidate > button#checkout-display-continueCheckout"});
// Write text in firstName
typeText(new String[] { XPATH, "//input[@id=\'guest.firstName\']" }, "purva");
// Write text in lastName
typeText(new String[] { XPATH, "//input[@id=\'guest.lastName\']" }, "gupta");
