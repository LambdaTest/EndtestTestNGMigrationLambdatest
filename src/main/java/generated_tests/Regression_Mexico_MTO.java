...
public class Regression_Mexico_MTO extends WebDriverHelper {
  ...
  @Test
  public void Validate_button_Add_Set_to_bag_when_choosing_tone__option_is_missingC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { XPATH, "//h3[contains(@class,\"commercialCarousel-pdp-title\")]" }).contains("Promociones exclusivas"));
// start if statement for recomendation just for you
if (isElementAvailable(new String[] { XPATH, "//h3[con//div[text() = \"Recomendación solo para ti\"]tains(@class,\"commercialCarousel-pdp-title\")]"})){
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text() = \"Labial Dúo Hydra Matte + Gel Retexturizante Primer de Maquillaje\"]"}));
// end if statement
}
...
// end else statement
  ...
  @Test
  public void MX__EE_create_account__Tiered_Discount__CCC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshot("logs/Screenshoots/KxbREr.png");
// Go back to PDP
goBack();
...
takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" },"logs/Screenshots/iAlxPi.png");
...
// end else statement
  ...
  @Test
  public void MX__EE_Set_variable_conditional__supported__Free_Shipping__Agency__BankingCphase() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
javascriptExecution("window.sessionStorage.clear();");
// Go To URL
getURL("https://s1-esika.tiendabelcorp.com/mx/multiprotector-rostro-acabado-mate-perfect-block/p/200098648/BelcorpJess");
// start if statement
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]"}));
...
// Take a screen shot to Validate that the list of products conditional for the promotion is displayed
takeScreenshot("logs/Screenshoots/UeXHfu.png");
// Go back to PDP
goBack();
// wait until add to cart button clickeble
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[@id='addToCartButton']"}, "10","disabled");
...
takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" },"logs/Screenshots/woesTw.png");
// click on go pay button
clickOnElement( new String[] {XPATH, "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]"});
// end if statement for add to cart
}
...
// end else
  ...
  @Test
  public void Validate_gift_modalC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]/..//div[@class=\"owl-wrapper-outer\"]"}));

    status = "passed"; 
   }
  @Test
  public void Validate_modal_Product_informationC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end else statements
  ...
  @Test
  public void MX_EE_apply_Discount__CC_couponCC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
typeText(new String[] { XPATH, "//div[contains(@class,\'voucher-respond\')] /child::form/child::input" }, "AHORAONUNCA");
// Click on Apply button
clickOnElement( new String[] {XPATH, "//button[@class=\'btn btn-black cart-voucher__btn\']"});
// Coupon successfully applied is present
if (isElementAvailable(new String[] { XPATH, "//div[@class=\'voucherSuccessMessage desktop\']/child::span[text()=\'Cupón aplicado exitosamente\']"})){
// Validate Coupon successfully applied
Assert.assertTrue(getText(new String[] { XPATH, "//div[@class=\'voucherSuccessMessage desktop\']/child::span[text()=\'Cupón aplicado exitosamente\']" }).contains("aplicado exitosamente"));
// End If Statement
}
...
Assert.assertTrue(getText(new String[] { XPATH, "//div[@class=\'js-voucher-validation-container help-block cart-voucher__help-block\']" }).contains("El cupón no es válido"));
// End of If Loop
}
// Click on go pay button
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]"}));
  ...
  @Test
  public void Purchase_in_virtual_store__registered_user__cash_BBVA_Bancomer__CC() {
...
clickOnElement( new String[] {CSS, "div#StickySidebar > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(1)"});
// click on esika link
...
// click on shampoo
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200090337-FotoFondoBlancoSB.jpg\"]"});
// Add assertion for add to cart button
Assert.assertTrue(isElementAvailable(new String[] { ID, "addToCartButton"}));
// click on add to cart button
clickOnElement( new String[] {ID, "addToCartButton"});
...
clickOnElement( new String[] {CSS, "img[src=\"https://belc-bigdata-mdm-images-prd.s3.amazonaws.com/images/FotoProductoFondoBlancoWebRedes/200092282_fotocrosselling.jpg\"]"});
// Add assertion for  \"add to cart\" button
Assert.assertTrue(isElementAvailable(new String[] { ID, "addToCartButton"}));
// click on add to cart button
clickOnElement( new String[] {ID, "addToCartButton"});
...
// start if
if (isElementAvailable(new String[] { CSS, "div#StickySidebar > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"})){
// click on gopay
clickOnElement( new String[] {CSS, "div#StickySidebar > div > div:nth-of-type(6) > div:nth-of-type(2) > div > div > div:nth-of-type(2) > div > button:nth-of-type(2)"});
// end if
}
...
// end else
  ...
  @Test
  public void Scenario__MX__Payment_rejected_with_debit_cardC_PHASE() {
// Clear Cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(getText(new String[] { CSS, "div#cboxLoadedContent div > span" }).contains("Lo sentimos, en este momento no podemos procesar tu pago, intenta de nuevo mas tarde o elige otro método de pago"));
// Take Snip
takeScreenshotOfParticularElement(new String[] { CSS, "div#cboxLoadedContent div > span" },"logs/Screenshots/ARDMPy.png");

    status = "passed"; 
   }
  @Test
  public void MX__EE_Access_from_the_landing_of_brands__guest_user_and_checkout___C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// end if
  ...
  @Test
  public void MX__EE_Access_from_the_landing_of_brands_categories__guest_user_and_checkout_Agency__BankingC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]"}));
  ...
  @Test
  public void SCENARIO__Purchase_in_virtual_store__Google_User__cash_OXXOCC() {
...
clickOnElement( new String[] {XPATH, "(//div[@class=\'product__listing product__grid\']/child::div/child::div/child::a)[2]"});
// Click on Add to cart
clickOnElement( new String[] {ID, "addToCartButton"});
