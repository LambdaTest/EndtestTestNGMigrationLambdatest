...
takeScreenshot("logs/Screenshoots/rnuTsJ.png");
// Go back to PDP
goBack();
...
takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" },"logs/Screenshots/wWXfzO.png");
...
// Take a screen shot to Validate that the list of products conditional for the promotion is displayed
takeScreenshot("logs/Screenshoots/XSoPCS.png");
// Go back to PDP
goBack();
// wait until add to cart button clickeble
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[@id='addToCartButton']"}, "10","disabled");
...
takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" },"logs/Screenshots/SHXwRY.png");
// click on go pay button
clickOnElement( new String[] {XPATH, "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]"});
// end if statement for add to cart
}
...
// Take Snip
takeScreenshotOfParticularElement(new String[] { CSS, "div#cboxLoadedContent div > span" },"logs/Screenshots/YRKFSU.png");
