...
public class FB_test_cases__Eight_from_regression extends WebDriverHelper {

  @Test
  public void Purchase_in_virtual_store__login_with_facebook_credit_cardCSixzeroEight() {
    javascriptExecution("lambda-name=Purchase in virtual store  login with facebook credit cardCSixzeroEight");
  ...
  @Test
  public void MTO_Login_with_Facebook_for_the_first_time_COneTwoSevenOne_CTwoNineThreezero() {
    javascriptExecution("lambda-name=MTO Login with Facebook for the first time COneTwoSevenOne CTwoNineThreezero");
  ...
  @Test
  public void EC_Verify_Register_as_a_FB_User_from_the_BrandCFiveOneSeven() {
    javascriptExecution("lambda-name=EC Verify Register as a FB User from the BrandCFiveOneSeven");
  ...
  @Test
  public void Purchase_in_virtual_store__login_with_facebook_credit_cardCOneEightzeroOneNinezeroCSixzeroEight() {
    javascriptExecution(
      "lambda-name=Purchase in virtual store  login with facebook credit cardCOneEightzeroOneNinezeroCSixzeroEight");
  ...
  @Test
  public void Purchase_in_virtual_store__login_with_facebook_credit_cardCOneEightzeroOneEightSixCSixzeroFour() {
    javascriptExecution(
      "lambda-name=Purchase in virtual store  login with facebook credit cardCOneEightzeroOneEightSixCSixzeroFour");
  ...
  @Test
  public void Purchase_in_virtual_store__login_with_facebook_credit_cardcOneEightzeroOneSevenTwoCFiveNineThree() {
    javascriptExecution(
      "lambda-name=Purchase in virtual store  login with facebook credit cardcOneEightzeroOneSevenTwoCFiveNineThree");
  ...
  @Test
  public void ECSCENARIO_Two_Purchase_in_virtual_store__log_in_with_FB_User__Cash_PaymentCFivezeroSeven__CTwoSixEightSix() {
    javascriptExecution(
      "lambda-name=ECSCENARIO Two Purchase in virtual store  log in with FB User  Cash PaymentCFivezeroSeven  CTwoSixEightSix");
    ...
    // press enter key
    pressKey(new String[] { XPATH, "//input[@class=\'form-control input-text h-auto\']" }, "ENTER");
    // wait
    ...
    // take screenshot
    takeScreenshot("logs/Screenshoots/hBrvFk.png");

    status = "passed";
  }

  @Test
  public void ECOMLogin_with_FacebookCOneTwoFiveFour() {
    javascriptExecution("lambda-name=ECOMLogin with FacebookCOneTwoFiveFour");
  ...
  @Test
  public void ECOM_Login_with_Facebook_for_the_first_time__COneTwoSevenTwo() {
    javascriptExecution("lambda-name=ECOM Login with Facebook for the first time  COneTwoSevenTwo");
  ...
  @Test
  public void MTO_Cancellation_of_Facebook_account_linkCOneTwoEightOneCTwoNineThreeFive() {
    javascriptExecution("lambda-name=MTO Cancellation of Facebook account linkCOneTwoEightOneCTwoNineThreeFive");
  ...
  @Test
  public void Purchase_in_virtual_store__login_with_facebook_credit_cardCOneEightzeroOneNineTwoCFiveEightEight() {
    javascriptExecution(
      "lambda-name=Purchase in virtual store  login with facebook credit cardCOneEightzeroOneNineTwoCFiveEightEight");
  ...
  @Test
  public void MTO_Login_with_Facebook_previously_registeredCOneEightThreeNineEightOne() {
    javascriptExecution("lambda-name=MTO Login with Facebook previously registeredCOneEightThreeNineEightOne");
  ...
  @Test
  public void ECOM_Link_Facebook_accountCOneTwoSixOneCTwoNineTwoSeven() {
    javascriptExecution("lambda-name=ECOM Link Facebook accountCOneTwoSixOneCTwoNineTwoSeven");
  ...
  @Test
  public void ECOM_Login_with_Facebook_previously_registeredCOneTwoSevenFourCTwoNineThreeOne() {
    javascriptExecution("lambda-name=ECOM Login with Facebook previously registeredCOneTwoSevenFourCTwoNineThreeOne");
  ...
  @Test
  public void Purchase_in_virtual_store__log_in_with_FB_User__Cash_PaymentCOneEightzeroOneEightOneCSixOnezero() {
    javascriptExecution(
      "lambda-name=Purchase in virtual store  log in with FB User  Cash PaymentCOneEightzeroOneEightOneCSixOnezero");
  ...
  @Test
  public void MTO_Link_Facebook_accountCOneTwoSixTwo() {
    javascriptExecution("lambda-name=MTO Link Facebook accountCOneTwoSixTwo");
  ...
  @Test
  public void MTO_Login_with_Facebook_previously_registeredCOneTwoSevenThreeCTwoNineThreeOne() {
    javascriptExecution("lambda-name=MTO Login with Facebook previously registeredCOneTwoSevenThreeCTwoNineThreeOne");
  ...
  @Test
  public void MTO_Linking_accounts_with_FacebookCOneTwoSevenFiveCTwoNineThreeTwo() {
    javascriptExecution("lambda-name=MTO Linking accounts with FacebookCOneTwoSevenFiveCTwoNineThreeTwo");
  ...
  @Test
  public void MTOLogin_with_FacebookCOneTwoFiveThreeCTwoNineTwoThree() {
    javascriptExecution("lambda-name=MTOLogin with FacebookCOneTwoFiveThreeCTwoNineTwoThree");
