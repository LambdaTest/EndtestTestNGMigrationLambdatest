...
public class Regression_Chile_Ecquador_Consolidated extends WebDriverHelper {
    ...
    public void Purchase_in_virtual_store__registered_user__Servipag_CSixzeroTwo() {
        ...
        // Click on Linea
        clickOnElement(new String[]{CSS, "a[href='/cl/c/lbel-0405/MaryEmy']"});
    ...
    @Test
    public void UF_Consultant_Marquee_COneSevenFiveNineSevenEightCSevenSixNine() {
    ...
    @Test
    public void ETwoE__Scenario_One__BTwoCCOneSevenNineNineSixSevenCThreeTwoEightzero() {
    ...
    @Test
    public void CL__LBEL__Popup_buy_the_consultant_CATEGORIESCTwoEightSevenSix() {
    ...
    @Test
    public void CL__ETwoE_create_account__Tiered_Discount__CCCOneSevenFiveSixTwoEightCTwoNineFiveNine() {
        javascriptExecution(
        ...
        if (isElementAvailable(new String[]{XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]"})) {
            ...
            if (isElementAvailable(new String[]{XPATH, "//div[contains(text(),\'Promoción condicionada\')]"})) {
                ...
                takeScreenshot("logs/Screenshoots/CMDLxY.png");
                // Go back to PDP
                goBack();
        ...
        if (isElementClickable(new String[]{XPATH, "//button[@id=\'addToCartButton\']"})) {
            ...
            takeScreenshotOfParticularElement(new String[]{CSS, "tr > td"}, "logs/Screenshots/kfGvrN.png");
    ...
    @Test
    public void CL__ETwoE_Fixed_levels__Discount_coupon__Credid_cardCThreeSevenOneFive_PHASETwo() {
        javascriptExecution("lambda-name=CL  ETwoE Fixed levels  Discount coupon  Credid cardCThreeSevenOneFive PHASETwo");
    ...
    public void CL__ETwoE_apply_Discount_coupon__CCCOneEightzerozeroFiveSevenCFiveSixTwo() {
        ...
        // start of else loop
            ...
            // start else
                ...
                // Print Result
                printResults("PrintNote", "\"coupon code is not present\"");
                // end else statement
            }
            // Assertion on Discount amount
            Assert.assertTrue(
    ...
    public void CL__ETwoE_Access_from_the_brands__guest_user_and_checkout_Agency_BankingCOneSevenFiveSixTwoSevenCEightThreeFour() {
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"delivery submit is not present\"");
            // end else statement
        }
    ...
    @Test
    public void Register_Recommended_Bundle_Order_from_IndividualCOneSevenFiveEightOneNineCFourFiveTwo() {
        javascriptExecution(
    ...
    @Test
    public void CLETwoE_apply_Discount_couponCCCOneEightzerozeroSixSevenCFiveSevenSeven() {
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"discount coupon is not present\"");
            // end else statement
        }
        // Assertion on Add to cart button
        Assert.assertTrue(isElementClickable(new String[]{XPATH, "//button[@id=\'addToCartButton\']"}));
    ...
    @Test
    public void ETwoE__Scenario_ThreeCOneSevenNineNineSixNineCThreeTwoEightTwo() {
    ...
    @Test
    public void EC__ETwoE_create_account__Tiered_Discount__CCCOneEightzeroTwozeroFourCThreeSevenFourTwo() {
        javascriptExecution(
        ...
        if (isElementAvailable(new String[]{XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]"})) {
            ...
            if (isElementAvailable(new String[]{XPATH, "//div[contains(text(),\'Promoción condicionada\')]"})) {
                ...
                Assert.assertTrue(checkCurrentUrlContains("isConditionOf"));
                // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
                takeScreenshot("logs/Screenshoots/oIxwgR.png");
                // Go back to PDP
                goBack();
                // wait until add to cart button clickeble
                waitUntil("CheckClickableElement", new String[]{XPATH, "//button[@id='addToCartButton']"}, "10", "disabled");
        ...
        if (isElementClickable(new String[]{XPATH, "//button[@id=\'addToCartButton\']"})) {
            ...
            // take a snip to validate product title /CUV/stock
            takeScreenshotOfParticularElement(new String[]{CSS, "tr > td"}, "logs/Screenshots/wuqCKj.png");
            // add assertion for eliminate link
            Assert.assertTrue(isElementAvailable(new String[]{CSS, "div.item__remove-action > div#actionEntry_0 > a"}));
            // start if statement for tiered discount
            if (isElementAvailable(new String[]{XPATH, "//span[@class=\"cart-entry-message\"]"})) {
    ...
    @Test
    public void CL__ETwoE_apply_Discount_coupon__CCCOneSevenFiveSixThreeOneCThreeSevenThreezero() {
        javascriptExecution("lambda-name=CL  ETwoE apply Discount coupon  CCCOneSevenFiveSixThreeOneCThreeSevenThreezero");
    ...
    @Test
    public void CL__ESIKA__Popup_buy_the_consultant_CATEGORIESCTwoEightSevenzero() {
        ...
        getURL("https://s1-esika.tiendabelcorp.com/cl/");
        // close
        if (isDisplayed(new String[]{XPATH, "//button[@id='cboxClose']"})) {
            clickOnElement(new String[]{XPATH, "//button[@id='cboxClose']"});
        } else {
            printResults("Print note", "C box pop up not coming");
        }
        // wait for consultant popup
        waitUntil("CheckVisibleElement", new String[]{XPATH, "(//div[@class='popup'])[2]"}, "10", "disabled");
        // start if statement
        if (isDisplayed(new String[]{XPATH, "(//div[@class=\"popup\"])[2]"}, 5)) {
            // click on yes i want
            clickOnElement(new String[]{CSS, "div#cboxLoadedContent div.popup__footer__button.js-switch-eco-mto-confirm"});
            // take a snip of consultant
            takeScreenshotOfParticularElement(new String[]{CSS, "div#cboxLoadedContent > ul"},
                    "logs/Screenshots/gWPFgM.png");
            // add assertion for consultant
            Assert.assertTrue(isElementDisplayed(new String[]{CSS, "div#cboxLoadedContent > ul"}));
            // click on buy from consultant
            clickOnElement(new String[]{CSS, "a#js-sem-buy-button"});
    ...
    @Test
    public void ETwoE__Scenario_Two__MTOCOneSevenNineNineSixEightCThreeTwoEightOne() {
    ...
    @Test
    public void CL__ETwoE_create_account_Tiered_Discount__CC__CFiveFiveSeven() {
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"first product is not present\"");
            // end else statement
        }
        ...
        // start else
            ...
            // Print Result
            printResults("PrintNote", "\"coupon text box is not present\"");
            // end else statement
        }
        // if coupon present
    ...
    @Test
    public void CL__CYZONE_Popup_buy_the_consultant_CATEGORIESCTwoEightSevenThree_PHASETwo() {
