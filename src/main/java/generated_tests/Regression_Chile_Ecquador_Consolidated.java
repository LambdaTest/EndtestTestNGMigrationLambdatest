...
Assert.assertTrue(
  ...
  isElementClickable(new String[] {
    CSS, "div.item__remove-action > div#actionEntry_0 > a"
  }));
  // Add Assertion For product name
Assert.assertTrue(

  isElementAvailable(new String[] {
    XPATH, "//span[@class=\'item__name\']"
  }));
  // Add assertion For Product Image
Assert.assertTrue(

  isElementAvailable(new String[] {
    CSS, "div.item__image > a > img"
  }));

  // Write cupon code
  typeText(new String[] {
    XPATH, "//input[@id=\'js-voucher-code-text\']"
  },"BIENVENIDO20");

  // Click on Apply Button
  clickOnElement( new String[] {
    CSS, "button#js-voucher-apply-btn"
  });

  // Click on Go Pay Button
  clickOnElement( new String[] {
    XPATH, "//div[@class=\'actions\']/button[contains(.,\'Ir a pagar\')]"
  });
  // Login as Guest User
...
if(
  ...
  isDisplayed(new String[] {
    ID, "address.regionIsoParent2"
  },0))
...
if(
  ...
  isElementAvailable(new String[] {
    CSS, "div#belcorpNewCheckoutPaymentModeSelector > div:nth-of-type(2) > div:nth-of-type(2) > label > span:nth-of-type(1)"
  }))
...
Assert.assertTrue(
  ...
  isElementAvailable(new String[] {
    CSS, "div[class=\"checkout-success__body__headline\"]"
  }));
  ...
  public void CL__EE_create_account__Tiered_Discount__CCCC() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
      ...
      if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
        ...
        takeScreenshot("logs/Screenshoots/aynHUj.png");
        // Go back to PDP
        goBack();
    ...
    if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/vemoun.png");
  ...
  public void EC_EE_apply_Discount__CC_couponCCC() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
      ...
      status = "passed";
    } @Test public void CL__EE_create_account_Tiered_Discount__CC__C () {
      // Clear cache and cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void UF_Consultant_Marquee_CC () {
      // clear cache and cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void Purchase_in_virtual_store__registered_user__Servipag_CCC () {
      // clear cache and cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void SCENARIO__Purchase_in_virtual_store__Google_User__Servipag_CC () {
      // Clear cookies and cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void EC_EE_Add_supported_from_link_Free_Shipping_Banking_AgencyCC () {
      // clear cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void CL__LBEL__Popup_buy_the_consultant_CATEGORIESC () {
      // Clear cache cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void CLEE_apply_Discount_couponCCCC () {
      // clear cache
      // Clear cookies
      deleteAllCookies();
      // Clear storage
    ...
    @Test public void EC__EE_create_account__Tiered_Discount__CCCC () {
      // Clear cache cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
      ...
      if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
          ...
          Assert.assertTrue(checkCurrentUrlContains("isConditionOf"));
          // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
          takeScreenshot("logs/Screenshoots/flQHEx.png");
          // Go back to PDP
          goBack();
          // wait until add to cart button clickeble
      ...
      if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
        ...
        // take a snip to validate product title /CUV/stock
        takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/AWgAcI.png");
        // add assertion for eliminate link
        Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.item__remove-action > div#actionEntry_0 > a" }));
        // start if statement for tiered discount
        if (isElementAvailable(new String[] { XPATH, "//span[@class=\"cart-entry-message\"]" })) {
    ...
    @Test public void Purchase_in_virtual_store__registered_user__Servipag_C () {
      // clear cache and cookies
      // Clear cookies
      deleteAllCookies();
      // Clear storage
      ...
      @Test public void EE__Scenario___MTOCC () {
        // Clear cookies and cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
      ...
      @Test public void Register_Recommended_Bundle_Order_from_IndividualCC () {
        // Clear cookies and cache
        // Clear cookies
        deleteAllCookies();
        // Clear storage
        ...
        if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
          ...
          status = "passed";
        } @Test public void CL__EE_apply_Discount_coupon__CCCC () {
          // clear cache
          // Clear cookies
          deleteAllCookies();
          // Clear storage
