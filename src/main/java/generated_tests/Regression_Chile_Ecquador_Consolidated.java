...
public class Regression_Chile_Ecquador_Consolidated extends WebDriverHelper {
  ...
  @Test
  public void Purchase_in_virtual_store__registered_user__Servipag_CSixzeroTwo() {
    javascriptExecution("lambda-name=Purchase in virtual store  registered user  Servipag CSixzeroTwo");
    ...
    // start else
      ...
      clickOnElement(new String[] { CSS,
        "button[type=\"button\"][class=\"btn btn-magenta btn-block submit_mpagoServipagForm checkout-next\"]" });
    ...
    @Test public void UF_Consultant_Marquee_COneSevenFiveNineSevenEightCSevenSixNine () {
      javascriptExecution("lambda-name=UF Consultant Marquee COneSevenFiveNineSevenEightCSevenSixNine");
      ...
      Assert.assertTrue(
        isElementAvailable(new String[] { XPATH, "//span[text() = \" MARIA ELENA VARGAS VILLALVA\"]" }));
    ...
    @Test public void ETwoE__Scenario_One__BTwoCCOneSevenNineNineSixSevenCThreeTwoEightzero () {
      javascriptExecution("lambda-name=ETwoE  Scenario One  BTwoCCOneSevenNineNineSixSevenCThreeTwoEightzero");
      ...
      clickOnElement(
        new String[] { XPATH, "(//button[@class=\'btn js_search_button searchBoxButtonIconShort\']/child::i)[1]" });
      // Products is Present
      if (isElementAvailable(new String[] { XPATH,
        "//div[@class=\'product__listing product__grid\']/child::div[3]/child::div[2]/child::a" })) {
        ...
        // start if statement
        if (isElementAvailable(new String[] { XPATH,
          "(//button[@class=\'item__quantity__action_btn item__quantity__action_plus_btn\'])[2]" })) {
          // Increase Quantity of Product
          clickOnElement(new String[] { XPATH,
            "(//button[@class=\'item__quantity__action_btn item__quantity__action_plus_btn\'])[2]" });
          // Click on Keep Buying Button
          clickOnElement(
            new String[] { XPATH, "//div[@class=\'row row-bar\']/child::div[2]/child::div/child::button[1]" });
          // End if
        }
        // Start Else
        else {
      ...
      // Click on Search Symbol
      clickOnElement(
        new String[] { XPATH, "(//button[@class=\'btn js_search_button searchBoxButtonIconShort\']/child::img)[1]" });
      // Products is Present
      if (isElementAvailable(new String[] { XPATH,
        "//div[@class=\'product__listing product__grid\']/child::div[3]/child::div[2]/child::a" })) {
        // Click on Ranking DropDown
    ...
    @Test public void CL__LBEL__Popup_buy_the_consultant_CATEGORIESCTwoEightSevenSix () {
      javascriptExecution("lambda-name=CL  LBEL  Popup buy the consultant CATEGORIESCTwoEightSevenSix");
      ...
      if (isDisplayed(new String[] { XPATH, "(//div[@class=\"popup\"])[2]" }, 0)) {
        // click on yes i want
        clickOnElement(
          new String[] { CSS, "div#cboxLoadedContent div.popup__footer__button.js-switch-eco-mto-confirm" });
        // take a snip of consultant
        takeScreenshotOfParticularElement(new String[] { CSS, "div#cboxLoadedContent > ul" },
          "logs/Screenshots/ygiKbR.png");
        ...
        takeScreenshotOfParticularElement(new String[] { CSS, "div#consultant-profile > div" },
          "logs/Screenshots/oCWmWN.png");
        // add assertion for consultant
    ...
    @Test public void CL__ETwoE_create_account__Tiered_Discount__CCCOneSevenFiveSixTwoEightCTwoNineFiveNine () {
      javascriptExecution(
        "lambda-name=CL  ETwoE create account  Tiered Discount  CCCOneSevenFiveSixTwoEightCTwoNineFiveNine");
      ...
      if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
          ...
          takeScreenshot("logs/Screenshoots/aMxmdL.png");
          // Go back to PDP
          goBack();
      ...
      if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
        ...
        takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/bCHOHg.png");
    ...
    @Test public void CL__ETwoE_Fixed_levels__Discount_coupon__Credid_cardCThreeSevenOneFive_PHASETwo () {
      javascriptExecution(
        "lambda-name=CL  ETwoE Fixed levels  Discount coupon  Credid cardCThreeSevenOneFive PHASETwo");
      ...
      // Go to URL
      getURL(
        "https://s1-lbel.tiendabelcorp.com/cl/infini-absolu-labial-liquido-larga-duraci%c3%b3n/p/200094567/MaryEmy");
      ...
      // start if statement
      if (isElementAvailable(
        new String[] { XPATH, "//a[@class=\'btn promotionButton viewDetailProductCommercialCarousel\']" })) {
        // Click on See Gift Details
        javascriptExecution(
          "document.querySelector(\"a[class=\'btn promotionButton viewDetailProductCommercialCarousel\']\").click();");
  ...
  @Test
  public void CL__ETwoE_apply_Discount_coupon__CCCOneEightzerozeroFiveSevenCFiveSixTwo() {
    javascriptExecution("lambda-name=CL  ETwoE apply Discount coupon  CCCOneEightzerozeroFiveSevenCFiveSixTwo");
  ...
  @Test
  public void EC_ETwoE_apply_Discount__CC_couponCOneEightzeroTwozeroFiveCEightFiveOneCThreeSevenFourSeven() {
    javascriptExecution(
      "lambda-name=EC ETwoE apply Discount  CC couponCOneEightzeroTwozeroFiveCEightFiveOneCThreeSevenFourSeven");
    ...
    if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
      ...
      Assert.assertTrue(isElementAvailable(new String[] { XPATH,
        "//div[@class=\'checkout-steps \']/child::div[2]/descendant::div/descendant::div/descendant::div[@class=\'subtotal\']" }));
      // CLICK here to continue button is present
      if (isElementAvailable(
        new String[] { XPATH, "//button[@class=\'btn btn-magenta btn-block submit_belpayForm checkout-next\']" })) {
        // Print in Console
    ...
    public void SCENARIO_Three_Purchase_in_virtual_store__Google_User__Servipag_COneEightzeroOneEightFiveCSixzeroThree
    () {
      javascriptExecution(
        "lambda-name=SCENARIO Three Purchase in virtual store  Google User  Servipag COneEightzeroOneEightFiveCSixzeroThree");
      ...
      // Products is Present
      if (isElementAvailable(new String[] { XPATH,
        "//div[@class=\'product__listing product__grid\']/child::div[2]/child::div[2]/child::a" })) {
        // Click on Third Product
        clickOnElement(new String[] { XPATH,
          "//div[@class=\'product__listing product__grid\']/child::div[2]/child::div[2]/child::a" });
        // Click on ADD TO CART
    ...
    @Test
    public void EC__ETwoE_Acceder_desde_la_landing_de_marcas_categorias__usuario_invitado_y_checkout_Agencia_BancaCOneEightzeroTwozeroThreeCEightThreeNine
    () {
      javascriptExecution(
        "lambda-name=EC  ETwoE Acceder desde la landing de marcas categorias  usuario invitado y checkout Agencia BancaCOneEightzeroTwozeroThreeCEightThreeNine");
      ...
      // Click on CLICK here to continue button
      clickOnElement(new String[] { CSS,
        "button[type=\"button\"][class=\"btn btn-magenta btn-primary btn-block submit_belpayCashForm checkout-next\"]" });
      // Click on Terms1
      clickOnElement(new String[] { ID, "Terms1" });
    ...
    @Test
    public void CL__ETwoE_Access_from_the_brands__guest_user_and_checkout_Agency_BankingCOneSevenFiveSixTwoSevenCEightThreeFour
    () {
      javascriptExecution(
        "lambda-name=CL  ETwoE Access from the brands  guest user and checkout Agency BankingCOneSevenFiveSixTwoSevenCEightThreeFour");
    ...
    @Test public void Register_Recommended_Bundle_Order_from_IndividualCOneSevenFiveEightOneNineCFourFiveTwo () {
      javascriptExecution(
        "lambda-name=Register Recommended Bundle Order from IndividualCOneSevenFiveEightOneNineCFourFiveTwo");
      ...
      if (isElementAvailable(new String[] { XPATH,
        "//div[@class=\'commercialCarousel-pdp-footer\']/child::a[text()=\'Ver detalle del set\']" })) {
        // Explicit wait  Carousel to Load
        waitUntil("CheckVisibleElement",
          new String[] { XPATH, "//ul[@id='productGalleryThumbnails']/following-sibling::div/child::div" }, "10",
          "disabled");
        // Validate Carousel is present
        Assert.assertTrue(isElementDisplayed(
          new String[] { XPATH, "//ul[@id=\'productGalleryThumbnails\']/following-sibling::div/child::div" }));
      ...
      // Go to Lbel URL
      getURL(
        "https://s1-lbel.tiendabelcorp.com/ec/botanology-crema-hidratante-para-manos-macadamia/p/200103961/MaritaTO123");
      // See Set Detail is Present
      if (isElementAvailable(new String[] { XPATH,
        "//div[@class=\'commercialCarousel-pdp-footer\']/child::a[text()=\'Ver detalle del set\']" })) {
        // Explicit wait  Carousel to Load
      ...
      if (isElementAvailable(new String[] { XPATH, "//select[@id=\'paymentOptions\']" })) {
        ...
        // Validate Order Summary
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "//div[@class=\'checkout-steps \']/child::div[1]" }));
        // Validate SubTotal
        ...
        status = "passed";
      } @Test public void CLETwoE_apply_Discount_couponCCCOneEightzerozeroSixSevenCFiveSevenSeven () {
        javascriptExecution("lambda-name=CLETwoE apply Discount couponCCCOneEightzerozeroSixSevenCFiveSevenSeven");
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\"commercialCarousel-pdp-wrapper\"]" })) {
          // Assertion on product discount coupon
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//div[@class=\"commercialCarousel-pdp-wrapper\"]" }));
          // End of if loop
        }
        // Assertion on Add to cart button
        Assert.assertTrue(isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" }));
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\"promo\"]" })) {
          ...
          // Assertion on Discount amount
          Assert.assertTrue(isElementAvailable(
            new String[] { XPATH, "//div[@class=\"col-xs-6 cart-totals-right text-right discount\"]" }));
          // click on cart go pay button
          clickOnElement(
            new String[] { XPATH, "//div[@class=\'actions\']/child::button[contains(text(),\'Ir a pagar\')]" });
          // End of if loop
      ...
      @Test public void ETwoE__Scenario_ThreeCOneSevenNineNineSixNineCThreeTwoEightTwo () {
        javascriptExecution("lambda-name=ETwoE  Scenario ThreeCOneSevenNineNineSixNineCThreeTwoEightTwo");
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\'name\']" })) {
          ...
          Assert.assertTrue(isElementDisplayed(
            new String[] { XPATH, "//div[@class=\'product-details page-title page-title-cyzone\']/child::h1" }));
          // End of If Loop
        }
        // Click on Lbel
        clickOnElement(new String[] { XPATH, "(//img[@data-parent=\'lbel\'])[2]" });
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\'name\']" })) {
          ...
          // Validate Product Name
          Assert.assertTrue(isElementDisplayed(
            new String[] { XPATH, "//div[@class=\'product-details page-title page-title-lbel\']/child::h1" }));
          // End of If Loop
        }
        // Click on Esika
        clickOnElement(new String[] { XPATH, "(//img[@data-parent=\'esika\'])[2]" });
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\'name\']" })) {
          ...
          // Validate Product Name
          Assert.assertTrue(isElementDisplayed(
            new String[] { XPATH, "//div[@class=\'product-details page-title page-title-esika\']/child::h1" }));
          // End of If Loop
        }
      ...
      @Test
      public void Purchase_in_virtual_store__registered_user__Servipag_COneEightzeroOneEightFourCSixzeroTwoCTwoSixSevenEight
      () {
        javascriptExecution(
          "lambda-name=Purchase in virtual store  registered user  Servipag COneEightzeroOneEightFourCSixzeroTwoCTwoSixSevenEight");
        ...
        // Add Assertion for VICTOR HUGO BRA...
        Assert.assertTrue(
          isElementAvailable(new String[] { XPATH, "//li[text() = \"VICTOR HUGO BRAVO VALENZUELA\"]" }));
        // Add Assertion for Mi Tienda Onlin...
        Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//b[text() = \"Mi Tienda Online\"]" }));
        // Add Assertion for cl18@cl.com
        Assert.assertTrue(isElementAvailable(new String[] { CSS, "div[class=\"consultant-mail\"]" }));
        ...
        // If condition for go pay button present
        if (isElementAvailable(new String[] { XPATH,
          "//div[@class=\'actions\']/child::button[@id=\'checkout-display-continueCheckout\']" })) {
          // click on go pay button
          clickOnElement(new String[] { XPATH,
            "//div[@class=\'actions\']/child::button[@id=\'checkout-display-continueCheckout\']" });
          // end if statement
      ...
      @Test public void EC__ETwoE_create_account__Tiered_Discount__CCCOneEightzeroTwozeroFourCThreeSevenFourTwo () {
        javascriptExecution(
          "lambda-name=EC  ETwoE create account  Tiered Discount  CCCOneEightzeroTwozeroFourCThreeSevenFourTwo");
        ...
        if (isElementAvailable(new String[] { XPATH, "//h3[contains(text(),\'Promociones exclusivas\')]" })) {
          ...
          if (isElementAvailable(new String[] { XPATH, "//div[contains(text(),\'Promoción condicionada\')]" })) {
            ...
            Assert.assertTrue(checkCurrentUrlContains("isConditionOf"));
            // Take a screen shot to Validate that the list of products conditional for the promotion is displayed
            takeScreenshot("logs/Screenshoots/ZbgBvi.png");
            // Go back to PDP
            goBack();
            // wait until add to cart button clickeble
            waitUntil("CheckClickableElement", new String[] { XPATH, "//button[@id='addToCartButton']" }, "10",
        ...
        if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
          ...
          // take a snip to validate product title /CUV/stock
          takeScreenshotOfParticularElement(new String[] { CSS, "tr > td" }, "logs/Screenshots/sWVwAp.png");
          // add assertion for eliminate link
          Assert.assertTrue(
            isElementAvailable(new String[] { CSS, "div.item__remove-action > div#actionEntry_0 > a" }));
          // start if statement for tiered discount
          if (isElementAvailable(new String[] { XPATH, "//span[@class=\"cart-entry-message\"]" })) {
            // change the qty of product
            pressKey(
        ...
        waitUntil("CheckClickableElement", new String[] { XPATH, "//select[@id='address.regionIso']" }, "10",
          "disabled");
        // Select Option from location
        ...
        if (isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]" })) {
          ...
          waitUntil("CheckVisibleElement", new String[] { XPATH, "//div[@class='checkout-success__body']" }, "10",
            "disabled");
          // Add assertion for sucess message
          Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"checkout-success__body\"]" }));
          // End if statement for sucess message
      ...
      @Test public void CL__ETwoE_apply_Discount_coupon__CCCOneSevenFiveSixThreeOneCThreeSevenThreezero () {
        javascriptExecution(
          "lambda-name=CL  ETwoE apply Discount coupon  CCCOneSevenFiveSixThreeOneCThreeSevenThreezero");
        ...
        // click on first product
        clickOnElement(
          new String[] { CSS, "div#EsikaBicSection6 div:nth-child(5) > div > div.productCard__title > a" });
        // start if statement for add to cart button
        if (isElementClickable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
          // click on add to cart button
          clickOnElement(new String[] { XPATH, "//button[@id=\'addToCartButton\']" });
      ...
      @Test public void CL__ESIKA__Popup_buy_the_consultant_CATEGORIESCTwoEightSevenzero () {
        javascriptExecution("lambda-name=CL  ESIKA  Popup buy the consultant CATEGORIESCTwoEightSevenzero");
      ...
      @Test public void ETwoE__Scenario_Two__MTOCOneSevenNineNineSixEightCThreeTwoEightOne () {
        javascriptExecution("lambda-name=ETwoE  Scenario Two  MTOCOneSevenNineNineSixEightCThreeTwoEightOne");
      ...
      @Test
      public void CL__ETwoE_Access_from_the_brands__categories_landing__guest_user_and_checkout_Agency__BankingCOneEightzerozeroThreeSevenCFiveFiveTwo
      () {
        javascriptExecution(
          "lambda-name=CL  ETwoE Access from the brands  categories landing  guest user and checkout Agency  BankingCOneEightzerozeroThreeSevenCFiveFiveTwo");
        ...
        if (isElementAvailable(new String[] { XPATH,
          ...
          clickOnElement(new String[] { CSS,
            "ul#productGalleryThumbnails div.slick-slide.slick-current.slick-active > div > li > a > img" });
      ...
      @Test public void CL__ETwoE_create_account_Tiered_Discount__CC__CFiveFiveSeven () {
        javascriptExecution("lambda-name=CL  ETwoE create account Tiered Discount  CC  CFiveFiveSeven");
        ...
        if (isElementAvailable(
          new String[] { XPATH, "//a[@class=\'spanTitle ecarousel_product_productName_200098633\']" })) {
          // Click on first product
        ...
        // if coupon present
        if (isElementAvailable(
          new String[] { XPATH, "//span[@class=\'js-release-voucher voucher-list__item-box\']" })) {
          // Add assertion for Tiered discount
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//span[@class=\'js-release-voucher voucher-list__item-box\']" }));
      ...
      @Test public void CL__CYZONE_Popup_buy_the_consultant_CATEGORIESCTwoEightSevenThree_PHASETwo () {
        javascriptExecution("lambda-name=CL  CYZONE Popup buy the consultant CATEGORIESCTwoEightSevenThree PHASETwo");
      ...
      @Test
      public void EC_ETwoE_Add_supported_from_link_Free_Shipping_Banking_AgencyCOneEightzeroTwozeroSevenCThreeSevenOneTwo
      () {
        javascriptExecution(
          "lambda-name=EC ETwoE Add supported from link Free Shipping Banking AgencyCOneEightzeroTwozeroSevenCThreeSevenOneTwo");
        ...
        if (isElementAvailable(new String[] { XPATH, "//a[text() = \"Ver productos\"]" })) {
          ...
          // Add Assertion for qty selector button (+)
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//button[@class=\'btn js-qty-selector-plus\']" }));
          // Add Assertion for qty selector button (-)
          Assert.assertTrue(
            isElementAvailable(new String[] { XPATH, "//button[@class=\'btn js-qty-selector-minus\']" }));
          // Add Assertion For Add To Cart Button
          Assert.assertTrue(
            isElementClickable(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" }));
          // Click on Add to cart button
          clickOnElement(new String[] { XPATH, "//button[contains(text(),\'Agregar a la bolsa\')]" });
          // Click on keep buying button
          clickOnElement(new String[] { XPATH, "//a[contains(text(),\'Seguir Comprando\')]" });
        ...
        if (isElementAvailable(new String[] { CSS, "div#lazyLoadCommercialCarousel a" })) {
          ...
          if (checkContainsValue(new String[] { XPATH, "(//div[@class=\'cart-popup-progress-text\'])[2]/span[2]" },
            ...
            Assert.assertTrue(
              getText(new String[] { XPATH, "(//div[@class=\'cart-popup-progress-text\'])[2]/span[2]" }).contains(
                "¡Felicitaciones, alcanzaste el envío gratis!"));
            // Add Assertion For free shipment
            Assert.assertTrue(
              getText(new String[] { XPATH, "//span[@class=\'free-delivery-amount\']" }).contains("Gratis"));
            // End if statement
          }
          // Start  Else Statement
          else {
          ...
          // start if statement
          if (isElementAvailable(
            new String[] { XPATH, "//div[@class=\'actions\']/button[contains(.,\'Ir a pagar\')]" })) {
            // click on go pay button
            clickOnElement(new String[] { XPATH, "//div[@class=\'actions\']/button[contains(.,\'Ir a pagar\')]" });
            // Write text in guest first Name
            typeText(new String[] { ID, "guest.firstName" }, "Soumya");
