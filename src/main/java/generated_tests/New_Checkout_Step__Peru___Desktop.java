...
public class New_Checkout_Step__Peru___Desktop extends WebDriverHelper {
  ...
  public void Verify_that_all_the_products_added_to_the_cart_appear_in_See_my_productsC() {
    ...
    Assert.assertTrue(
      isElementAvailable(new String[] { XPATH, "(//li[@class=\'new-checkout-order-summary-list-heading\'])[2]" }));
  ...
  public void Check_the_order_of_added_productsC() {
    ...
    Assert
      .assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'subtotals__item--state-discount\'])[2]" }));
    // add assertion for bonus
    Assert.assertTrue(isElementAvailable(new String[] { CSS,
      "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form > div.checkout-order-summary > div > div" }));
