...
public class New_Checkout_Step__Peru___Desktop extends WebDriverHelper {

 
  @Test
  public void Verify_No_impact_with_registered_userC() {
...
takeScreenshot("logs/Screenshoots/fiKVas.png");
// add assertion for\"see my products\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//li[@class=\'new-checkout-order-summary-list-heading\'])[2]"}));
// add assertion for bonus
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form > div.checkout-order-summary > div > div"}));
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#collapsibleContentProducts_reco365 div.name.name-item > span"}));
// add assertion for quantity
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div#collapsibleContentProducts_reco365 div.quantity-entry"}));
// end if
}
  ...
  @Test
  public void ECOMRegisteredValidate_that_the_banner_for_ecom_is_displayedC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End of if loop
  ...
  @Test
  public void Registered_Validate_that_the_banner_for_MTO_is_displayedC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
// End of if loop
  ...
  @Test
  public void ECOMMGuestValidate_that_the_banner_for_ecomm_is_displayedC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
if (isElementAvailable(new String[] { XPATH, "(//strong[text()=\'¿Necesitas ayuda con tu proceso de pago?\'])[2]"})){
// add assertion for banner
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//strong[text()=\'¿Necesitas ayuda con tu proceso de pago?\'])[2]"}));
// End If Statement
}
...
// End Else Statement
  ...
  @Test
  public void Verify_the_completeness_of_the_data_to_continue_to_step_C() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
  ...
  @Test
  public void GuestValidate_that_the_banner_for_MTO_is_displayedC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form > div.checkout-order-summary > div > div"}));
  ...
  @Test
  public void Verify_that_the_checkbox_is_optional_to_continue_to_step_C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//button[@id=\'addressSubmit\']"});
  ...
  @Test
  public void Verify_the_no_impact_on_the_functionality_Order_as_a_gift_for_other_countryC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
