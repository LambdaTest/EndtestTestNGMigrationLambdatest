...
public class Checkout_TC__Peru__Chile__New_Checkout_updated extends WebDriverHelper {
  ...
  public void ECOM_Login_with_your_account__COneTwoFiveEight() {
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/XCMgUn.png");
    // Refresh page
    pageRefresh();
  ...
  public void ECOMPE_Free_shipping_bar_adjustmentCOneTwoTwoThree() {
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshot("logs/Screenshoots/NNxfGA.png");
      // Click on Remove
      clickOnElement(new String[] { XPATH,
  ...
  public void MTO_new_user_registrationCOneTwoSixSevenCTwoNineTwoEight() {
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/qaIOpD.png");
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/TRyHSE.png");
    // Click on register agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
    // Click on register  checkbox
    clickOnElement(new String[] { NAME, "belcorpToC" });
  ...
  public void MTO_CL_Change_of_message_of_Maximum_amount_per_orderCOneTwoThreeNine() {
    ...
    if (isElementAvailable(new String[] { XPATH, "(//a[text()=\'Rose D’Amelie Perfume de Mujer\'])[1]" })) {
      ...
      status = "passed";
    } @Test public void MTO_Copy_and_paste_in_formsCOneTwoEightFive () {
    ...
    @Test public void MTO_Go_back_to_the_bagCOneTwoFivezeroCTwoNineTwoOne () {
      ...
      if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
        ...
        Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'cart-headline\']" }));
        // Take Screenshot
        takeScreenshot("logs/Screenshoots/PoWeRC.png");
        // end if add to cart present
      }
      // Start  else statement
      else {
    ...
    @Test public void ECOM_Copy_and_paste_in_formsCOneTwoEightSix () {
    ...
    @Test public void ECOMCLChange_of_message_of_Maximum_amount_per_orderCOneTwoThreeFive () {
      ...
      typeText(new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > form > input:nth-of-type(4)" },
        "000");
      // click on enter
      pressKey(new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > form > input:nth-of-type(4)" },
        "td > li:nth-of-type(1) > div:nth-of-type(3) > form > input:nth-of-type(4)");
    ...
    @Test public void ECOM_RegisterCOneTwoFiveTwoCTwoNineTwoTwo () {
      ...
      typeText(new String[] { NAME, "checkPwd" }, "][][");
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/ancuBI.png");
      // Click on register.agree checkbox
      clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
      // scroll down
      scroll("ScrollDown", 60);
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/TSaywq.png");
      // Refresh page
      pageRefresh();
      ...
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/daHQxT.png");
      // Click on register agree checkbox
      clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
      // Refresh page
      pageRefresh();
      ...
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/iONWGz.png");
      // Scroll Down
      scroll("ScrollDown", 224);
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/rDzgYg.png");
      // Click on register agree checkbox
      clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
      // Add Assertion for Create user
      Assert.assertTrue(isElementClickable(
    ...
    @Test public void MTO__PE_Change_of_message_of_Maximum_amount_per_order___COneTwoThreeSeven__CTwoNineOneTwo () {
      javascriptExecution(
      ...
      if (isElementAvailable(new String[] { ID, "addToCartButton" })) {
        ...
        if (isElementAvailable(new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > p" })) {
          ...
          Assert.assertTrue(
            isElementAvailable(new String[] { CSS, "td > li:nth-of-type(1) > div:nth-of-type(3) > p" }));
          // End of if loop
        }
        // end if add to cart present
      }
    ...
    @Test public void ECOM_Adjustment_of_my_personal_data_formCOneTwoFourSix () {
    ...
    @Test public void MTO_login_as_guestCOneTwoFiveFive () {
      ...
      if (isDisplayed(new String[] { XPATH, "//button[@id=\'addToCartButton\']" }, 0)) {
        ...
        Assert.assertFalse(
          isElementClickable(new String[] { XPATH, "//button[text() = \"Continuar como invitado\"]" }));
        // Take Screenshot
        takeScreenshot("logs/Screenshoots/COKano.png");
        // Refresh page
        pageRefresh();
        // Write text in guest firstName...
