...
public class Checkout_TC__Peru__Chile__New_Checkout_updated extends WebDriverHelper {
  ...
  @Test
  public void MTO_Fill_out_the_form_and_log_in_as_a_guest__C() {
  ...
  @Test
  public void ECOM_Login_with_registered_userC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Forgot_your_passwordCC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOMPEChange_of_message_of_Maximum_amount_per_orderC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void Ecomm__Mail_password_recovery_C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Go_back_to_the_bagCC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//h1[@class=\'cart-headline\']" }));
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/xTGwto.png");
      // end if add to cart present
    }
  ...
  @Test
  public void MTO_login_as_guestC() {
    ...
    if (isDisplayed(new String[] { XPATH, "//button[@id=\'addToCartButton\']" }, 0)) {
      ...
      // Take Screenshot
      takeScreenshot("logs/Screenshoots/UgIRUp.png");
      // Refresh page
      pageRefresh();
      // Write text in guest firstName...
  ...
  @Test
  public void MTO_Login_with_registered_userCC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTOCL_Free_shipping_bar_settingC() {
    // Clear cache cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Login_with_an_accountC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    typeText(new String[] { CSS, "input[class=\" form-control\"]" }, "srdas9@hotmail.com");
  ...
  public void ECOM_RegisterCC() {
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/hUSkUl.png");
    // Click on register.agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
    // scroll down
    scroll("ScrollDown", 60);
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/kHodYl.png");
    // Refresh page
    pageRefresh();
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/WMqNvp.png");
    // Click on register agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
    // Refresh page
    pageRefresh();
    ...
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/Ewotwg.png");
    // Scroll Down
    scroll("ScrollDown", 224);
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/rmJOxl.png");
    // Click on register agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
  ...
  @Test
  public void MTO_Login_with_accountCC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    typeText(new String[] { ID, "j_username" }, "demo@mailinator.com");
    // Write text in j_password
    typeText(new String[] { ID, "j_password" }, "Photontest@123");
    // Click on  \"eye icon\"
    clickOnElement(new String[] { CSS, "div[class=\"btn-pwdShow btnKeypassword\"]" });
  ...
  @Test
  public void ECOM_Adjustment_of_my_personal_data_formC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO__PE_Change_of_message_of_Maximum_amount_per_order___C__C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void Ecomm_Fill_out_the_form_and_log_in_as_a_guest__C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO__Forgot_your_password_C_C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOMPE_Free_shipping_bar_adjustmentC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    if (isElementAvailable(new String[] { XPATH, "//button[@id=\'addToCartButton\']" })) {
      ...
      takeScreenshot("logs/Screenshoots/kqWrvq.png");
      // Click on Remove
      clickOnElement(new String[] { XPATH,
  ...
  @Test
  public void Ecom__Forgot_your_password_C_C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOM_Login_with_an_accountC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOMCLChange_of_message_of_Maximum_amount_per_orderC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOM_Login_with_your_account__C() {
    // Clear cookies and cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    clickOnElement(new String[] { NAME, "belcorpToC" });
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/kNNqxS.png");
    // Refresh page
    pageRefresh();
    // Write text in j_username
  ...
  @Test
  public void MTO_CL_Change_of_message_of_Maximum_amount_per_orderC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_Copy_and_paste_in_formsC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTOPE_Free_shipping_bar_settingC__C() {
    // Clear cache cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO_new_user_registrationCC() {
    // Clear cookies and cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
    ...
    typeText(new String[] { NAME, "checkPwd" }, "][][");
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/QIoinG.png");
    // Click on register.agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
    ...
    typeText(new String[] { NAME, "checkPwd" }, "Sairam9");
    // Take Screenshot
    takeScreenshot("logs/Screenshoots/XiSSey.png");
    // Click on register agree checkbox
    clickOnElement(new String[] { NAME, "agreeToReceivePublicity" });
    // Click on register  checkbox
    clickOnElement(new String[] { NAME, "belcorpToC" });
  ...
  @Test
  public void ECOM_Forgot_your_passwordCC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void Ecom_Keep_Floating_Buttons__C() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void MTO__Mail_password_recovery_CC() {
    // clear cache and cookies
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOMCL_Free_shipping_bar_settingC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
  ...
  @Test
  public void ECOM_Copy_and_paste_in_formsC() {
    // clear cache
    // Clear cookies
    deleteAllCookies();
    // Clear storage
