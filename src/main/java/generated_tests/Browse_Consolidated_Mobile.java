...
public class Browse_Consolidated_Mobile extends WebDriverHelper {
  ...
  @Test
  public void ZOOM_EN_MOBILE_MTO_And_ECOMCC() {
...
Assert.assertTrue(isElementClickable(new String[] { XPATH, "(//button[@class=\'ytp-large-play-button ytp-button\'])[1]"}));
...
// End Else Statement
  ...
  @Test
  public void arrows_menu_mobile_Check_the_arrows_in_menu_mobile_MobileC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
clickOnElement( new String[] {XPATH, "//a[text()=\'maquillaje\']/../../..//span[@class=\"glyphicon glyphicon-chevron-right hidden-md hidden-lg nav__link--drill__down js_nav__link--drill__down\"]"});
// take snip to verify the title
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/FURmlE.png");
...
clickOnElement( new String[] {XPATH, "//a[text()=\'Ojos\']/../..//span[@class=\"glyphicon glyphicon-chevron-right hidden-md hidden-lg nav__link--drill__down js_nav__link--drill__down_third_level\"]"});
// take a snip to veridy the title
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/MynlPG.png");
...
Assert.assertTrue(checkCurrentUrlContains( "sombras"));
  ...
  @Test
  public void Mobile__Anchor_Header_Menu__SearchC__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//button[@class=\'navbar-toggle js-toggle-sm-navigation\']"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[@class=\'input-group-addon searchBoxIconShort\'])[2]"}));
// Click on lbel
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//a[@id=\'lnk-sup-lbel\'])[1]"}));
// Valiadate \"hemberger menu  is Present\"
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//button[@class=\'navbar-toggle js-toggle-sm-navigation\']"}));
// Validate \"bag is present\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'mini-cart-icon\'])[2]"}));
// Validate \"search engine present\"
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//i[@class=\'glyphicon glyphicon-search\'])[3]"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//input[@id=\'js-site-search-input\'])[2]"}));
  ...
  @Test
  public void MENU_Logged_behavior__MOBILEC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
// wait
waitUntil("CheckClickableElement", new String[]{XPATH, "//button[text() = ' Iniciar sesión']"}, "10","disabled");
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/uJgOww.png");
// click on my account arrow
clickOnElement( new String[] {XPATH, "//span[text()=\'Mi Cuenta\']/../..//span[@class=\"glyphicon glyphicon-chevron-down myAcctExp\"]"});
// Take a snip for my account option verification
takeScreenshotOfParticularElement(new String[] { XPATH, "//ul[@data-trigger=\"#signedInUserOptionsToggle\"]" },"logs/Screenshots/xUzxUu.png");
// Add assertion for My personal data
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//ul[@data-trigger=\"#signedInUserOptionsToggle\"]//a[text()=\'mis datos personales\']"}));
// Add assertion for My placed orders
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//ul[@data-trigger=\"#signedInUserOptionsToggle\"]//a[text()=\'mis pedidos realizados\']"}));
// Add assertion for My addresses
Assert.assertTrue(isElementClickable(new String[] { XPATH, "//ul[@data-trigger=\"#signedInUserOptionsToggle\"]//a[text()=\'mis direcciones\']"}));
// start if statement
if (isElementAvailable(new String[] { XPATH, "//ul[@class=\"bic-user-menu\"]//a[text()=\' Quiero ser consultora\']"})){
// Add assertion for i want to be consultant
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//ul[@class=\"bic-user-menu\"]//a[text()=\' Quiero ser consultora\']"}));
// end if
}
// Add assertion for find a consultant
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//ul[@class=\"bic-user-menu\"]//span[text()=\'Buscar una consultora\']"}));
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[contains(text(),\'Cerrar Sesión\')]"}));
  ...
  @Test
  public void MENU_First_level_information__MOBILEC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/XMbLHp.png");
// Add assertion for login/signup
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//li[@class=\"auto liUserSign\"]"}));
// Add assertion for i want to be consultant
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"yCmsComponent show_mobile want-sell\"]"}));
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/wUGEry.png");
// Click on ojos navigation arrow
clickOnElement( new String[] {XPATH, "//a[text()=\'Ojos\']/../..//span[@class=\"glyphicon glyphicon-chevron-right hidden-md hidden-lg nav__link--drill__down js_nav__link--drill__down_third_level\"]"});
// take a snip of hamburgur menu user menu is not showing
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/Dzpbzn.png");
// Add assertion for login/signup
Assert.assertFalse(isElementDisplayed(new String[] { XPATH, "//li[@class=\"auto liUserSign\"]"}));
// Add assertion for i want to be consultant
Assert.assertFalse(isElementDisplayed(new String[] { XPATH, "//div[@class=\"yCmsComponent show_mobile want-sell\"]"}));
// Add assertion for find consulatnt
Assert.assertFalse(isElementDisplayed(new String[] { XPATH, "//span[text()=\'Buscar una consultora\']"}));
  ...
  @Test
  public void TONE_DROP_BAR__Product_with_VariantsC__C() {
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//li[@class=\'tone-slide variantGroupAll\']/parent::ul" },"logs/Screenshots/YigvCO.png");
// End of If Loop
}
// Else Statement
else{
...
// End Else Statement Loop
  ...
  @Test
  public void CAOn__off_consulting_canopyC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//div[@class=\"new-header header-center\"]"}));
  ...
  @Test
  public void ANCHOR_HEADER_BRANDS_CCCC() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//a[@id=\'lnk-sup-cyzone\'])[2]"}));
  ...
  @Test
  public void MENU_Level_design__MOBILEC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/ERMKdd.png");
// Add assertion for maquillaje
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[contains(text(),\'Maquillaje\')]"}));
// Click on ojos navigation arrow
clickOnElement( new String[] {XPATH, "//a[text()=\'Ojos\']/../..//span[@class=\"glyphicon glyphicon-chevron-right hidden-md hidden-lg nav__link--drill__down js_nav__link--drill__down_third_level\"]"});
// take a snip to verify the title is in bold
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/RTcNdC.png");
// Add assertion for ojos
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text()=\' Ojos\']"}));
  ...
  @Test
  public void MENU_Behavior_when_not_logged_in__MOBILEC() {
// Clear cache cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//div[@class=\"yCmsComponent show_mobile want-sell\"]"}));
// take a snip to verify all the user menu component present
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\"close-nav-mobile\"]" },"logs/Screenshots/KSqjzT.png");
// Add assertion for find consulatnt
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//span[text()=\'Buscar una consultora\']"}));
  ...
  @Test
  public void CAHeader_behavior_mobile__C__C() {
// Clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
takeScreenshotOfParticularElement(new String[] { XPATH, "//div[@class=\'bic-tabs-brands\']" },"logs/Screenshots/HZMoYf.png");
