...
public class New_Checkout_Step__Chile___Desktop extends WebDriverHelper {
...
// End Else Statement
  ...
  @Test
  public void Verify_the_no_impact_on_the_functionality__Order_as_a_giftC() {
// clear cache
// Clear cookies
deleteAllCookies();
// Clear storage
...
javascriptExecution("window.sessionStorage.clear();");
// Go To URL
getURL("https://bic2-esika.tiendabelcorp.com/cl/");
...
if (isDisplayed(new String[] { XPATH, "//input[@name=\"firstName\"]"}, 0)) {
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "//label[contains(text(),\'Pedir como regalo\')]"}));
...
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "(//div[text()=\'No puede llevar números ni caracteres especiales\'])[1]"}));
...
// Assertion on wrong details error msg
Assert.assertTrue(isElementDisplayed(new String[] { XPATH, "//div[text()=\'No puede llevar números ni caracteres especiales\']"}));
