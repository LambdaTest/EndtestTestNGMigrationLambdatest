...
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/sEeShk.png");
// if product present
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/zYXLak.png");
// add assertion for oder details
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[text()=\'Detalle del pedido\'])[1]"}));
// End If Statement
}
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/NISCje.png");
// add assertion for oder details
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[text()=\'Detalle del pedido\'])[1]"}));
// End If
}
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/VFnyTp.png");
// End If Statement
}
// Else Statement
else{
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/VXpRSa.png");
// End If
}
// Start else
else{
