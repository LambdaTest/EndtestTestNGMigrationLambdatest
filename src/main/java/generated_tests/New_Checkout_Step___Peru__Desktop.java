...
public class New_Checkout_Step___Peru__Desktop extends WebDriverHelper {
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/CPsXaM.png");
// if product present
...
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//div[@class=\'subtotals__item--state-discount\'])[2]"}));
// End If Statement
}
// Else Statement
else{
...
// End Else Statement
  ...
  @Test
  public void Check_the_order_of_added_productsC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/hTjrHJ.png");
// add assertion for oder details
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[text()=\'Detalle del pedido\'])[1]"}));
// End If Statement
}
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/BhhVfr.png");
// add assertion for oder details
Assert.assertTrue(isElementAvailable(new String[] { XPATH, "(//span[text()=\'Detalle del pedido\'])[1]"}));
// End If
}
...
// End else
  ...
  @Test
  public void Verify_that_all_the_products_added_to_the_cart_appear_in_See_my_productsC() {
// clear cache and cookies
// Clear cookies
deleteAllCookies();
// Clear storage
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/VKysnQ.png");
// End If Statement
}
// Else Statement
else{
...
Assert.assertTrue(isElementAvailable(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form"}));
// take a snip of see my product
takeScreenshotOfParticularElement(new String[] { CSS, "div.col-md-4.hidden-xs.hidden-sm.checkout-right-form" },"logs/Screenshots/NsFBLR.png");
// End If
}
// Start else
else{
...
// End else
  ...
  @Test
  public void C_Payment_with_Pago_Efectivo__Phase_() {
// Go to URL
getURL("https://s1-esika.tiendabelcorp.com/pe/");
// Scroll down
scroll("ScrollDown", 1800);
// if image present
if (isElementAvailable(new String[] { CSS, "main > div:nth-of-type(6) > div > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > a > img"})){
// Click on img
clickOnElement( new String[] {CSS, "main > div:nth-of-type(6) > div > div:nth-of-type(2) > div:nth-of-type(2) > div > div:nth-of-type(1) > div:nth-of-type(1) > a > img"});
...
// Click on Ir a pagar
clickOnElement( new String[] {CSS, "button[id=\"checkout-display-continueCheckout\"][class=\"btn btn-magenta btn-block btn--continue-checkout js-continue-checkout-button\"]"});
...
// Click on Pagar
clickOnElement( new String[] {CSS, "button[type=\"button\"][class=\"btn btn-block submit_mpagoCashForm checkout-next\"]"});
// if present
